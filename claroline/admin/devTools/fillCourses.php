...
$htmlHeadXtra[] =
"<style type=\"text/css\">
        TABLE.list TR TD.rem { background-color: ".$colorLight."; }
        label
        {
            display: block;
            width: 25%;
        ...
        input, textarea { margin-left: 1em;    background-color: ".$colorLight.";}
...
if (isset($HTTP_POST_VARS["nc"]))
{
    ...
    ,"Baseball","Soccer","Basketball","World","pop","corn","cvs"
    );
