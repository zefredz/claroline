...
include("../../inc/lib/userManage.lib.php");
...
if($display_form)
{
	...
	<?php echo $lang_addUser_OneByOne; ?>. <?php echo $lang_addUser_UserOneByOneExplanation; ?>

	<form method="post" action="<?= $PHP_SELF ?>?register=yes">
	<table cellpadding="3" cellspacing="0" border="0">
	<tr>
		<td align="right"><?php echo $lang_addUser_Name; ?> :
		</td>
		<td>
		<input type="text" size="15" name="nom_form" value="<?php echo htmlentities(stripslashes($lastname)); ?>">
		</td>
	</tr>
	<tr>
		<td align="right"><?php echo $lang_addUser_Surname; ?> :
		</td>
		<td>
		<input type="text" size="15" name="prenom_form" value="<?php echo htmlentities(stripslashes($firstname)); ?>">
		</td>
	</tr>
	<tr>
		<td align="right"><?= $lang_addUser_Username ?> :
		</td>
		<td><input type="text" size="15" name="username_form" value="<?php echo htmlentities(stripslashes($username)); ?>">
		</td>
	</tr>
	<tr>
		<td align="right"><?php echo $lang_addUser_Pass ?> :
		</td>
		<td>
		<input type="password" size="15" name="password_form" value="<?php echo htmlentities(stripslashes($password)) ?>">
		</td>
	</tr>
	<tr>
		<td align="right"><?php echo $lang_addUser_Email; ?> :
		</td>
		<td>
		<input type="text" size="15" name="email_form" value="<?php echo $email; ?>">
		</td>
	</tr>
	<tr>
		<td align="right"><?php echo $lang_addUser_Status; ?> :
		</td>
		<td>
		<input type="radio" name="status_form" value="1" > <?php echo $lang_addUser_Yes ?>
		<input type="radio" name="status_form" value="5" checked="checked"> <?php echo $lang_addUser_No; ?>
		</td>
	</tr>
	<tr>
		<td>&nbsp;
		</td>
		<td><input type="submit" name="submit" value="<?php echo  $lang_addUser_buttonSubmit ?>">
		</td>
	</tr>
	</table>
	</form>
	...
	if($is_platformAdmin && (! $userPasswordCrypted))
	{
		?>
		<hr><br>
		<?php echo $lang_addUser_addSeveralUser ?>
		<br><br>
