...
if( !isset($_REQUEST['register']) && ! ( isset($alreadyRegistered) && $alreadyRegistered ) )
{
	echo "<form action=\"".$_SERVER['PHP_SELF']."\" method=\"post\">\n"
	    ."<ul>\n"
		."<li>".$lang_config_siteName." ".stripslashes($siteName)."</li>\n"
		."<li>".$lang_config_rootWeb." <a href=\"".$rootWeb."\">".$rootWeb."</a></li>\n"
		."<li>".$lang_config_TitleInstitution." ".stripslashes($institution['name'])."</li>\n"
		."<li>".$lang_config_urlInstitution." <a href=\"".$institution['url']."\">".$institution['url']."</a></li>\n"
		."<li>"
