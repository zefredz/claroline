...
function get_menu_item_list($type)
{
    ...
    .                   '</form>'
    ;
$menuAdminUser[] = claro_html::tool_link('adminusers.php',       get_lang('User list'));
$menuAdminUser[] = claro_html::tool_link('adminaddnewuser.php',  get_lang('Create user'));
$menuAdminUser[] = claro_html::tool_link('admin_class.php',      get_lang('Manage classes'));
$menuAdminUser[] = claro_html::tool_link('../user/AddCSVusers.php?AddType=adminTool', get_lang('Add a user list'));
...
$menuAdminCourse[] = claro_html::tool_link('admincourses.php',                   get_lang('Course list'));
$menuAdminCourse[] = claro_html::tool_link('../course/create.php?fromAdmin=yes', get_lang('Create course'));
$menuAdminCourse[] = claro_html::tool_link('admincats.php',                      get_lang('Manage course categories'));
...
$menuAdminPlatform[] = claro_html::tool_link('maintenance/repaircats.php', get_lang('Repair category structure'));
$menuAdminPlatform[] = claro_html::tool_link('upgrade/index.php',    get_lang('Upgrade'));


$menuAdminClaroline[] = claro_html::tool_link('registerCampus.php',  get_lang('Register my campus'));
$menuAdminClaroline[] = claro_html::tool_link('http://www.claroline.net/forum', get_lang('Support forum'));
...
if ( defined('CLAROLANG') && CLAROLANG == 'TRANSLATION') $menuAdminSDK[] = claro_html::tool_link('xtra/sdk/translation_index.php', get_lang('Translation Tools'));
if ( defined('DEVEL_MODE') && DEVEL_MODE == TRUE )
{
    $menuAdminSDK[] =  claro_html::tool_link('devTools', get_lang('Devel Tools'));
}
