...
function get_menu_item_list($type)
{
    ...
    if(is_null($menu))
    {
        ...
        $menu['AdminUser'][] = claro_html_tool_link('adminmergeuser.php', get_lang('Merger user accounts ') . ' (EXPERIMENTAL !!!)');
        ...
        $menu['Communication'][] = '<a href="../messaging/admin.php">'.get_lang('Internal messaging system').'</a>';
