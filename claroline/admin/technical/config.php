...
else
{
	...
	{
		$siteName                       =trim(strip_tags(stripslashes($_REQUEST["siteName"])));
		$administrator["name"]          =trim(strip_tags(stripslashes($_REQUEST["nameAdministrator"])));
		$administrator["phone"]         =trim(strip_tags(stripslashes($_REQUEST["phoneAdministrator"])));
		$administrator["email"]         =trim(strip_tags($_REQUEST["emailAdministrator"]));
		$educationManager["name"]       =trim(strip_tags(stripslashes($_REQUEST["nameEducationManager"])));
		$educationManager["phone"]      =trim(strip_tags(stripslashes($_REQUEST["phoneEducationManager"])));
		$educationManager["email"]      =trim(strip_tags($_REQUEST["emailEducationManager"]));
		$institution["name"]            =trim(strip_tags(stripslashes($_REQUEST["nameInstitution"])));
		$institution["url"]             =trim(strip_tags($_REQUEST["urlInstitution"]));
		$platformLanguage               =trim(strip_tags($_REQUEST["platformLanguage"]));
		$rootWeb                        =trim(strip_tags($_REQUEST["rootWeb"]));
		$urlAppend                      =trim(strip_tags($_REQUEST["urlAppend"]));
		$dbHost                         =trim(strip_tags($_REQUEST["dbHost"]));
		$dbLogin                        =trim(strip_tags($_REQUEST["dbLogin"]));
		$dbPass                         =trim(strip_tags($_REQUEST["dbPass"]));
		$dbNamePrefix                   =trim(strip_tags($_REQUEST["dbNamePrefix"]));
						...
						if($find>0)
						{
							...
							while($var[$i])
							{
								for($j=0;$j<count($replace);$j++)
								{
									...
									{
										$newVar=str_replace($end,"\"".str_replace('"','\"',str_replace(';',':',$newVal[$j]))."\"",$var[$i]);
...
<form action="<?php echo $_SERVEUR['PHP_SELF'] ?>" method="POST" target="_self">
	...
	<tbody>
		<tr>
			...
			<td> 
				<input type="text" name="siteName" id="siteName" size="30" value="<?php echo htmlspecialchars($siteName) ?>"  >
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> 
				<input type="text" name="nameAdministrator" id="nameAdministrator" size="30" value="<?php echo htmlspecialchars($administrator["name"]) ?>"  >
			</td>
		</tr>
		<tr>
			<td align="right">  
			...
			<td> 
				<input type="text" name="phoneAdministrator" id="phoneAdministrator" size="30" value="<?php echo htmlspecialchars($administrator["phone"]) ?>"  >
			</td>
		</tr>
		<tr>
			<td align="right"> 
			...
			<td> 
				<input type="text" name="emailAdministrator" id="emailAdministrator" size="30" value="<?php echo htmlspecialchars($administrator["email"]) ?>"  >
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> <input type="text" name="nameEducationManager" id="nameEducationManager" size="30" value="<?php echo htmlspecialchars($educationManager["name"]) ?>"  >
			</td>
		</tr>
		<tr>
			<td align="right">  
			...
			<td> 
				<input type="text" id="phoneEducationManager"  name="phoneEducationManager" size="30" value="<?php echo htmlspecialchars($educationManager["phone"]) ?>"  >
			</td>
		</tr>
		<tr>
			<td align="right">  
			...
			<td> 
				<input type="text" name="emailEducationManager"  id="emailEducationManager" size="30" value="<?php echo htmlspecialchars($educationManager["email"]) ?>"  >
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td> 
				<input type="text" name="nameInstitution" id="nameInstitution" size="30" value="<?php echo htmlspecialchars($institution["name"]) ?>"  >
			</td>
		</tr>
		<tr>
			<td align="right"> 
			...
			<td> 
				<input type="text" name="urlInstitution"  id="urlInstitution" size="50" value="<?php echo htmlspecialchars($institution["url"]) ?>"  >
			</td>
		</tr>
		...
		<tr>
			...
			<td> 
				<input type="text" name="rootWeb" id="rootWeb" size="50" value="<?php echo htmlspecialchars($rootWeb) ?>"  >
			</td>
		</tr>
		<tr>
			<td align="right"> 
