...
<a class="item" href="<?php echo $claroRootWeb ?>"		target="_top"	><?php echo $claroSiteName; ?></a><br>
<a class="item" href="<?php echo $claroRootAdminWeb ?>"	target="_top"	>Admin</a><br>
<a class="item" href="http://www.phpmyadmin.net" 	target="_blank"	>phpMyAdmin</a>
<HR>
<?php
