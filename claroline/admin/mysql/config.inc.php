<?php # $Id$
function importVarFromConfigOfClaroline ($what="")
{
	include "../../inc/conf/claro_main.conf.php";
	GLOBAL $cfg, $claroSiteName, $claroLangAdmin, $claroRootWeb, $claroRootAdminWeb;
	$claroSiteName 	= $siteName;
	...
	$cfgOfAServer['port']          = '';
	$cfgOfAServer['socket']        = '';
	$cfgOfAServer['connect_type']  = 'tcp';
	$cfgOfAServer['compress']      = FALSE;       // Use compressed protocol for the MySQL connection
	$cfgOfAServer['controluser']   = $dbUser;
	$cfgOfAServer['controlpass']   = $dbPass;
	$cfgOfAServer['auth_type']     = 'config';
	$cfgOfAServer['user']          = $dbUser;
	$cfgOfAServer['password']      = $dbPass;
	$cfgOfAServer['only_db']       = $mainDbName;
	$cfgOfAServer['verbose']       = $siteName." Main DB";
	$cfgOfAServer['pmadb']         = $pmaDbName;          // Database used for Relation, Bookmark and PDF Features
                                                    // - leave blank for no support
	$cfgOfAServer['bookmarktable'] = 'pma_bookmark';
	$cfgOfAServer['relation']      = 'pma_relation';
	$cfgOfAServer['table_info']    = 'pma_table_info';          // table to describe the display fields
                                                    //   - leave blank for no display fields support
	$cfgOfAServer['table_coords']  = 'pma_table_coords';          // table to describe the tables position for the PDF
                                                    //   schema - leave blank for no PDF schema support
	$cfgOfAServer['pdf_pages']     = 'pma_pdf_pages';          // table to describe pages of relationpdf
                                                    // - leave blank if you don't want to use this
	$cfgOfAServer['column_comments']              // table to store columncomments
                                     = 'pma_column_comments';          // - leave blank if you don't want to use this
	$cfgOfAServer['AllowDeny']['order']           // Host authentication order, leave blank to not use
                                     = '';
	$cfgOfAServer['AllowDeny']['rules']           // Host authentication rules, leave blank for defaults
                                     = array();

	if ($what=="pma")
	{
		$cfgOfAServer['only_db']       = $pmaDbName;
		$cfgOfAServer['verbose']       = $siteName."-Pma relations-DB";
	}
	if ($what=="stat")
	{
		$cfgOfAServer['only_db']       = $statsDbName;
		$cfgOfAServer['verbose']       = $siteName."-Tracking-DB";
	}
	if ($what=="myCourses")
	{
		$cfgOfAServer['only_db']       = str_replace("_","\_",$dbNamePrefix)."%";
		$cfgOfAServer['verbose']       = $siteName." Courses DB";
	}
	return $cfgOfAServer;
}
...
$i++;
$cfg['Servers'][$i] = importVarFromConfigOfClaroline();

$i++;
$cfg['Servers'][$i] = importVarFromConfigOfClaroline("myCourses");

$i++;
$cfg['Servers'][$i] = importVarFromConfigOfClaroline("stat");

$i++;
$cfg['Servers'][$i] = importVarFromConfigOfClaroline("pma");


/* Uncomment this block to  have access to ALL your bases
$i++;
$cfg['Servers'][$i] = importVarFromConfigOfClaroline();
