...
<TABLE BORDER="0" CELLPADDING="1" CELLSPACING="0" ALIGN="CENTER" VALIGN="TOP" WIDTH="<?php echo $tablewidth?>">
    <tr> 
      <td align=right>
<?php
  $sql = "SELECT count(*) AS total FROM `$tbl_users` WHERE user_level != -1";
...
?>
	...
	<TR>
		...
		<td bgcolor="<?php echo $color2?>" width="8%" height="25" nowrap align="center"><FONT FACE="<?php echo $FontFace?>" SIZE="<?php echo $FontSize2?>" COLOR="<?php echo $textcolor?>"><B><?php echo $langEmail?></B></font></TD>
