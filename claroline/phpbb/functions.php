...
function trig_topic_notification($topicId)
{
    ...
    $url_topic = $url_phpbb . "/viewtopic.php?topic=". $topicId . "&cidReq=" . $_course['sysCode'];
    $url_forum = $url_phpbb . "/index.php?cidReq=" . $_course['sysCode'];
