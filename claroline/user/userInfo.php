...
$userIdViewed = (int) $uInfo; // Id of the user we want to view coming from the user.php
...
if ($allowedToEditDef)
{
	...
	{
		$userIdViewed = (int) $editMainUserInfo;
...
elseif ($displayMode =="viewMainInfoEdit")
{
	...
	if ($mainUserInfo)
	{
		...
		echo	"<form action=\"".$_SERVER['PHP_SELF']."\" method=\"post\">\n",
				...
				"<td align=\"left\"><b>",htmlize(ucfirst(strtolower($mainUserInfo['firstName'])))," ",htmlize(ucfirst(strtolower($mainUserInfo['lastName']))),"</b></td>\n",
