...
if (claro_is_in_a_group() && claro_is_group_allowed())
{
    ...
    ClaroBreadCrumbs::getInstance()->prepend( get_lang('Documents and Links'), Url::Contextualize('document.php') );
    ClaroBreadCrumbs::getInstance()->prepend( get_lang('Groups'), Url::Contextualize('../group/group.php') );
}
else
{
