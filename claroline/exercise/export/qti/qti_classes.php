...
class ImsAnswerTrueFalse extends answerTrueFalse
{
    ...
    function imsExportProcessing($questionIdent)
    {
        ...
        {
            $out.= '  <displayfeedback feedbacktype="Response" linkrefid="' . xmlentities($this->trueFeedback) . '" />' . "\n";
        }
        ...
        {
            $out.= '  <displayfeedback feedbacktype="Response" linkrefid="' . xmlentities($feedback_ident) . '" />' . "\n";
        }
