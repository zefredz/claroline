...
/*----------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------*/
    ...
    // Hack this  regep to tune  about your need
    // $regexp = "^(http|https|ftp)  <- remove  or add  : sftp|callto|calendar|mailto|gopher|irc|news|telnet|
    // (:[a-zA-Z0-9]*)?/? -> [a-zA-Z0-9] to fix accpeted port (relative to protocol
