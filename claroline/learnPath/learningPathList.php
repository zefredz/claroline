   ...
   switch ($_REQUEST['cmd'])
   {
        ...
        case "delete" :
              ...
              */
              ...
              if ( !empty($_GET['del_path_id']) )
              {
                $_GET['del_path_id'] = (int) $_GET['del_path_id'];
              }
        ...
        case "mkInvisibl" :
             ...
             if ( isset($_GET['visibility_path_id']) && $_GET['visibility_path_id'] != "")
             {
                $_GET['visibility_path_id'] = (int) $_GET['visibility_path_id'];
             }
        ...
        case "moveUp" :
              ...
              if ( isset($_GET['move_path_id']) &&  $_GET['move_path_id'] != "")
              {
                 $_GET['move_path_id'] = (int)  $_GET['move_path_id'];
              }
