...
/*======================================
  ...
  // this page is used in frameset so the frameset will redirect to index or auth if needed
  if ( ! $_cid) die($langNotAllowed);
  if ( ! $is_courseAllowed) die($langNotAllowed);
