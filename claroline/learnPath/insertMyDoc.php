        ...
        if ( check_name_exist($sourceDoc) ) // source file exists ?
        {
            ...
            if($num == 0)
            {
                ...
                $sql = "INSERT INTO `".$TABLEMODULE."`
                        ...
                        VALUES ('". claro_sql_escape($basename) ."' , '". claro_sql_escape(get_block('blockDefaultModuleComment')) . "', '".CTDOCUMENT_."', '" . claro_sql_escape( get_conf( 'cllnp_documentDefaultTime', 0 ) ) . "' )";
                $query = claro_sql_query($sql);
