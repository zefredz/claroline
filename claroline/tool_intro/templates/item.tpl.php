...
<div class="item<?php if ($this->intro->getVisibility() != 'SHOW') : ?> hidden<?php endif; ?>">
    ...
    <div class="manageTools">
        <a
            href="<?php echo htmlspecialchars(Url::Contextualize($_SERVER['PHP_SELF'].'?cmd=rqEd&amp;id='.$this->intro->getId())); ?>"
            title="<?php echo get_lang('Edit this item'); ?>">
            <img src="<?php echo get_icon_url('edit'); ?>" alt="<?php echo get_lang('Edit'); ?>" />
        </a>
        
        <a
            href="<?php echo htmlspecialchars(Url::Contextualize($_SERVER['PHP_SELF'].'?cmd=exDel&amp;id=' . $this->intro->getId())); ?>"
        ...
        <a
            href="<?php echo htmlspecialchars(Url::Contextualize($_SERVER['PHP_SELF'].'?cmd='.(($this->intro->getVisibility() == 'SHOW')?('mkInvisible'):('mkVisible')).'&amp;id='.$this->intro->getId())); ?>"
        ...
        <a
            href="<?php echo htmlspecialchars(Url::Contextualize($_SERVER['PHP_SELF'].'?cmd=exMvUp&amp;id='.$this->intro->getId())); ?>" title="<?php echo get_lang('Move this item up'); ?>">
            <img src="<?php echo get_icon_url('move_up'); ?>" alt="<?php echo get_lang('Move up'); ?>" />
        </a>
        
        <a
            href="<?php echo htmlspecialchars(Url::Contextualize($_SERVER['PHP_SELF'].'?cmd=exMvDown&amp;id='.$this->intro->getId())); ?>"
