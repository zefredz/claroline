...
$langAccountNotExist = "Kontoen er ikke fundet.<BR>".$langMailSentToAdmin." Han/hun vil søge manuelt.<BR>";// by moosh
...
$langLoginRequest = "Login forespørgsel til";// by moosh
