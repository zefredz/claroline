...
$_lang['%moduleName has been added as module'] = 'is toegevoegd als een module van de cursus en van dit leerpad';
$_lang['%moduleName is already used as a module in this learning path'] = 'Deze oefening wordt reeds gebruikt als een module in dit leerpad.';
...
$_lang['(always private)'] = '(steeds priv&eacute;)';
...
$_lang['<strong>Approved</strong><p>Your campus registration has been approved by the Claroline.net team.</p>'] = '<strong>Goedgekeurd</strong><p>uw campus registratie is goedgekeurd door het Claroline.net team.<br />Een link naar uw campusmpus is shown on the Worldwide page of Claroline.net.</p>';
$_lang['<strong>Deleted</strong><p>Your campus registration has been desactivated, contact us (see our website) if you think this is an error.</p>'] = '<strong>verwijderd</strong><p>uw campus registratie is gedesactiveerd, contacteer ons (zie onze website) als U denkt dat dit een fout is.</p>';
$_lang['<strong>Removed</strong><p>Your campus has been removed from the worldwide page.</p>'] = '<strong>Verwijderd</strong><p>Uw campus is verwijderd van de wereldwijde pagina.</p>';
...
$_lang['A reply to your topic has been posted'] = 'Er werd een antwoord op uw onderwerp ingediend.';
...
$_lang['Add introduction text'] = 'Inleiding toevoegen';
...
$_lang['Add new heading'] = 'Voeg nieuwe hoofding toe';
...
$_lang['Add/modify a comment to'] = 'Commentaar wijzigen/toevoegen aan';
$_lang['Added line'] = 'lijn toegeovoegt';
$_lang['Admin'] = 'admin';
...
$_lang['All modules of this course are already used in this learning path.'] = 'Alle modules van deze cursus zijn reeds gebruikt in dit leerpad.';
...
$_lang['Among'] = 'tussen';
$_lang['An error occured.  Learning Path import failed.'] = 'Er is een fout opgetreden.  Import van leerpad is mislukt.';
...
$_lang['Answers to the question'] = 'Antwoorden op de vraag';
...
$_lang['Are you sure you want to remove the following module from the learning path :'] = 'Bent U zeker dat U de volgende module will verwijderen van het leerpad : ';
...
$_lang['Asset not found :'] = 'Troef niet gevonden : ';
...
$_lang['Back to learning path administration'] = 'Terug naar leerpad administratie';
$_lang['Back to list'] = 'Back to list';
$_lang['Back to my course list'] = 'terug naar mijn cursuslijst';
...
$_lang['Campus name'] = 'Naam webstek';
...
$_lang['Cannot extract manifest from zip file (corrupted file ? ).'] = 'Kan het manifesto niet extraheren uit het zip bestand (corrupt bestand ?).';
...
$_lang['Category updated'] = 'category gewijzigd.';
$_lang['Change minimum raw mark to pass this module (percentage) :'] = 'Verander ruwe minimum om deze module met succes te be&euml;indigen (in percent) : ';
$_lang['Change picture'] = 'Plaatje wijzigen';
...
$_lang['Chat of the group'] = 'Chat van de groep';
$_lang['Chat reset by'] = 'Chat ge-herinitaliseerd door';
...
$_lang['Choose a course to access this page.'] = 'Kies een course om deze pagina te kunnen bekijken.';
...
$_lang['Clear up event list'] = 'Lijst opkuisen';
...
$_lang['Course administrator only'] = 'Enkel voor cursusbeheerder';
$_lang['Course code'] = 'Cursuscode';
$_lang['Course code needed'] = 'Cursus code veld moet vervolledigd worden';
...
$_lang['Course manager cannot unsubscribe himself'] = 'de course begeleider kanzichzelf nietuitschrijven';
$_lang['Course members'] = 'cursus leden';
$_lang['Course not found'] = 'course niet gevonden';
...
$_lang['Create a new label / title in this learning path'] = 'Maak een nieuw label / titel aan in dit leerpad';
$_lang['Create a new learning path'] = 'Maak een nieuw leerpad';
$_lang['Create a new user'] = 'Nieuwe gebruiker aanmaken';
$_lang['Create another new user'] = 'Maak opnieuw een nieuwe gebruiker';
$_lang['Create category'] = 'Maak category';
$_lang['Create course'] = 'Maak een cursus';
$_lang['Create first a user account on this platform'] = 'Maak eerst een gebruikers accountant op dit platform';
...
$_lang['Create user'] = 'Maak een gebruiker';
...
$_lang['DBSettingNamesIntro'] = '
                ...
                ';
$_lang['Database Host'] = 'Databank machine';
$_lang['Database name'] = 'Databank naam';
$_lang['Database usage'] = 'Databank gebruik';
$_lang['Date'] = 'Datum';
$_lang['Day'] = 'Dag';
$_lang['Default works visibility'] = 'Standaard zichtbaarheid werkjes';
$_lang['Define Headings'] = 'Definieer Hoofdingen';
...
$_lang['Deleted line'] = 'lijn verwijderd';
...
$_lang['Details may be incorrect as it seems that some questions have change between this attempt and now.'] = 'Details kunnen fout zijn , aangezien sommige vragen veranderd zijn tussen deze test en nu.';
$_lang['Devel Tools'] = 'Gereedschap voor ontwikkelaars';
$_lang['Differences :'] = 'verschillen :';
$_lang['Directory created'] = 'Folder is aangemaakt';
$_lang['Disable'] = 'Desactiveren';
$_lang['Disable text editor'] = 'Desactiveer tekst bewerking';
$_lang['Disk Usage'] = 'Schijf gebruik';
$_lang['Display of detailled answers is not authorized.'] = 'Toon de gedaitaleerde antwoorden niet aan onbevoegden';
$_lang['Do you really want to delete the category'] = 'Categorie verwijderen, bent U zeker ?';
$_lang['Do you want to continue?'] = 'Wilt U voortgaan?';
$_lang['Document'] = 'Document';
$_lang['Document content'] = 'Inhoud van het document : ';
$_lang['Document deleted'] = 'Folder/Bestand is verwijderd.';
...
$_lang['Documents of the group'] = 'Groepsdocumenten';
$_lang['Down'] = 'Omlaag';
$_lang['Download attached file'] = 'Aangehecht bestand overladen';
$_lang['EG'] = 'bv.';
$_lang['ERROR: The format you gave is not compatible with Claroline'] = 'ERROR: Het format dat U opgaf is niet verenigbaar met Claroline';
$_lang['Edit'] = 'Wijzigen';
...
$_lang['Edit properties'] = 'wijzig eingenschappen';
...
$_lang['Element moved'] = 'Folder/Bestand is verplaatst.';
$_lang['Element renamed'] = 'Naam van Folder/bestand is gewijzigd.';
$_lang['Email'] = 'Email';
...
$_lang['Empty (or NULL)'] = 'Leeg (of NULL)';
$_lang['Empty all groups'] = 'Alle groepen leegmaken';
$_lang['Empty language file'] = 'Leeg taalbestand';
$_lang['Enable'] = 'Toestaan';
$_lang['Enable text editor'] = 'Activeer tekst bewerking';
$_lang['End date'] = 'Einddatum';
$_lang['Enrol as course manager'] = 'Als cursus manager inschrijven';
...
$_lang['Enter the description of your wiki here'] = 'schrijf een omschrijving van jouw wiki hier';
...
$_lang['Error : Name already exists in the learning path or in the module pool'] = 'Fout : De naam bestaat reeds';
...
$_lang['Exercice not found'] = 'Oefening niet gevonden';
...
$_lang['Exercise description'] = 'Oefening omschrijving';
$_lang['Exercise done, choose a module in the list to continue.'] = 'Uw vooruitgang is genoteerd, kies een module uit de lijst om voort te gaan.';
$_lang['Exercise in module'] = 'Oefening in module';
$_lang['Exercise management'] = 'Oefeningenbeheer';
$_lang['Exercise name'] = 'Oefening naam';
$_lang['Exercise no longer available'] = 'Oefening niet langer beschikbaar';
...
$_lang['File received : %filename'] = 'Bestand ontvangen :  %filename';
$_lang['File structure checker'] = 'bestand structuur controleur';
$_lang['Filename'] = 'Bestandsnaam';
$_lang['Fill groups (automatically)'] = 'Alle groepen invullen';
$_lang['Fill in blanks'] = 'Invullen';
$_lang['Fill text field'] = 'vol tekst zone';
...
$_lang['Forum emptied'] = 'forum geleegt';
...
$_lang['Go back to the question list'] = 'Terug naar de vragenlijst van de oefening';
$_lang['Go back to the question pool'] = 'Terug naar de lijst van alle vragen';
$_lang['Go to the account creation page'] = 'Ga naar het accountant maak pagina';
$_lang['Group'] = 'Groep';
$_lang['Group Tutor'] = 'Lesgever';
$_lang['Group area'] = 'Groepsruimte';
$_lang['Group deleted'] = 'Groep verwijderd';
$_lang['Group forums category can\'t be deleted'] = 'Groeps forums categoryen kunnen niet worden verwijderd';
...
$_lang['Import'] = 'Import';
$_lang['Import a learning path'] = 'Importeer een leerpad';
...
$_lang['Include picture'] = 'Beeldje invoegen';
...
$_lang['Insert a document as module'] = 'Voeg een document toe als module';
$_lang['Insert a module of the course'] = 'Module uit de cursus invoegen';
$_lang['Insert my exercise'] = 'Oefening invoegen';
$_lang['Insert my module'] = 'Module invoegen';
...
$_lang['It seems that you already have registered your campus.'] = 'Het lijkt er op dat uw capus reeds geregistreerd is.';
$_lang['Keys :'] = 'sleutels :';
$_lang['Language'] = 'Taal';
...
$_lang['Learning Path is empty'] = 'Leer weg is weg';
$_lang['Learning Path not found'] = 'Leer weg werd niet gevonden';
$_lang['Learning path'] = 'Leerpad';
$_lang['Learning path admin'] = 'Leerpad Admin';
$_lang['Learning path content'] = 'Leerpad inhoud';
$_lang['Learning path has been successfully imported.'] = 'Het leerpad werd met succes geimporteerdd.';
$_lang['Learning path list'] = 'Leerpad Lijst';
$_lang['Learning path progression :'] = 'Leerpad vooruitgang : ';
$_lang['Learning paths tracking'] = 'Leerpad opvolging';
$_lang['Lecturer(s)'] = 'lesgever(s)';
$_lang['Licence'] = 'Licentie';
$_lang['Limit'] = 'Begrenzing';
...
$_lang['Mail is already used by another user.'] = 'Mail wordt reeds gebruikt door een andere gebruiker.';
$_lang['Mail synthax error.'] = 'Mail syntax fout.';
$_lang['Main Group Settings'] = 'Hoofd Groeps Instellingen';
$_lang['Main database'] = 'Systeem database';
...
$_lang['Manifest read.'] = 'Manifest gelezen.';
...
$_lang['Minimum raw to pass has been changed'] = 'Ruw minimum om te slagen is veranderd';
$_lang['MinuteShort'] = 'min.';
$_lang['Missing'] = 'ontbrekend';
$_lang['Missing field(s)'] = 'Niet ingevuld(e) veld(en)';
$_lang['Missing images detected'] = 'Ontbrekende beelden gedetecteerd';
...
$_lang['Modify exercise'] = 'Wijzig oefeing';
...
$_lang['Modules of this path will still be available in the pool of modules'] = 'Modules van dit leerpad zullen nog steeds beschikbaar zijn in de verzameling modules';
$_lang['Month'] = 'Maand';
...
$_lang['Moved line'] = 'lijn verplaatst';
$_lang['Multiple answers'] = 'Meerdere antwoorden';
...
$_lang['My other courses'] = 'Mijn andere courses';
$_lang['My personal course list'] = 'Mijn persoonlijke lijst cursussen';
$_lang['My results'] = 'Mijn resultaten';
$_lang['MySQL Database and Table Names'] = 'MySQL Databank en tabelnamen';
$_lang['Mysql Repository'] = 'Mysql backup';
$_lang['Mysql connection parameters'] = 'Mysql connectie parameters';
$_lang['Name cannot be empty'] = 'De naam moet vervolledigs worden';
$_lang['Name link'] = 'Naam verwijzing';
$_lang['Name of the class has been changed'] = 'Naam van de klas is veranderd';
$_lang['Name of the new directory'] = 'Naam van nieuwe folder';
...
$_lang['New learning path name :'] = 'Nieuwe leerpad naam : ';
...
$_lang['No learning path'] = 'Geen leerpad';
...
$_lang['Not allowed'] = 'U bent hier niet toegelaten';
...
$_lang['Notify by email when replies are posted'] = 'Verwittigen per e-mail wanneer de antwoorden ingediend worden';
$_lang['Now'] = 'Nu';
$_lang['Number of courses'] = 'Aantal cursussen';
$_lang['Number of courses by faculty'] = 'Aantal gebruikers per faculteit';
...
$_lang['Number of learning paths using this module :'] = 'Aantal leerpaden dat gebruik maakt van deze module : ';
...
$_lang['Ooops, stranges cases detected !!'] = 'Oooeeps, vreemd antwoord ontdekt !!';
$_lang['Operation impossible'] = 'Onmogelijk';
$_lang['Operation impossible.<br />A file with this name already exists.'] = 'Onmogelijk.<br />Er bestaat al een bestand met dezelfde naam.';
...
$_lang['Please choose one or more good answers'] = 'Kies &eacute;&eacute;n of meerdere goede antwoorden.';
$_lang['Please confirm your choice'] = 'Gelieve uw keuze te bevestigen';
$_lang['Please define at least one blank with brackets [...]'] = 'Definieer minstens een plaatshouder met vierkante haakjes [...]';
...
$_lang['Please give the exercise name'] = 'Geef a.u.b. een naam aan de oefening.';
$_lang['Please give the question'] = 'Stel a.u.b. een vraag';
$_lang['Please type the text'] = 'Tik aub een tekst';
$_lang['Please type your text below'] = 'Tik hieronder uw tekst';
...
$_lang['Prefix for names of course databases'] = 'Prefix voor namen van cursus databanken';
...
$_lang['Progress in learning paths'] = 'Vooruitgang in leerpad';
$_lang['Progression of users on all learning paths'] = 'Vooruitgang gebruikers op alle leerpaden';
...
$_lang['Public courses'] = 'publieke courses';
$_lang['Publish'] = 'Publiceren';
$_lang['Published on'] = 'Gepubliceerd op';
$_lang['Question'] = 'Vraag';
$_lang['Question / Answer management'] = 'Vragen / Antwoorden beheer';
$_lang['Question list of the exercise'] = 'Vragenlijst van de oefening';
$_lang['Question not found'] = 'Vraag niet gevonden';
...
$_lang['Recent changes'] = 'recentelijke wijziggingen';
...
$_lang['Registration not allowed on the platform'] = 'Registratie niet toegestaan op platform';
...
$_lang['Remove picture'] = 'Werwijder plaatje';
$_lang['Rename'] = 'Hernoemen';
$_lang['Replace attached file'] = 'Vervang aangehecht bestand';
...
$_lang['Results of the exercises done'] = 'Resultaten van de volbrachte oefeningen';
...
$_lang['SCORM conformant modules are definitively removed from server when deleted in their learning path.'] = 'SCORM conforme modules worden definitief verwijderd van de server als ze in hun leerpad verwijderd worden.';
$_lang['SDK'] = 'SDK';
$_lang['Save'] = 'Opslaan';
...
$_lang['Scores of exercises done'] = 'Scores van volbrachte oefeningen';
$_lang['Scorm'] = 'Scorm';
$_lang['Script missing'] = 'scripts vermist';
$_lang['Script not in claroline'] = 'Scripts bestaat niet in claroline';
$_lang['Search'] = 'Zoeken';
...
$_lang['Send account information to user by email'] = 'Zend account informatie naar gebruiker per email';
...
$_lang['Statement'] = 'Commentaar (optioneel)';
$_lang['Statistics'] = 'Statistieken';
$_lang['Statistics by question'] = 'Statistieken volgends vraag';
$_lang['Statistics by user'] = 'statistieken volgends gebruiker';
$_lang['Statistics of course'] = 'Statistieken van cursus';
$_lang['Statistics of exercise'] = 'Statistieken van oefening';
$_lang['Statistics of exercise attempt'] = 'statistieken van de gedaane oefeningen';
...
$_lang['Subscribe a class'] = 'Klas inschrijven';
$_lang['Subscribe to course'] = 'Inschrijven in een cursus';
...
$_lang['The information has been modified'] = 'De eigenschappen werden gewijzigd';
...
$_lang['There is no question for the moment'] = 'Er zijn momenteel geen vragen (in deze categorie)';
$_lang['There is no start asset defined for this module.'] = 'Geen startvaardigheden gedefinieerd voor deze module.';
$_lang['There is no tracking for this attempt.'] = 'Er is geen volging voor deze poging.';
$_lang['There is no user account with this email address.'] = 'Er is geen account met dit email adres.';
$_lang['This category already exists!'] = 'Deze categorie bestaat reeds!';
...
$_lang['This category contains some courses, you can\'t erase it!'] = 'Dere categorie bevat enkele cursussen, U kan ze niet verwijderen!';
...
$_lang['This class still contains some sub classes, delete them first'] = 'Deze klas bevat nog steeds sub-klassen, deze moet U eerst verwijderen';
...
$_lang['This mail appears already in a previous line of the CSV file.'] = 'Dit mail adres komt reeds voor in een eerder lijn van het CSV bestand.';
$_lang['This official code already appears in a previous line of the CSV file.'] = 'Deze offici&euml;le code komt reeds voor in een vorige lijn in het CSV bestand.';
...
$_lang['This will also delete all works submitted in this assignment !'] = '! Dit zal alle werkjes, ingeleverd voor deze taak, ook verwijderen !';
$_lang['Thumbnails'] = 'Duimnagels';
$_lang['Time'] = 'Tijd (s.)';
$_lang['Time in learning path'] = 'Tijd in leerpad';
...
$_lang['Tool accesses changed'] = 'Gereedschap toegang gewijzigd';
...
$_lang['Tracking database'] = 'Databank voor opvolging';
...
$_lang['Unable to change tool access'] = 'Kon toegang tot extern gereedschap niet veranderen';
$_lang['Unable to copy file :'] = 'Niet gelukt om bestand te kopiëren :';
$_lang['Unable to create category'] = 'onmogelijk om deze category te maken';
$_lang['Unable to create directory :'] = 'Onmogelijk om Map te maken';
$_lang['Unable to create file :'] = 'onmogelijk om bestand te maken';
$_lang['Unable to create forum'] = 'onmogelijk om dit forum te maken';
$_lang['Unable to create frame file'] = 'onmogelijk om het frame bestand te maken';
$_lang['Unable to create the SCORM archive'] = 'Onmogelijk om SCORM acrhief te maken';
$_lang['Unable to create the SCORM manifest (imsmanifest.xml)'] = 'onmogelijk om het SCORM manifest te maken (imsmanifest.xml)';
$_lang['Unable to delete'] = 'Kon niet verwijderen';
$_lang['Unable to delete Forum'] = 'onmogelijk om dit forum te verwijderen';
$_lang['Unable to delete category'] = 'onmogelijk om deze category te verwijderen';
...
$_lang['Unable to empty forum'] = 'onmogelijk om forum te legen.';
$_lang['Unable to empty groups'] = 'Onmogelijk om deze groep te legen';
$_lang['Unable to enrol you to the course'] = 'Niet mogelijkom u in te schrijven voor deze cursus';
$_lang['Unable to load exercise\'s question'] = 'Onmogelijk om de vragen van de oefening te laden';
$_lang['Unable to load the exercise'] = 'Onmogelijk om oefeing te laden';
$_lang['Unable to remove your registration to the course'] = 'onmogelijk om je registratie ongedaan te maken voor deze cursus';
$_lang['Unable to save'] = 'Onmogelijk om te bewaren';
$_lang['Unable to update'] = 'Kon niet aanpassen';
$_lang['Unable to update category'] = 'onmogelijk om deze category te wijziggen';
$_lang['Unable to update external tool'] = 'Kon get externe gereedschap niet bijwerken.';
$_lang['Unable to update forum'] = 'onmogelijk om forum te wijziggen';
...
$_lang['Unchanged line'] = 'lijn onveranderd';
$_lang['Unique answer'] = 'Uniek antwoord';
...
$_lang['Use a document'] = 'Gebruik een document';
$_lang['Use a module of this course'] = 'Gebruik een module uit deze cursus';
$_lang['Use an exercise'] = 'Gebruik een oefening';
...
$_lang['WARNING : you are going to delete this wiki and all its pages. Are you sure to want to continue ?'] = 'waarschuwing : u gaat dezez wiki  verwijderen en alle pagina\'s van dit wiki . Bent u zeker dat u wil doorgaan ?';
$_lang['WARNING: this page is a preview. Your modifications to the wiki has not been saved yet ! To save them do not forget to click on the \'save\' button at the bottom of the page.'] = 'Opgepast : deze pagina is een voorbeeld. Uw wijziggingen zij nog niet bewaard ! om ze te beweren vergeet niet om te klikken op de \'bewaar\' knop.';
$_lang['Warning ! This question and its answers are used in several exercises. Would you like to modify them'] = 'Waarschuwing: Deze vraag en zijn antwoorden worden in verschillende oefeningen gebruikt. Wilt u de vraag wijzigen';
$_lang['Week'] = 'Week';
...
$_lang['Wiki of the group'] = 'Wiki van de groep';
...
$_lang['Wrong operation'] = 'Verkeerde bewerking';
$_lang['Year'] = 'Jaar';
$_lang['Yes'] = 'Ja';
...
$_lang['You can delete these scripts from you server'] = 'U kunt deze scripts verwijderen van jouw server';
$_lang['You can not change your own settings!'] = 'U kan uw eigen instellingen niet veranderen!';
$_lang['You can not change your own status'] = 'U kan uw eigen status niet wijzigen';
$_lang['You can not move a class in itself!'] = 'U kan een klas niet in zichzelf verplaatsen!';
...
$_lang['You can set access rights for users using the following grid :'] = 'u kunt de toegang rechten voor gebruikers wijziggen in de volgende tabel :';
...
$_lang['You cannot unsubscribe the last course manager of the course'] = 'Je kunt jezelf niet uitschrijven uit de laatste course manager van den course';
...
$_lang['You have already answered the question'] = 'U hebt deze vraag al beantwoord.';
...
$_lang['You must install these scripts to run correctly claroline'] = 'U moet deze scripts installeren om Claroline goed te kunnen gebruiken';
...
$_lang['You must specify the CSV format used in your file'] = 'U moet het CSV formaat, gebruikt in uw bestand, aanduiden';
...
$_lang['Your new profile has been saved'] = 'Uw nieuw profiel werd opgeslagen';
...
$_lang['Your time is'] = 'Uw tijd is';
$_lang['Your total score is'] = 'Uw totale score is';
...
$_lang['blockConfirmBlockingPathMadeInvisible'] = 'Dit leerpad is blokkerend.<br/>Indien U het onzichtbaar maakt, krijgen studenten toegang tot de volgende leerpaden zonder deze te vervolledigen.</br> Bevestigen ?';
$_lang['blockConfirmDeleteModule'] = 'bent U zeker dat U deze module compleet wil verwijderen ?<br/>Het zal permanent van de server verwijderd worden, en van elk leerpad waar het deel van uitmaakt.<br/>U zal het niet meer kunnen gebruiken in een leerpad. <br />Bevestig verwijderen van : ';
$_lang['blockConfirmDeleteScorm'] = 'Dit leerpad maakt deel uit van een SCORM import pakket. Als u het verwijdert, worden alle SCORM-conforme modules en gerelateerde bestanden verwijderd van de server.  Bent U zeker dat u dir leerpad wil verwijderen: ';
$_lang['blockConfirmDeleteStats'] = 'Indien U de statistieken van deze cursus verwijdert is dit een onomkeerbare actie!<br /><br />Bent U zeker dat U de statistieken wil verwijderen ?';
$_lang['blockCourseDescriptionCourseContent'] = 'Inhoud van de cursus';
$_lang['blockCourseDescriptionCourseContentComment1'] = 'Wat is het belang van de inhoud die gedoceerd wordt binnen het raamwerk van de cursus?  Wat is het niveau van de inhoud ?  Hoe is de inhoud gestructureerd?  Wat is de volgorde van de inhoud?  Wat is het doel van de inhoud?';
...
$_lang['blockCourseSettingsTip'] = 'Standaard bent u de enige gebruiker van uw cursus. Als u een minimum aan privacy wenst, is het best om de registratie gedurende een week te openen en aan de studenten vragen om zichzelf in te schrijven. Dan sluit u de registratie en controleert u mogelijke indringers in de gebruikerslijst.';
$_lang['blockDefaultLearningPathComment'] = 'Dit is de inleidende tekst van dit leerpad. Om het door uw eigen tekst te vervangen, klik op de onderstaande link <b>inleiding toevoegen</b>.';
$_lang['blockDefaultModuleAddedComment'] = 'Dit is de inleidende tekst van deze module. Deze tekst zal verschijnen in elk leerpad waar de module deel van uitmaakt. Om ze door uw eigen tekst te vervangen, klik op de onderstaande link <b>Inleiding toevoegen</b>.';
$_lang['blockDefaultModuleComment'] = 'Dit is de inleidende tekst van deze module. Deze tekst zal verschijnen in elk leerpad waar de module deel van uitmaakt. Om ze door uw eigen tekst te vervangen, klik op de onderstaande link <b>Inleiding toevoegen</b>.';
...
$_lang['blockFeedbackHelp'] = 'Comentaar is optioneel. Het is de correcte versie van de taak. Indien niet leeg zal het getoond worden aan de gebruikers volgens de \'toon commentaar\' configuratie.';
...
$_lang['blockIntroLearningPath'] = 'Gebruik dit gereedschap om uw studenten documenten, oefeningen, HTML pagina\'s en links in een bepaalde volgorde aan te bieden.<br /><br /> Om een nieuw leerpad aan te bieden, klik op de onderstaande knop.<br />';
$_lang['blockIntroWork'] = 'Dit stuk gereedschap staat de lesgever toe opdrachtenaan te maken in dewelke elke student (volgens de instellingen van de taak) een document kan uploaden, of een tekst kan schrijven op de website van de cursus.
...
$_lang['blockUsedInSeveralPath'] = 'Deze oefening wordt gebruikt in een of meerdere leerpaden. Als U het verwijdert, zal het niet langer beschikbaar zijn in het leerpad.';
...
$_lang['blockWikiConflictHowTo'] = '<p><strong>wijziging probleem</strong> : De pagina die u probeert te verander blijkt al veranderd te zijn voordat u deze veranderdet.<br /><br />
...
$_lang['denotes new items'] = 'Duid nieuwe punten aan';
$_lang['differences between version of %1\$s modified by %2\$s and version of %3\$s modified by %4\$s'] = 'Verschil tussen versie van  %1$s gemodificeert door %2$s en versie van %3$s gemodificeert door %4$s';
$_lang['e.g. <em>History of Literature</em>'] = 'bijv. <i>Literatuurgeschiedenis</i>';
$_lang['good looking'] = 'mooi ogend';
$_lang['group(s) has (have) been added'] = 'groep(en) werd(en) toegevoegd';
$_lang['has been enroled'] = 'Is ingeschreven';
...
$_lang['in all exercises'] = 'in alle oefeningen';
$_lang['line'] = 'lijn';
$_lang['lines'] = 'lijnen';
...
$_lang['number'] = 'aantal';
$_lang['only in the current exercise'] = 'enkel in de huidige oefening';
...
$_lang['sampleLearnPathDescription'] = 'Dit is een voorbeeld van een leerpad, het gebruikt de voorbeeld oefening uit de oefeningen en voorbeeld document uit de documenten. Klik op
...
$_lang['sampleLearnPathTitle'] = 'Voorbeeld van leerpad';
...
$_lang['this password is too simple. Use a password like this <code>%passpruposed</code>'] = 'Dit wachtwoord is te eenvoudig. Kies een ander zoals bijvoorbeeld: ';
$_lang['to'] = 'naar';
$_lang['uncompress zipped (.zip) file on the server'] = 'ZIP bestand decomprimeren';
$_lang['use brackets [...] to define one or more blanks'] = 'gebruik vierkante haken [...] om een of meerdere invulruimtes te definieren';
$_lang['warning : Installation cannot find the description of the learning path and has set a default comment.  You should change it'] = 'Waarschuwing: De installatie kan de omschrijving van het leerpad niet vinden en heeft een standaard waarde gebruikt. U dient die te veranderen.';
$_lang['warning : Installation cannot find the name of the learning path and has set a default name.  You should change it.'] = 'Waarschuwing: De installatie kan de naam van het leerpad niet vinden en heeft een standaard waarde gebruikt. U dient deze te veranderen.';
?>