...
$l_notify = "Mail mij wanneer geantwoord wordt";
$l_notifybody = "U krijgt deze e-mail omdat een bericht dat u hebt geschreven op het forum een antwoord heeft gekregen
	en u had gevraagd om op de hoogte gebracht te worden.
...
Tot ziens.";
$l_notifysubj = "Er werd een geantwoord op uw onderwerp.";
$l_notopics = "Er zijn geen onderwerpen in dit forum.";
$l_posted = "Geschreven op";
$l_poster = "Schrijver";
$l_posts = "berichten";
...
$langAddNewHeading = "Voeg nieuwe opschrift toe";
...
$langAlertBlockingPathMadeInvisible = "Dit leertraject is blokkerend.<br/>Indien U het onzichtbaar maakt, krijgen studenten toegang tot de volgende leertrajecten zonder deze te vervolledigen.</br> Bevestigen ?";
$langAll = "ALLE";
...
$langAreYouSureDeleteModule = "bent U zeker dat U deze module compleet wil verwijderen ?<br/>Het zal permanent van de server verwijderd worden, en van elk leertraject waar het deel van uitmaakt.<br/>U zal het niet meer kunnen gebruiken in een leertraject. <br />Bevestig verwijderen van : ";
$langAreYouSureToDelete = "Wilt u dit document verwijderen: ";
$langAreYouSureToDeleteScorm = "Dit leertraject maakt deel uit van een SCORM import pakket. Als u het verwijdert, worden alle SCORM-conforme modules en gerelateerde bestanden verwijderd van de server.  Bent U zeker dat u dir leertraject wil verwijderen: ";
$langAreYouSureToRemove = "Bent U zeker dat U de volgende module will verwijderen van het leertraject : ";
$langAreYouSureToRemoveLabel = "Door dit label te verwijderen, verwijdert U alle modules en labels eraan verbonden";
$langAreYouSureToRemoveSCORM = "SCORM conforme modules worden definitief verwijderd van de server als ze in hun leertraject verwijderd worden.";
...
$langBackModule = "Terug naar de lijst";
...
$langBackToLPAdmin = "Terug naar leertraject administratie";
...
$langCannotRemoveGroupForum = "U kunt geen groeps forum verwijderen . U moet eerst de groep verwijderen";
...
$langCategoryDeleted = "categorie verwijderd.";
$langCategoryUpdated = "categorie gewijzigd.";
$langChangePwdexp = "Geef nieuw wachtwoord twee maal in om te wijzigen, laat leeg om huidige te behouden";
$langChangeRaw = "Verander minimum om deze module met succes te be&euml;indigen (in procenten) : ";
$langChangedTool = "Gereedschap toegang gewijzigd";
$langChat = "Online chat";
$langChatResetBy = "Chat ge-herinitialiseerd door";
$langChoice = "Uw keuze";
...
$langCode = "Cursuscode";
$langCodeAppearAlready = "Deze offici&euml;le code komt reeds voor in een vorige regel van het CSV bestand.";
...
$langConfirmDeleteThisGroup = "Bent u zeker om deze groep te verwijderen ?";
$langConfirmEmptyForum = "Verwijder alle berichten van";
$langConfirmEmptyGroups = "Bent U zeker dat U alle groepen wil leegmaken ?";
$langConfirmEnrollClassToCourse = "Weet u zeker dat u de hele klas aan deze cursus wilt koppelen ?";
...
$langCourseAdministratorOnly = "Alleen voor cursusbeheerder";
...
$langCreateCategory = "Maak categorie";
...
$langCreateNewLearningPath = "Maak een nieuw leertraject";
...
$langDefineHeadings = "Definieer Opschriften";
...
$langDeleteCaution = "! Dit zal alle bestanden, ingeleverd voor deze taak, ook verwijderen !";
...
$langDocumentAlreadyUsed = "Dit document wordt reeds gebruikt als een module in dit leertraject";
...
$langEditCategory = "verander category";
...
$langErrorAssetNotFound = "Materiaal niet gevonden : ";
...
$langErrorCreatingDirectory = "Niet mogelijk om Map te maken";
$langErrorCreatingFile = "niet mogelijk om bestand te maken";
$langErrorCreatingFrame = "niet mogelijk om het frame bestand te maken";
$langErrorCreatingManifest = "niet mogelijk om het SCORM manifest te maken (imsmanifest.xml)";
$langErrorCreatingScormArchive = "Niet mogelijk om SCORM archief te maken";
...
$langErrorEmptyName = "De naam moet compleet gemaakt worden";
$langErrorFileMustBeZip = "Bestand moet een ZIP bestand zijn";
$langErrorFormatCSV = "ERROR: Het formaat dat U opgaf is niet verenigbaar met Claroline";
...
$langErrorLoadingExercise = "Niet mogelijk om oefeing te laden";
$langErrorLoadingQuestion = "Niet mogelijk om de vragen van de oefening te laden";
...
$langErrortExtractingManifest = "Kan inhoud niet uitpakken uit het zip bestand (corrupt bestand ?).";
...
$langExAlreadyUsed = "Deze oefening wordt reeds gebruikt als een module in dit leertraject.";
$langExInsertedAsModule = "is toegevoegd als een module van de cursus en van dit leertraject";
...
$langFeedbackHelp = "Commentaar is optioneel. Het is de correcte versie van de taak. Indien niet leeg zal het getoond worden aan de gebruikers volgens de 'toon commentaar' configuratie.";
...
$langFileExists = "Niet mogelijk.<br />Er bestaat al een bestand met dezelfde naam.";
...
$langFillToolCourses = "Opvul gereedschap voor cursussen";
...
$langForum = "Forum";
$langForumCreated = "forum gemaakt";
$langForumDeleted = "forum verwijderd";
$langForumEmptied = "forum leeggemaakt";
$langForumGroup = "Groepsforum";
$langForumUpdated = "forum geupdated";
$langForums = "Forums";
$langFree = "Vrij";
$langFrom = "Van";
...
$langGroupChatLink = "Chat van de groep";
...
$langGroupWikiLink = "Wiki van de groep";
$langGroups = "Groepen";
...
$langGroupsNotEmptied = "Niet mogelijk om deze groep leeg te maken";
...
$langInstalled = "Het leertraject werd met succes geimporteerdd.";
...
$langIntroLearningPath = "Gebruik dit gereedschap om uw studenten documenten, oefeningen, HTML pagina's en links in een bepaalde volgorde aan te bieden.<br /><br /> Om een nieuw leertraject aan te bieden, klik op de onderstaande knop.<br />";
...
$langLearningPathEmpty = "Leertraject is leeg";
$langLearningPathList = "Leertraject Lijst";
$langLearningPathName = "Nieuwe leertraject naam : ";
$langLearningPathNotFound = "Leertraject niet gevonden";
...
$langMailAppearAlready = "Dit mail adres komt reeds voor in een eerder regel van het CSV bestand.";
$langMailSynthaxError = "Mail syntax fout.";
$langMailTo = "Mail naar : ";
$langMailUsed = "Mail wordt al gebruikt door een andere gebruiker.";
$langMainDB = "Systeem database";
$langMainGroupSettings = "Hoofd Groepsinstellingen";
...
$langMissingFields = "Niet ingevuld(e) veld(en)";
$langMissingImagesDetected = "Ontbrekende plaatjes gedetecteerd";
...
$langModuleStillInPool = "Modules van dit leertraject zullen nog steeds beschikbaar zijn in de verzameling modules";
$langModules = "Modules";
...
$langNewLabel = "Maak een nieuw label / titel aan in dit leertraject";
...
$langNoMoreModuleToAdd = "Alle modules van deze cursus zijn reeds gebruikt in dit leertraject.";
$langNoPost = "Geen Post";
$langNoPostAllowed = "Geen nieuwe post toegestaan";
...
$langNoUserFound = "Geen gebruiker gevonden";
...
$langNotInstalled = "Er is een fout opgetreden. Import van leertraject is mislukt.";
...
$langNumGroupStudent = "Aantal teams waarin een student zich kan inschrijven in de cursus";
$langNumero = "Nr.";
$langOfficialCode = "Administratieve code";
$langOk = "Ok";
$langOkChapterHeadAdded = "Titel toegevoegd: ";
$langOkDefaultCommentUsed = "Waarschuwing: De installatie kan de omschrijving van het leertraject niet vinden en heeft een standaard waarde gebruikt. U dient die te veranderen.";
$langOkDefaultTitleUsed = "Waarschuwing: De installatie kan de naam van het leertraject niet vinden en heeft een standaard waarde gebruikt. U dient deze te veranderen.";
$langOkFileReceived = "Bestand ontvangen : ";
$langOkManifestFound = "Inhoud gevonden in zip bestand : ";
$langOkManifestRead = "Inhoud gelezen.";
...
$langPathContentTitle = "Leertraject inhoud";
...
$langPopulateTools = "Gereedschapssets aanmaken in cursussen";
$langPostReply = "Post beantwoorden";
...
$langRawHasBeenChanged = "Minimum onbeantwoord om te slagen is veranderd";
$langReg = "Registratie";
...
$langSpecifyFormat = "U moet het CSV formaat, gebruikt in uw bestand, aangeven";
...
$langTeacherQty = "Nb. leerkrachten";
...
$langUnableCreateCategory = "niet mogelijk om deze category te maken";
$langUnableCreateForum = "niet mogelijk om dit forum te maken";
...
$langUnableDeleteForum = "niet mogelijk om dit forum te verwijderen";
$langUnableDeleteGroupCategoryForum = "Groeps forum categorien kunnen niet worden verwijderd";
...
$langUnableToEmptyForum = "niet mogelijk om forum leeg te maken.";
...
$langUnableToUpdateCategory = "niet mogelijk om deze categorie te wijzigen";
$langUnableToUpdateForum = "niet mogelijk om forum te wijzigen";
$langUnableUpdateExternalTool = "Kon het externe gereedschap niet bijwerken.";
...
$langUnregisterAllStudents = "verwijder alle geregistreerde studenten";
...
$langUsedInLearningPaths = "Aantal leertrajecten dat gebruik maakt van deze module : ";
...
$langUserRegisteredToCourse = "gebruiker geregistreerd in de cursus";
...
$langWiki = "Wiki";
$langWikiAccessControl = "toegangs controle beheer";
$langWikiAccessControlText = "u kunt de toegang rechten voor gebruikers wijzigen in de volgende tabel :";
$langWikiAllPages = "alle pagina's";
$langWikiBackToPage = "terug naar de pagina";
$langWikiConflictHowTo = "<p><strong>wijziging probleem</strong> : De pagina die u probeert te verander blijkt al veranderd te zijn voordat u deze veranderde.<br /><br />
...
$langWikiContentEmpty = "Deze pagina is leeg , klik op 'wijzig deze pagina' om inhoud toe te voegen";
$langWikiCourseMembers = "cursus leden";
$langWikiCreateNewWiki = "maak een nieuw Wiki";
$langWikiCreatePrivilege = "maak pagina's";
$langWikiCreationSucceed = "Wiki is succesvol aagemaakt";
$langWikiDefaultDescription = "schrijf een omschrijving van uw wiki hier";
$langWikiDefaultTitle = "nieuw wiki";
$langWikiDeleteWiki = "verwijder wiki";
$langWikiDeleteWikiWarning = "waarschuwing : u gaat dezez wiki verwijderen en alle pagina's van deze wiki. Wilt u doorgaan?";
$langWikiDeletionSucceed = "wiki succesvol verwijderd";
$langWikiDescription = "beschrijving van het Wiki";
$langWikiDescriptionForm = "Wiki beschrijving";
$langWikiDescriptionFormText = "U kunt een titel en een beschrijving kiezen voor u Wiki";
$langWikiDiffAddedLine = "regel toegevoegd";
$langWikiDiffDeletedLine = "regel verwijderd";
$langWikiDiffMovedLine = "regel verplaatst";
$langWikiDiffUnchangedLine = "regel onveranderd";
$langWikiDifferenceKeys = "codes :";
$langWikiDifferencePattern = "Verschil tussen versie van  %1\$s gewijzigd door %2\$s en versie van %3\$s gewijzigd door %4\$s";
$langWikiDifferenceTitle = "verschillen :";
$langWikiEditConflict = "wijzig probleem";
$langWikiEditLastVersion = "wijzig laatste versie";
$langWikiEditPage = "wijzig deze pagina";
$langWikiEditPrivilege = "wijzig pagina";
$langWikiEditProperties = "wijzig eigenschappen";
$langWikiEditionSucceed = "wiki succesvol gewijzigt";
$langWikiGroupMembers = "groeps leden";
...
$langWikiIdenticalContent = "Geen veranderingen gevonden <br />geen wijzigingen aangebracht";
$langWikiInvalidWikiId = "fout Wiki id";
$langWikiList = "Lijst van Wiki's";
$langWikiMainPage = "Hoofd pagina";
$langWikiMainPageContent = "Dit is de hoofd pagina van Wiki %s. klik op edit om de inhoud te wijziggen";
$langWikiNoWiki = "Geen Wiki";
$langWikiNotAllowedToCreate = "Het is niet toegestaan om een pagina aan te maken. U hebt geen toegang daartoe";
$langWikiNotAllowedToEdit = "Het is niet toegestaan om deze pagina te wijzigingen. U hebt geen toegang daartoe.";
$langWikiNotAllowedToRead = "Het is niet mogelijk om deze pagina te lezen. Het is niet toegestaan";
$langWikiNumberOfPages = "Aantal pagina's";
$langWikiOtherUsers = "Andere (*)";
$langWikiOtherUsersText = "(*) Gasten , gebruikers die niet ingeschreven zijn in deze cursus ...";
$langWikiPageHistory = "pagina historie";
$langWikiPageSaved = "pagina bewaard";
$langWikiPreviewTitle = "voorbeeld :";
$langWikiPreviewWarning = "Opgepast : deze pagina is een voorbeeld. Uw wijzigingen zijn nog niet bewaard ! om ze te bewaren vergeet niet om te klikken op de 'bewaar' knop.";
$langWikiProperties = "instellingen";
$langWikiReadPrivilege = "lees pagina's";
$langWikiRecentChanges = "recentelijke wijzigingen";
$langWikiRecentChangesPattern = "%1\$s gewijzigd op %2\$s door %3\$s";
$langWikiShowDifferences = "Toon verschillen";
$langWikiTitle = "Titel van Wiki";
$langWikiTitleEdit = "Wiki : Wijzig instellingen";
$langWikiTitleNew = "Wiki : Maak een nieuw Wiki";
$langWikiTitlePattern = "Wiki : %s";
$langWikiVersionInfoPattern = "(versie van %1\$s gewijzigt door %2\$s)";
$langWikiVersionPattern = "%1\$s door %2\$s";
...
$lang_completeUserInfoOfUser = "Volledige gebruikersinfo van de gebruiker";
$lang_course_enrollment = "Cursussen van gebruiker";
$lang_do_you_want_to_continue = "Wilt U doorgaan?";
...
$lang_p_category_s_created = "categorie %s gemaakt";
$lang_p_config_file_creation = "Configuratie bestand creatie:<br /> %s";
$lang_p_d_StudentUnregistredFormCours = "%d student((e)n) uitgeschreven uit deze cursus";
...
$lang_p_topic_s_created = "Topics %s gemaakt";
...
$lang_toolsToFill = "hulpmiddelen om populatie te verhogen";
...
$langimportLearningPath = "Importeer een leertraject";
?>