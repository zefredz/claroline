...
$_lang['%chat_filename is now in the document tool. (<em>This file is visible</em>)'] = '%chat_filename bevindt zich nu in de documentensectie. (<em>Dit bestand is zichtbaar</em>)';
$_lang['%claroLabel registered'] = '%claroLabel ingeschreven';
$_lang['%date not valid'] = '%date ongeldig';
$_lang['%delay ago'] = '%delay geleden';
$_lang['%firstname %lastname has been added to the campus'] = '%firstname %lastname werd aan de campus toegevoegd';
$_lang['%firstname %lastname has been added to the campus and to the class'] = '%firstname %lastname werd aan de campus en de klas toegevoegd';
$_lang['%firstname %lastname has been added to the campus and to the course'] = '%firstname %lastname werd aan de campus en de cursus toegevoegd';
...
$_lang['%itemName is already attached'] = '%itemName is reeds gekoppeld';
$_lang['%label registered as tool'] = '%label geregistreerd als een tool';
...
$_lang['%name is required'] = '%name vereist';
...
$_lang['%nb_user new users in the platform'] = '%nb_user nieuwe gebruikers op het platform';
$_lang['%number student(s) unregistered from this course'] = '%number student(en) uitgeschreven voor deze cursus';
$_lang['%site_name Course creation %course_name'] = '%site_name Cursus %course_name aangemaakt';
$_lang['%sitename Request - Course creator status for %firstname %lastname'] = '%sitename Aanvraag - Cursusbeheerder status voor %firstname %lastname';
$_lang['%sitename Request - Revocation of %firstname %lastname'] = '%sitename Aanvraag - Herinstellen van %firstname %lastname';
...
$_lang['&#91;British people&#93; live in &#91;United Kingdom&#93;.'] = '[Belgen] wonen in [België].';
...
$_lang['Access allowed'] = 'Toegangsrechten';
...
$_lang['Access to course and tools'] = 'Toegang tot de cursus en de tools';
...
$_lang['Administrator for %site_name'] = 'De hoofdman van %site_name';
$_lang['Advanced'] = 'Uitgebreid';
$_lang['Advanced Settings'] = 'Geavanceerde instellingen';
...
$_lang['Agreement text displayed before the "Create user account" page'] = 'Tekst met overeenkomst weergegeven vóór de "gebruikersaccount aanmaken" pagina.';
$_lang['All'] = 'ALLE';
...
$_lang['All platform courses'] = 'Alle bestaande cursussen';
$_lang['All profiles'] = 'Alle profielen';
$_lang['All users have been sucessfully unregistered from the class'] = 'Alle gebruikers werden met succes uit de klas verwijderd.';
$_lang['All visible submissions'] = 'Alle zichtbare ingaves';
$_lang['Allow a course manager to browse and link external resources reachable by an url'] = 'Sta een cursusbeheerder toe om te browsen en te linken naar externe bronnen bereikbaar via een URL.';
$_lang['Allow a course manager to browse and link resources in any public course'] = 'Sta een cursusbeheerder toe om te browsen en te linken naar bronnen in om het even welke publieke cursus.';
$_lang['Allow a course manager to browse and link resources in its other courses'] = 'Sta een cursusbeheerder toe om te browsen en te linken naar bronnen in zijn of haar andere cursussen.';
$_lang['Allow a course manager to browse and link resources located in a group space and in group tools'] = 'Sta een cursushebeerder toe om te browsen en te linken naar bronnen in een groepsruimte en in groepsonderdelen.';
...
$_lang['Allow enrolment/unenrolment to courses by the users'] = 'Sta het zich in cursussen in- en uitschrijven toe aan gebruikers.';
$_lang['Allow external resource linking'] = 'Sta het linken naar externe bronnen toe.';
$_lang['Allow group resource linking'] = 'Sta het linken naar groepsbronnen toe.';
$_lang['Allow late upload'] = 'Sta late upload toe';
$_lang['Allow other course resource linking'] = 'Sta het linken naar bronnen binnen andere cursussen toe.';
$_lang['Allow public course resource linking'] = 'Sta het linken naar bronnen binnen publieke cursussen toe.';
$_lang['Allow search in the add user option'] = 'Sta zoeken in de gebruiker toevoegen optie toe';
...
$_lang['An email has been sent to help you remember your user name and password.'] = 'Er werd je een e-mail gestuurd om je gebruikersnaam en paswoord op te frissen.';
...
$_lang['Are users allowed to create themselves a Course Creator account ?'] = 'Wordt aan gebruikers toegestaan zichzelf met een cursusbeheerder status te registreren?';
...
$_lang['Attached Resources : Add / Delete attachement'] = 'Voeg bron toe : voeg toe / verwijder een bestand ';
...
$_lang['Bold'] = 'Vet';
$_lang['Both private and Public course'] = 'Privé zowel als publieke cursus';
...
$_lang['CAS (Central Authentication Service)'] = 'CAS (Centrale Authenticatie Service)';
...
$_lang['Cannot register module %label'] = 'Kan de module %label niet registreren';
$_lang['Cannot register tool %label'] = 'Kan de tool %label niet registreren';
...
$_lang['Categories structure is right'] = 'Categorieën structuur correct';
...
$_lang['Change this setting only if it\'s absolutely required.'] = 'Wijzig deze instelling enkel indien absoluut noodzakelijk.';
...
$_lang['Changes in the display of the module have been applied'] = 'Wijzigingen in de weergave van de module werden toegepast';
...
$_lang['Common part of both parameters above.'] = 'Overeenkomend gedeelte van beide parameters hierboven';
...
$_lang['Confirm Operation'] = 'Bevestig deze operatie';
...
$_lang['Contact'] = 'Contacteren';
$_lang['Contact your administrator.'] = 'Contacteer je beheerder.';
$_lang['Content'] = 'Inhoud';
$_lang['Continue'] = 'Doorgaan';
$_lang['Conversion'] = 'Conversie';
$_lang['Conversion 1.7 to 1.8'] = 'Conversie 1.7 naar 1.8';
$_lang['Copy'] = 'Knippen';
$_lang['Copy any text you are currently writing and paste it outside the browser'] = 'Kopieer de tekst die je momenteel aan het tikken bent en plak hem ergens buiten de browser';
...
$_lang['Course Manager'] = 'Cursus beheerder';
...
$_lang['Course member (the user is actually enrolled in the course)'] = 'Cursusgebruiker (de gebruiker is voor de cursus werkelijk ingeschreven)';
...
$_lang['Course tools'] = 'Cursusgereedschappen';
$_lang['Course users list'] = 'Gebruikers in cursus';
$_lang['Course visitor (the user has an account on the platform, but is not enrolled in the course)'] = 'Cursusbezoeker (de gebruiker heeft een account op het platform, maar is niet voor de cursus ingeschreven)';
$_lang['Course visitor (the user has no account on the platform)'] = 'Cursusbezoeker (de gebruiker heeft geen account op het platform)';
$_lang['Courses'] = 'Cursussen';
$_lang['Courses : %disk_usage (perhaps with others directory)'] = 'Cursussen : %disk_usage (misschien in combinatie met andere mappen)';
...
$_lang['Data checkin'] = 'Gegevenscontrole';
...
$_lang['Dear %firstname %lastname, your personal settings have been registered.'] = 'Beste %firstname %lastname, je persoonlijke instellingen werden geregistreerd.';
$_lang['Debug'] = 'Debug';
...
$_lang['Definition file doesn\'t exist'] = 'Definitiebestand bestaat niet';
...
$_lang['Delete all event before %date in statistics'] = 'Verwijder alle events voor %date in statistieken';
...
$_lang['Development mode'] = 'Modus van de vakwerkgroep';
...
$_lang['Disk quota exceeded, please contact the %administrator'] = 'Disk quota overschreden, contacteer de %administrator a.u.b.';
...
$_lang['Display'] = 'Tonen';
$_lang['Display "Request a Course Creator status"'] = 'Toon "Een cursusbeheerdersaccount aanvragen"';
$_lang['Display "Request to be deleted from the platform"'] = 'Toon "Aanvraag om van het platform te worden verwijderd"';
$_lang['Display Settings'] = 'Toon instellingen';
$_lang['Display an agreement page before the "create user account" form'] = 'Toon een overeenkomstpagina voor het "gebruikersaccount aanmaken" formulier';
$_lang['Display authentication login form'] = 'Toon authenticatie login formulier';
$_lang['Display data'] = 'Toon gegevens';
$_lang['Display file'] = 'Toon bestand';
$_lang['Display link "Create user account" on the platform homepage.'] = 'Toon de link "Gebruikersaccount aanmaken" op de startpagina van het platform.';
$_lang['Display links to enrol/unenrol to course on the homepage of the user'] = 'Toon links op de startpagina van de gebruiker om zich in- of uit te schrijven voor cursussen.';
$_lang['Display of detailled answers is not authorized.'] = 'Toon de gedetaileerde antwoorden niet aan onbevoegden';
$_lang['Display options for Image Viewer'] = 'Toon opties voor de afbeeldingen viewer';
$_lang['Display the field official code in form'] = 'Toon het veld officiële code in het formulier';
$_lang['Display the logo of the organisation. (http://www.domain.tld/logo.gif)'] = 'Toon het logo van de organisatie. (http://www.domein.tld/logo.gif)';
$_lang['Display the logo of the platform. (http://www.domain.tld/logo.gif)'] = 'Toon het logo van het platform. (http://www.domein.tld/logo.gif)';
...
$_lang['Don\'t display email of the users to anonymous (to avoid spam)'] = 'Maak e-mailadres van gebruikers onzichtbaar voor anonieme gebruikers (om SPAM te vermijden)';
$_lang['Down'] = 'Omlaag';
...
$_lang['Encrypt exported password using md5 algorithm'] = 'Encrypteer geëxporteerde paswoorden d.m.v. md5 algoritme';
...
$_lang['Enrolment allowed only'] = 'Inschrijving reeds toegestaan';
$_lang['Enrolment allowed or not'] = 'Inschrijving toegestaan of niet';
$_lang['Enrolment denied only'] = 'Inschrijving enkel verboden';
$_lang['Enrolment key'] = 'Inschrijvingssleutel';
$_lang['Enter'] = 'Log in';
...
$_lang['Enter the description of your wiki here'] = 'Geef hier een omschrijving voor de nieuwe Wiki in.';
...
$_lang['Error : Class has sub-classes'] = 'Error : Klas heeft subklassen';
$_lang['Error : Class not found'] = 'Error : Klas niet gevonden';
...
$_lang['Error : no file uploaded'] = 'Error : Geen bestand verstuurd';
$_lang['Error : no zlib extension found'] = 'Error : Zlib extensie niet gevonden';
...
$_lang['Error while deleting the scripts of the module'] = 'Error bij het verwijderen van modulescripts';
...
$_lang['Example : http://www.yourdomain.tld/mycampus/'] = 'Voorbeeld : http://www.jouwdomein.tld/mijncampus/';
...
$_lang['Explain cannot be empty'] = 'Uitlegveld kan niet leeg zijn';
...
$_lang['File are always created in cache, but if this value is true feed file in cache arent rebuilt on request if exiting in cache.'] = 'Bestanden worden altijd aangemaakt in de cache, maar als deze waarde true is, worden feedbestanden niet heraangemaakt op aanvraag wanneer de cache wordt verlaten.';
...
$_lang['Fill the area to explain your motivation and submit your request. An e-mail will be sent to platform adminisrator(s).'] = 'Gebruik deze zone om uw motivatie uit te leggen en dien uw vraag in. Een e-mail zal naar de administrators van het platform verzonden worden.';
...
$_lang['Garbage : %disk_usage'] = 'Afval : %disk_usage';
...
$_lang['Go to documents tool'] = 'Ga naar de documentensectie';
...
$_lang['Hide course categories to anonymous'] = 'Verberg cursuscategoriën voor anonieme gebruikers';
$_lang['Hide email address to anonymous user'] = 'Verberg het e-mailadres voor anonieme gebruikers';
$_lang['Hits'] = 'Hits';
...
$_lang['If activated course administrator will receive an email every time a submission is made.  Students will receive an email adivising them that their work has been marked.'] = 'Indien geactiveerd zal de cursusbeheerder een e-mail ontvangen telkens een nieuwe taak werd ingediend. Studenten ontvangen een e-mail wanneer hun werk van een commentaar en/of score werd voorzien.';
$_lang['If after while no message appears confirming the course creation, please click <a href="%url">here</a>'] = 'Wanneer na een tijdje geen bericht verschijnt dat de cursus is gemaakt, klik <a href="%url">hier</a>';
$_lang['If false, other field are optional'] = 'Indien niet waar, zijn de andere velden optioneel';
...
Qua relevantie is het toch interessant niet te werken met een te korte waarde.';
$_lang['If you do not have the key, please contact the course manager'] = 'Indien je niet beschikt over de sleutel, contacteer je best de platformbeheerder.';
$_lang['If you haven\'t a user account yet, use the <a href="%url">the account creation form</a>.'] = 'Indien je nog niet beschikt over een gebruikersaccount, gebruik het <a href="%url">gebruikersaccount aanmaken</a> formulier.';
$_lang['If you wish to enrol on this course'] = 'Indien U wil inschrijven in deze cursus';
$_lang['Image Viewer'] = 'Afbeelding Viewer';
...
$_lang['Imported exercises must be an ims-qti zip file.'] = 'Geïmporteerde oefeningen moeten het ims-qti zipfile formaat hebben. VosLO oefeningen volgen uiteraard die standaard.';
...
$_lang['In iCal, an event have a duration, but not in claroline. 3600 = 1 Hour.'] = 'In iCal heeft een event een duur, maar niet in claroline. 3600 = 1 uur.';
$_lang['Increase the security of file download. This option only works on Apache Server. To be really secure, this option have to be completed by an .htaccess file on the course folders.'] = 'Verbeter de beveiliging van bestandsdownload. Deze optie werkt enkel met een Apache Webserver. Om helemaal veilig te zijn moet deze instelling vergezeld gaan door een .htaccess bestand in de cursusfolders.';
...
$_lang['Install module'] = 'Installatie module';
...
$_lang['Manage External link'] = 'Externe links toevoegen/beheren';
...
$_lang['Memorize them, you will use them the next time you will enter to this site.'] = 'Onthoud ze, u hebt ze nodig als u de volgende keer wilt inloggen.';
...
$_lang['Module'] = 'Module';
$_lang['Module %module is already installed on your platform'] = 'De module %module is reeds op je platform geïnstalleerd';
...
$_lang['Module added in dock : %dock'] = 'Module toegevoegd in de dock : %dock';
...
$_lang['Module deactivation failed'] = 'Module uitschakelen is mislukt';
...
$_lang['No email address specified'] = 'Geen e-mailadres opgegeven';
...
$_lang['No, rebuild the file on each request'] = 'Neen, bouw het bestand opnieuw op bij elke aanvraag';
...
$_lang['Note : this repository should be protected with a .htaccess or
       be placed outside the web. Because there contain data of private courses. Claroline Would be able to read and write in this dir'] = 'Opmerking:  deze opslagplaats moet beschermd worden door een .htaccess of van webtoegang worden afgesloten omdat ze gegevens van privécursussen bevat. Claroline moet in deze map kunnen lezen en schrijven.';
...
$_lang['Number of columns displayed per page'] = 'Aantal weergegeven kolommen per pagina';
...
$_lang['Number of exercices per page'] = 'Aantal oefeningen per pagina';
...
$_lang['Operation impossible.'] = 'Operatie is onmogelijk.';
...
$_lang['Private access (site accessible only to people on the <a href="%url">user list</a>)'] = 'Privé toegang (site enkel toegankelijk voor mensen in de <a href="%url">gebruikerslijst</a>)';
...
$_lang['Private&nbsp+ New Registration allowed'] = 'Privé&nbsp+ Nieuwe registratie toegestaan';
...
$_lang['Public feedback'] = 'Gepubliceerd commentaar';
$_lang['Public&nbsp;&nbsp;+ New Registration allowed'] = 'Publieke&nbsp;&nbsp;+ Nieuwe registratie toegestaan';
$_lang['Public&nbsp;&nbsp;+ New Registration denied'] = 'Publieke&nbsp;&nbsp;+ Nieuwe registratie verboden';
...
$_lang['Remove from the dock'] = 'Verwijder uit de dock';
$_lang['Rename'] = 'Hernoemen';
$_lang['Rename %filename in'] = 'Hernoem %filename naar';
...
$_lang['Right'] = 'Rechten';
$_lang['Right Profile'] = 'Rechtenprofiel';
...
$_lang['Secure document download'] = 'Veilige documentendownload';
...
$_lang['Send this announcement by email to registered students'] = 'Stuur deze aankondiging per e-mail naar alle studenten';
...
$_lang['Set the editor that will replace standard html textarea.'] = 'Stel de editor in die de standaard html tekst zal vervangen.';
...
$_lang['Show all'] = 'Alles uitvouwen';
$_lang['Show answers'] = 'Toon antwoorden';
$_lang['Show differences'] = 'Toon verschillen';
$_lang['Show groups in resource browser'] = 'Toon groepen in de resource browser';
...
$_lang['Submission'] = 'Ingave';
$_lang['Submission type'] = 'Type ingediende items';
$_lang['Submission visibility'] = 'Zichtbaarheid van ingave';
...
$_lang['Teacher can add a user in his course'] = 'Docent kan een gebruiker in zijn cursus toevoegn';
$_lang['Teacher can import an existing class course'] = 'Docent kan een bestaande klas in zijn cursus toevoegen';
$_lang['Teacher can import user list in his course'] = 'Docent kan een lijst met gebruikers in zijn cursus importeren';
$_lang['Technical Tools'] = 'Technische gereedschappen';
$_lang['Temporary folder missing'] = 'Map met tijdelijke bestanden ontbreekt';
$_lang['Text displayed if a user tries to enrol in a course requiring a key'] = 'Weer te geven tekst wanneer een gebruiker in een cursus probeert in te schrijven waarvoor een sleutel is vereist.';
$_lang['Text displayed if a user tries to enrol in a locked course'] = 'Weer te geven tekst wanneer een gebruiker in een afgesloten cursus probeert in te schrijven';
$_lang['Text displayed on the "Create user account" page'] = 'Weergegeven tekst op de "Gebruikersaccount aanmaken" pagina';
$_lang['Text displayed on the "My user account" page'] = 'Weergegeven tekst op de "Mijn profiel" pagina';
$_lang['Text displayed on the right column'] = 'Weergegeven tekst in de rechterkolom';
...
$_lang['The domain that the cookie is available.  To make the cookie available on all subdomains of example.com, you\'d set it to ".example.com". The . is not required but makes it compatible with more browsers. Setting it to www.example.com  will make the co'] = 'Het domein waarvoor de cookie beschikbaar is. Om de cookie voor alle subdomeinen van voorbeeld.com beschikbaar te maken, moet je het op ".example.com" instellen. Het . is nodig, maar maakt het compatibel met meerdere browsers.';
...
$_lang['The information have been modified'] = 'De gegevens werden aangepast';
$_lang['The module has been removed from this dock'] = 'De module werd uit deze dock verwijderd';
...
$_lang['There is a folder called <b><i>%module_name</i></b> for which there is no module installed.'] = 'Er is een folder <b><i>%module_name</i></b> waarvoor er geen module is geïnstalleerd.';
$_lang['There is a module installed in DB : <b><i>%module_name</i></b> for which there is no folder on the server.'] = 'Er is een module geïnstalleerd in de DB : <b><i>%module_name</i></b> waarvoor er geen folder is op de server.';
$_lang['There is an error in exercise data of imported file.'] = 'Er zit een fout in de oefeninggegevens van het geïmporteerde bestand.';
...
$_lang['These informations are displayed on the footer of the platform'] = 'Deze info wordt onderaan het platform weergegeven';
...
$_lang['This course requires a key for enrolment'] = 'Deze cursus vereist een inschrijvingssleutel';
$_lang['This day'] = 'Vandaag';
$_lang['This is the faculty, department or school where the course is delivered'] = 'Hier komt de naam van de school waar de cursus wordt gegeven';
$_lang['This is the main page of the Wiki %s. Click on \'\'\'Edit\'\'\' to modify the content.'] = 'Dit is de hoofdpagina van Wiki: %s. Klik op \'\'\'Wijzig deze pagina\'\'\' om de inhoud te wijzigen';
$_lang['This is the main page of the Wiki %wikiTitle. Click on \'\'\'Edit\'\'\' to modify the content.'] = 'Dit is de hoofdpagina van de Wiki %wikiTitle. Klik op \'\'\'Wijzigen\'\'\' om de inhoud ervan aan te passen.';
...
$_lang['This password is too simple. Use a password like this <code>%passProposed</code>'] = 'Dit paswoord is te eenvoudig. Gebruik een paswoord zoals dit <code>%passProposed</code>';
$_lang['This prefix could allow to order more easily the tables / DB in the user interface of your server technical back office  '] = 'Dit prefix maakt het mogelijk om de tabellen ordelijker te krijgen in de DB.';
...
$_lang['This text layout should be modified to be editable in this editor. Cancel to keep your original text layout.'] = 'Deze tekst layout moet gewijzigd worden om aanpasbaar te zijn in deze editor. Kies ongedaan maken om je originele tekst layout te behouden.';
...
$_lang['Time'] = 'Tijd (s.)';
$_lang['Time before really compute data. 86400 = 1 day.'] = 'Tijd voor het werkelijk verrekenen van de gegevens. 86400 = 1 dag.';
...
$_lang['To'] = 'naar';
$_lang['To install this module click <a href="%url">here</a>.'] = 'Om deze module te installeren klik <a href="%url">hier</a>.';
...
$_lang['Tool list'] = 'Lijst met onderdelen';
...
$_lang['Unable to create zip file'] = 'Kan Zip bestand niet aanmaken';
...
$_lang['Unknown question format in file %file'] = 'Onbekend vraagformaat in bestand %file';
...
$_lang['Use Jpspan mode for the resource linking utility. Warning : Jpspan does not work on IIS web servers.'] = 'Gebruik Jpspan modus voor het resource linking tool. Waarschuwing : Jpspan werkt niet op IIS webservers.';
$_lang['Use SSO system'] = 'Gebruik SSO systeem';
$_lang['Use format defined in first line of file'] = 'Gebruik formaat zoals in de eerste regel van het bestand';
$_lang['Use it, and build  on change'] = 'Gebruik het en bouw op bij wijzigingen';
$_lang['Use negative weighting for incorrect choices to penalize a user that check all answers.'] = 'Gebruik negatieve score voor foute antwoorden om gebruikers die alles aanduiden tegen te gaan.';
$_lang['Use the cache'] = 'Gebruik de cache';
$_lang['Use the following format'] = 'Gebruik het volgende formaat';
...
$_lang['User account creation allowed'] = 'Aanmaken gebruikersaccount toegestaan';
...
$_lang['User registred in cours with unexisting (deprecated) status'] = 'Gebruiker geregistreerd in een cursus met een onbestaande (afgekeurde) status.';
$_lang['User request'] = 'Gebruiker aanvraag';
$_lang['User search in the user tool is allowed'] = 'Opzoeken van gebruikers in de gebruikerstool is toegelaten.';
...
$_lang['User\'s course settings'] = 'Gebruiker\'s cursussettings';
$_lang['Username'] = 'Gebruikersnaam (\'login\')';
$_lang['Username is too long (maximum 20 characters)'] = 'Gebruikersnaam is te lang (maximum 20 karakters)';
...
$_lang['Users can not submit after end date'] = 'Je kan niet indienen na de einddatum!';
...
$_lang['Users with similar settings exist on the system yet'] = 'Gebruiker(s) met gelijkaardige instellingen bestaan reeds op het systeem';
...
$_lang['WARNING ! You have just lost your session on the server.'] = 'OPGELET ! Je sessie op de server is net verlopen.';
$_lang['WARNING : you are going to delete this wiki and all its pages. Are you sure to want to continue ?'] = 'Waarschuwing : u gaat deze Wiki verwijderen en alle pagina\'s van deze Wiki. Wilt u doorgaan?';
...
$_lang['Warn users when they loose their session on the platform'] = 'Waarschuw gebruikers ervan dat ze hun sessie op de server verliezen';
$_lang['Warning the system distinguishes uppercase (capital) and lowercase (small) letters'] = ' Opgelet: het systeem maakt een onderscheid tussen hoofd- en kleine letters.';
...
$_lang['When users click on a document, it opens a new window'] = 'Wanneer gebruikers op een document klikken, opent dit een nieuw venster';
$_lang['When users click on a submitted file, it opens a new window'] = 'Wanneer gebruikers op een ingediend bestand klikken, opent dit een nieuw venster';
...
$_lang['Wiki creation succeed'] = 'Wiki met succes aagemaakt';
...
$_lang['Yes, and rebuild the file on change'] = 'Ja en herbouw het bestand bij wijziging';
...
$_lang['You can force the case  of course code'] = 'Je kan cursuscode in hoofdletters verplichten';
...
$_lang['You can set access rights for users using the following grid :'] = 'U kunt de toegangsrechten voor gebruikers wijzigen in de volgende tabel :';
$_lang['You can\'t move %facultyCode in the same category !'] = 'Je kan %facultyCode niet in dezelfde categorie verplaatsen!';
$_lang['You can\'t remove a group forum. You have to remove the group first'] = 'Je kan geen groepenforum verwijderen. Je moet eerst de groep verwijderen';
...
$_lang['You need an email in your profile'] = 'Een e-mailadres is verplicht in je profiel';
$_lang['You need to be authenticated with your %sitename account'] = 'Je moet aangemeld zijn met je %sitename account';
$_lang['You typed two different passwords'] = 'Je gaf twee verschillende paswoorden op';
...
Je bent geregistreerd op %siteName
    Login naam :  %username
    Paswoord  : %password
    Het adres van  %siteName
    is : %rootWeb
    Bij problemen, gelieve me te contacteren.
...
$_lang['blockForumNotificationEmailMessage'] = 'Beste %firstname %lastname,

Je ontvangt deze e-mail omdat een nieuw bericht werd toegevoegd bij één van je favoriete onderwerpen in onze forums en je aangaf hiervan op de hoogte te willen worden gesteld.

Je vindt de thread op:

%url_topic

De forum-index vind je op:

%url_forum

Bedankt voor het gebruik van het forum.';
...
$_lang['blockUsersWithoutValidEmail'] = 'Op %userQty geregistreerde gebruikers, hebben %userInvalidQty gebruikers een ongeldig of geen mailadres.
%messageFailed';
...
<dd>Klik op het icoon \'instellingen\' om de instellingen vervolgens te wijzigen .</dd>
...
<li><b>Wijzig pagina\'s</b> : Deze insteling zorgt dat dit type kan pagina\'s wijzigen in het Wiki</li>
<li><b>Maak pagina\'s</b> : Deze insteling zorgt dat dit type kan pagina\'s maken in het Wiki</li>
</ul><small><em>(*) een gebruiker kan geen nieuwe pagina\'s aanmaken als hij deze niet kan wijzigen , tevens kan hij als hij ze kan maken dan kan hij ze altijd lezen.</em></small></dd>
...
$_lang['lines'] = 'lijnen';
$_lang['max. 12 characters, e.g. <em>ROM2121</em>'] = 'max. 12 lettertekens - gebruik bij voorkeur klas of graad, bijv. <i>2LGb</i>';
$_lang['min.'] = 'min.';
$_lang['multi'] = 'multi';
...
$_lang['number'] = 'aantal';
$_lang['only for new works'] = 'enkel voor nieuwe werken';
$_lang['previous level'] = 'Vorig niveau';
$_lang['rebuild file on each request'] = 'herbouw het bestand bij elke aanvraag';
