...
$langHomeContent="De meeste functies zijn al ingevuld met een korte tekst of met een link. Die zijn als standaard, of als voorbeeld gegeven. Deze moet u zelf wijzigen.</p><p>Op deze manier heeft uw cursussite volgende hoofdtekst: ‘Dit is de inleidende tekst van uw cursussite...’ U kunt deze tekst wijzigen. <b>Tip: Gebruik deze tekst om uw studenten wegwijs te maken in uw cursussite. Dit kan noodzakelijk zijn voor de goede zichtbaarheid van uw realisaties in de cursussite</b>.</p><p>Waneer U een site creëert zijn een aantal werkmiddelen standaardsgewijs geactiveerd (Agenda, Cursusmaterialen, Oefeningen...). Het is aanbevolen die functies die u niet gebruikt te inactiveren, zodat de gebruikers en bezoekers geen tijd verliezen door te zoeken op de verkeerde plaatsen.</p><p>U kunt ook pagina’s toevoegen aan de startpagina. Gebruik daarvoor de tool 'Pagina toevoegen aan de startpagina' om de pagina naar de server te sturen. Indien u naar een pagina of een reeds bestaande website wilt verwijzen, gebruik de tool 'Link toevoegen aan startpagina'. De pagina's en de links die u toevoegt, kunt u inactiveren en nadien verwijderen.  Dit verschilt van de standaardfuncties, dewelke u kunt inactiveren, maar niet verwijderen.</p><p>U krijgt tevens de keuze uw cursus zichtbaar of onzichtbaar in de cursuslijst te plaatsen. Het kan wenselijk zijn een cursus 'in aanmaak' niet in de cursuslijst te laten verschijnen(zie functie 'Eigenschappen van de cursus') en zodoende privé blijft zodat niemand zich kan registreren op de cursussite zolang de cursussite in ontwikkeling is.</p>";
