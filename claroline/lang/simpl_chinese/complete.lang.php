...
$langAddForums = "添加新论坛,请在论坛所属分类中点籠"论蘚". 对学生来说,空类别(不含有论坛)是不可见的.";
$langAddIntro = "添加课程介绍信息";
$langAddIntro = "添加课程介绍";
$langAddIntro = "增加课程介绍";
$langAddIntro = "增加课程说明";
$langAddIntro = ".$(ATv<S?N3L=iI\.(B";
$langAddPage = "添加网页";
$langAddress = "地址 ";
$langAdm = "管理";
$langAdmin = "网站管理";
$langAdminBy = "系统管理";
$langAdministrationTools = "课程管理";
...
$langCreateClaroTables = "为主数据库创建表";
$langCreateDir = "创建目录";
$langCreateSite = "创建课程";
$langDate = "日期";
$langDay = "日";
...
$langDelete = ".$(AI>3}.(B";
$langDescription = "简介";
$langDescription = "文章摘要";
$langDetail = "内容";
$langDetail = "详细信息";
$langDiffTranslation = "翻译比较";
$langDirCr = "目录已创建";
$langDirMv = "目录已移动";
$langDoc = "讲义材料";
...
$langExplanation = "网页必须是HTML格式(比如\"my_page.ht\").它 将会成为主页上的一个链接. 如果需要发送非HTML格式(PDF, Word, Power Point, Video,等等)文件,请使用 <a href=../document/document.php>课程讲义</a>";
$langFac = "院系";
$langFaculty = "类属";
$langFields = "您有些选项未填写.";
...
$langLinks = "相关链接";
$langLinkSite = "添加链接";
$langLinksToClaroProjectSite = "Claroline网站链接";
$langLn = "语言";
...
$langPersonalSettings = "您的个人资料已登记,为帮助您记忆您的用户名和密码,我们已向您的信箱发送了一封邮件.</p>现在请选择您的课程.";
$langPgTitle = "网页标题";
$langPoweredBy = "技术支持";
...
$langStatus = "操作选项";
$langStudent = "学生";
$langSubTitle = "为课程主页菜单增加到网站,网页或者任何的网址的链接. 提示:如果您需要增加一个到某一网页的链接,可以先访问那个网页,复制浏览器上部地址栏里的地址,然后添加到下面礬"链絓"栏.";
$langSysInfo = "系统工具";
$langTableStructureDontKnow = "这张表的结果未知";
...
$langUserFree = "用户名已被占用!返回重新选择用户名.";
$langUserName = "用户名";
$langUserNo = "您选择的用户名 ";
$langUsers = "用户列表";
$langUsers = "用户";
...
$l_password = "密码";
$l_perday = "消息 每天";
$l_pmposted = "回复文章已张贴, 您可以点击<a href\"viewpmsg.ph\">这里</a> 来阅读内部 消息";
$l_posted = "张贴";
$l_poster = "张贴者";
$l_posts = "文章";
$l_profile = "个人资料";
$l_profileof = "阅读个人资料";
$l_publicmail = "允许其他用户看到我的邮件地址 邮件地址";
$l_quotemsg = "[引用]\n在 %s1, %s2 写到:\n%s3\n[/引用]";
$l_recptname = "接收者用户名";
$l_replies = "回复";
$l_reply = "回复";
...
$l_tryagain = "请返回重试.";
$l_url = "网址";
$l_userdisallowed = "用户名 这个用户名已被管理员禁止. 请返回重试.";
$l_username = "用户名";
$l_userpass = "请输入用户名和密码.";
$l_userremoved = "这个用户已经从用户数据库删除.";
$l_usertaken = " 用户名 已被使用.";
$l_viewforum = "阅读论坛.";
$l_viewmsg = "阅读您的 消息.";
