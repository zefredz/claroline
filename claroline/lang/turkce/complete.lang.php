...
$langAddForums = "Forum eklemek için seçtiðiniz kategorideki\"Forumla\" baðlantýsýný týklayýnýz. (Forumsuz) boþ kategoriler öðrenci arayüzünde görülmez";
...
$langExplanation = "Sayfa HTML formatýnda olmalýdýr (örnek:\"felsefe_odevi.ht\"). Eðer HTML olmayan bir dosya göndermek istiyorsanýz (PDF, Word, Power Point, Video, etc.) use <a href=../document/document.php>Belge Araçlarýný kullanýnýz</a>";
$langFac = "Kategori";
...
$langInfo2Say = "Öðrecilere verilecek bilgiler";
