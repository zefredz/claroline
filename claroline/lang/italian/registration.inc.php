...
$langLastname = "Cognome"; // by moosh
$langEmail = "Posta elettronica";// by moosh
$langRetrieve ="Recupera le informazioni di identificazione";// by moosh
$langMailSentToAdmin = "E' stato spedito un avviso all'amministratore.";// by moosh
$langAccountNotExist = "Iscrizione non trovata.<BR>".$langMailSentToAdmin." per una ricerca manuale.<BR>";// by moosh
$langAccountExist = "Iscrizione trovata.<BR>".$langMailSentToAdmin."<BR>";// by moosh
$langWaitAMailOn = "Inviare un messaggio a ";// by moosh
$langCaseSensitiveCaution = "Attenzione! il sistema distingue le maiuscole e le minuscole.";// by moosh
