...
// Other SQL tables
$langAgendaTitle="¦roda 11-ty grudnia - Pierwsza lekcja: Newton 18";
$langAgendaText="Ogólne wprowadzenie do filozofii i zasad medodologii";
...
$langIntroductionText="To jest wprowadzenie do kursu. ¯eby wymieniæ tekst na swój w³asny, kliknij ³±cze <b>modyfikuj</b> poni¿ej.";
$langIntroductionTwo="Ta strona umo¿liwia poszczególnym studentom lub grupom za³adowaæ swoje opracowania na stronê kursu. Wysy³ane tu pliki HTML nie mog± zawieraæ obrazków.";
$langCourseDescription="Tu napisz opis, który poka¿e siê na li¶cie kursów.";
$langProfessor="Prowadz±cy";
$langAnnouncementEx="To jest przyk³adowe og³oszenie. Tylko prowadz±cy i administratorzy kursu mog± umieszczaæ og³oszenia.";
