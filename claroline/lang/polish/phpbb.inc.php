...
$l_subject="Temat";
$l_body="Wpisz $l_message";
$l_from="Od";   // Message from
...
$l_guest="Go¶æ"; // Whosonline
$l_noposts="Nr $l_posts";
$l_joined="Po³±czony";
$l_gotopage="Id¼ do strony";
$l_nextpage="Nastêpna strona";
$l_prevpage="Poprzednia strona";
$l_go="Id¼";
$l_selectforum="Wybierz $l_forum";
...
$l_returnindex="$l_toreturn do spisu Forów dyskusyjnych";
$l_returntopic="$l_toreturn do spisu tematów.";
...
$l_stored="Twoja $l_message zosta³a zapisana w bazie danych.";
$l_viewmsg="¿eby zobaczyæ $l_message.";
