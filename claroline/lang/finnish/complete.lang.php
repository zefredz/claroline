...
$_lang['Add introduction text'] = 'Lisää johdantoteksti';
...
$_lang['Back to Home page'] = 'Takaisin omalle sivulle';
...
$_lang['Name of the new directory'] = 'Uuden hakemiston nimi';
...
$_lang['On'] = 'On';
$_lang['Operation impossible'] = 'Toiminto on mahdoton';
$_lang['Operation impossible.<br />A file with this name already exists.'] = 'Toiminto on mahdoton.<br />Samanniminen tiedosto on olemassa.';
$_lang['Posted'] = 'Lähettänyt';
$_lang['Posts'] = 'Lähettäjät';
$_lang['Powered by'] = 'Alusta';
$_lang['Public access from campus home page even without login'] = 'Avoin pääsy sivuston omalta sivulta ilman sisäänkirjautumista';
...
$_lang['Return to the list'] = 'Takaisin listaan';
$_lang['Role'] = 'Rooli';
$_lang['Save'] = 'Tallenna';
$_lang['Seen'] = 'Nähty';
...
$_lang['The information has been modified'] = 'Tietoja on muutettu';
...
$_lang['Visibility modified'] = 'Näkyvyyttä on muutettu';
...
$_lang['Your new profile has been saved'] = 'Profiili on tallennettu';
$_lang['blockCourseDescriptionDescription'] = 'tehtävän kuvaus';
