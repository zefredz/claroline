...
$_lang['You can personalize the layout of each course'] = 'You can personalize the layout of each course.  To do so, create a file named "style.php" containing your 
<acronym title="Cascading Style Sheet">CSS</acronym> rules and structured as in the example.  Then put it in the course\'s directory.<br/><br/>
Example: <br/>&lt;?php<br/>$courseStyle = \'<br/>body<br/>{<br/>&nbsp;&nbsp;background: blue;<br/>}<br/>\';';
