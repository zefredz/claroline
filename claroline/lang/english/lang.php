...
$langAnnouncements="Annoucements";
$langLinks="Links";
$langWorks="Student works";
$langUsers="Users";
$langStatistics="Statistics";
$langCourseProgram="Course program";
$langAddPageHome="Add page and link to Home";
$langLinkSite="Link to site from Homepage";
$langModifyInfo="Modify course info";
$langDeactivate="deactivate";
$langActivate="activate";
$langInactiveLinks="Inactive links";
