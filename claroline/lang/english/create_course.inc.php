...
$langSampleHandmade = "Sample handmade module";
$langSampleHandmadeDesc = "You can make an \'handmade\' module using html pages, flash animations, vidéos, sound files (mp3, ogg,..)<br /><br /> To allow students to view the content of your newly created module you\'ll have to set a start page (asset) for the module.";
...
$langAnnouncementExTitle = "Announcement example";
$langAnnouncementEx="This is an announcement example. Only course managers are allowed to publish announcements.";
$langJustCreated="You just created the course website";
$langEnter="Back to my course list";
...
//Display
$langCreateCourse="Create courses";
