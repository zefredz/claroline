...
$langGroupForumLink="Di?n dàn nhóm";
...
$l_messages	= "Bài";
$l_subject	= "Subject";
$l_body		= "N?i dung $l_message";
$l_from		= "Ngu?i g?i";   // Message from
$l_moderator 	= "Ngu?i di?u hành";
$l_username 	= "Username";
$l_password 	= "Password";
$l_email 	= "Email";
...
$l_anonymous	= "Vô danh";  // Post
$l_guest	= "Guest"; // Whosonline
$l_noposts	= "No $l_posts";
$l_joined	= "Joined";
$l_gotopage	= "Ð?n trang";
$l_nextpage 	= "Trang k? ti?p";
$l_prevpage     = "Trang tru?c";
$l_go		= "OK";
$l_selectforum	= "Ch?n $l_forum";
...
$l_here 	= " t?i dây";
$l_toreturn	= "d? tr? v?";
$l_returnindex	= "$l_toreturn danh m?c di?n dàn";
$l_returntopic	= "$l_toreturn danh m?c ch? d?.";
...
$l_nopost	= "Không có quy?n g?i bài.";
$l_noread	= "Không có quy?n truy c?p.";

$l_lastpost 	= "$l_post g?n nh?t";
$l_sincelast	= "t? l?n vi?ng tham cu?i c?a b?n";
$l_newposts 	= "$l_posts m?i $l_sincelast";
$l_nonewposts 	= "Không có $l_posts m?i $l_sincelast";
...
$l_moderatedby	= "Ði?u hành b?i";

// Private forums
$l_privateforum	= "Ðây là <b>di?n dàn c?a thành viên (h?n ch?)</b>.";
$l_private 	= "$l_privateforum<br>Note: you must have cookies enabled in order to use private forums.";
$l_noprivatepost = "$l_privateforum B?n không th? g?i bài vào dây.";

// Viewtopic
$l_topictitle	= "Xem $l_topic";
$l_unregistered	= "Ngu?i dùng chua dang ký";
$l_posted	= "Ngày";
$l_profileof	= "Xem lý l?ch c?a";
$l_viewsite	= "Ð?n tham website c?a";
$l_icqstatus	= "$l_icq status";  // ICQ status
$l_editdelete	= "S?a/Xoá $l_post này";
$l_replyquote	= "Tr? l?i có trích d?n";
$l_viewip	= "View Posters IP (Moderators/Admins Only)";
$l_locktopic	= "Khoá $l_topic này";
$l_unlocktopic	= "M? khoá $l_topic này";
$l_movetopic	= "Di chuy?n $l_topic này";
$l_deletetopic	= "Xoá $l_topic này";

// Functions
$l_loggedinas	= " ";
$l_notloggedin	= "Chua log in";
$l_logout	= "Logout";
$l_login	= "Login";
...
$l_editprofile	= "S?a thông tin cá nhân";
$l_editprefs	= "Hi?u ch?nh $l_preferences";
$l_search	= "Search";
$l_memberslist	= "Danh sách thành viên";
$l_faq		= "H?i dáp";
$l_privmsgs	= "$l_messages riêng tu";
...
$l_stored	= "$l_message c?a b?n dã du?c luu.";
$l_viewmsg	= "d? xem $l_message.";
$l_deleted	= "$l_post dã b? xoá.";
