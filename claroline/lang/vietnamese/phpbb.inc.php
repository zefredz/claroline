...
$l_messages	= "Bài";
$l_subject	= "Subject";
$l_body		= "Nội dung $l_message";
$l_from		= "Người gửi";   // Message from
...
$l_returnindex	= "$l_toreturn danh mục diễn đàn";
$l_returntopic	= "$l_toreturn danh mục chủ đề.";
...
$l_lastpost 	= "$l_post gần nhất";
$l_sincelast	= "từ lần viếng thăm cuối của bạn";
$l_newposts 	= "$l_posts mới $l_sincelast";
$l_nonewposts 	= "Không có $l_posts mới $l_sincelast";
...
$l_noprivatepost = "$l_privateforum Bạn không thể gửi bài vào đây.";
...
$l_editprefs	= "Hiệu chỉnh $l_preferences";
$l_search	= "Search";
$l_memberslist	= "Danh sách thành viên";
$l_faq		= "Hỏi đáp";
$l_privmsgs	= "$l_messages riêng tư";
...
$l_stored	= "$l_message của bạn đã được lưu.";
$l_viewmsg	= "để xem $l_message.";
$l_deleted	= "$l_post đã bị xoá.";
