...
$langAddForums = "Para agregar foros, hacer click en\"Foro\" en la categoría escogida.
...
$langExplanation = "La página tiene que estar en formato HTML (p.e.\"mi_pagina.ht\"). Ésta podrá ser enlazada desde la página principal. Si desea enviar documentos que estén en formato HTML (PDF, Word, Power Point, Video, etc.) use las <a href=../document/document.php>Herramientas de documentos</a>";
$langExplanation = "Esta página debe estar en formato HTML (por ejemplo\"mi_pagina.ht\"). Aparecerá  el enlace en la página principal de su sitio. Si usted desea enviar un documento que no está en formato HTML (PDF, Power Point, Word...) utilice la función <a href=../document/document.php> Documentos</a>";
...
$langIn = "en";
$langIndeed = "Correcto. La ironía socrática es un metódo interrogativo. El término griego\"eirota\" significa , por otro lado,\"interroga\".";
...
$langLogin = "Ingreso";
$langLoginBeforePost1 = "Para agregar mensajes en el foro, ";
$langLoginBeforePost2 = "antes que nada, usted debe ";
$langLoginBeforePost3 = "ingresar al Campus";
...
$langMessage = "En el momento que usted suprima el foro\"Foro de prueba\", igualmente se suprimirá el presente tema que no contiene más que este mensaje";
$langMinute = "Minutos";
...
$langOkSentLink = "Su enlace ha sido enviado.<p>Ahora está accesoble desde la  <a href\"../..//index.ph\">Página principal del curso</a>";
$langOkSentPage = "Su página ha sido enviada.<p>Ahora está enlazada desde la <a href\"../..//index.ph\">Página principal del curso</a>";
...
$l_aim = "AIM";
$l_author = "Autor";
$l_banned = "Ha sido dado de baja de este foro. Si tiene preguntas, por favor contacte al administrador del sistema.";
$l_body = "";
$l_by = "por";
...
$l_enterpassword = "Debe escribir su contraseña.";
$l_error = "Error";
$l_forum = "Foro";
$l_forums = "Foros";
$l_from = "De";
...
$l_mismatch = "Las contraseñas no corresponden.";
$l_msn = "MSN";
$l_new = "Nuevo";
...
$l_norecipient = "Debe escribir el nombre del usuario a quien desea enviar el Mensaje.";
...
$l_publicmail = "Permitir a otros usuarios ver mi Dirección de correo electrónico";
$l_quotemsg = "[quote]\nEl %s1, %s2 escribió:\n%s3\n[/quote]";
...
$l_separator = "» »";
$l_sigexplain = "Texto que puede ser agregado a los mensajes que env&iacute;a al foro.<BR>255 caracteres como m&aacute;ximo!";
$l_signature = "Firma";
...
$l_url = "URL";
$l_userdisallowed = "El Nombre de Usuario elegido ha sido desautorizado por el administrador. Por favor regrese y vuelva a intentarlo.";
$l_username = "Nombre de Usuario";
$l_userpass = "Por favor escriba su nombre de usuario y su contraseña.";
$l_userremoved = "El usuario con esa contraseña ha sido dado de baja de la base de datos.";
$l_usertaken = "El Nombre de Usuario que ha elegido, ya existe.";
$l_viewforum = "Ver Foro";
$l_viewmsg = "para ver su Mensaje.";
$l_viewpostuser = "Ver los mensaje enviados por ese usuario";
$l_website = "Direcci&oacute;n del sitio Web";
$l_whosonline = "&iquest;Qui&eacute;n est&aacute; en l&iacute;nea?";
$l_wrongpass = "Contraseña equivocada.";
