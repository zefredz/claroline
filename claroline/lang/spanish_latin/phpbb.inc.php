...
$l_userdisallowed = "El $l_username elegido ha sido desautorizado por el administrador. $l_tryagain";
...
$l_faq		= "FAQ (respuestas a preguntas frecuentes)";
...
$l_poweredby	= "Funciona con";
$l_version	= "Versi&oacute;n";

// Auth

// Register
$l_notfilledin	= "Error - no ha llenado todos los campos obligatorios.";
...
$l_welcomesubj	= "Bienvenido a los Foros de $sitename";
$l_welcomemail	=
"
$l_welcomesubj,
...
Por favor no olvide su contraseña, &eacute;sta ha sido encriptada en nuestra base de datos y no ser&aacute; posible d&aacute;rsela posteriormente.
...
$email_sig
";
$l_beenadded	= "Usted ha sido agregado a la base de datos.";
$l_thankregister= "Gracias por registrarse!";
$l_useruniq	= "Debe ser &uacute;nica. Dos usuarios no pueden tener la misma clave.";
$l_storecookie	= "Guardar mi nombre de usuario en un 'cookie' durante un a&ntilde;o.";
...
$l_alwayssig	= "Siempre agregar mi firma";
...
// Sendpmsg
$l_norecipient	= "Debe escribir el nombre del usuario a quien desea enviar el $l_message.";
...
// Sendpasswd
$l_wrongactiv	= "La contraseña de activaci&oacute;n es incorrecta. Verifique el $l_message correo electr&oacute;nico que recibi&oacute; y aseg&uacute;rese de haber copiado la contraseña de activaci&oacute;n correctamente.";
$l_passchange	= "Su contraseña ha sido cambiada. En cualquier momento puede ir a su <a href=\"bb_profile.$phpEx?modo=editar\">perfil</a> y cambiar su clave de acceso.";
...
cambia la contraseña de acceso para los foros de $sitename. Si cree que ha recibido este
mensaje por error, ign&oacute;relo y su clave de acceso permanecer&aacute; igual.

Su nueva contaseña de acceso generada es: $newpw

Para que el cambio se lleva a cabo debe visitar la p&aacute;gina:

   http://$SERVER_NAME$PHP_SELF?actkey=$key

Una vez que visite esta p&aacute;gina, su contraseña de acceso ser&aacute; cambiada en nuestra base de datos,
...
$l_passsent	= "Su contraseña de acceso ha sido cambiada por una nueva, generada al azar. Verifique su correo electr&oacute;nico para saber c&oacute;mo terminar el proceso de cambio de clave de acceso.";
$l_emailpass	= "Contraseña de acceso perdida";
$l_passexplain	= "Por favor llene este formulario, le enviaremos una nueva contraseña de acceso a su correo electr&oacute;nico";
