...
$langPropositions="Lista de cosas para hacer para ";
$lang_subscribe_processing ="Proceso de registración";
$langAuthRequest = "Se necesita autentificación";
$langSubscribeDone = "Subscripción realizada";
$langAndGoBack ="volver";
$langAlreadySubscribe ="ya está inscripto";
