...
$langVideo       = "Video";
$langFileNot     = "El archivo no se pudo enviar";
$langTooBig      = "No eligió ningún archivo o el archivo es demasiado grande.";
$langListDel     = "La lista ha sido borrada completamente";
$langBList       = "Regresar a la lista";
$langTitleMod    = "El título del documento ha sido modificado";
$langFAdd        = "El archivo ha sido agregado";
$langDelF        = "El archivo ha sido borrado.";
$langAddV        = "Agregar un archivo de audio o video";
$langsendV       = "Enviar audio/video";
$langDocTitle    = "Título del documento";
