...
$langAddressProgram = "Dirección del programa del curso";
$langIfNoAppear     = "Si el programa del curso no aparece abajo, lo puede encontrar en el";
$langCorrectIt      = "Catálogo de cursos</a>, corrija la dirección en el campo siguiente y después acepte";
$langOut            = "Usted ha salido del curso";
$langCome           = "Para regresar, haga un click ";
$langBack           = "aquí;";
