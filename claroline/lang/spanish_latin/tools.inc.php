...
// image_upload.php
$langimage_upload="Enviar imagen";
$langimage_assist="Asistente para enviar imagen";
$langloadimage="Cargar imagen";
$langFileToLoad="Archivo para cargar :";
$langFileLoaded="Archivo cargado :";
$langFileName="Descripción de la imagen (máx. 254 car.) :";
$langAddArea="Agregar áreas sensibles  -->";
$langSaveImg="Grabar imagen";
$langEditimage="Editar imagen";
$langUpdateQ="Actualizar pregunta";
