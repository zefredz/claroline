...
$_lang['%count_course_to_upgrade course(s) to upgrade'] = '%count_course_to_upgrade curso(s) a revisar';
$_lang['%count_course_upgraded courses on %count_course already upgraded'] = '%count_course_upgraded cursos de %count_course revisados';
...
$_lang['A list of keys allowing requests to the Claroline SSO server. The SSO client has to provide one of the keys contained into this list to receive any answer from the Claroline SSO server.'] = 'La lista de claves para atender peticiones al servidor Claroline SSO. El cliente SSO client tiene que presentar una de las claves de la lista para obtener respuesta del servidor Claroline SSO.';
...
$_lang['Access to campus'] = 'Acceder al campus';
...
$_lang['Cache management'] = 'Gestión de caché';
...
$_lang['Cannot delete service %service'] = 'No se puede borrar el servicio %service';
...
$_lang['Claroline Upgrade Tool<br />from %currentClarolineVersion to %new_version'] = 'Claroline Upgrade Tool<br />de %currentClarolineVersion a %new_version';
...
$_lang['Click on the following link if you want to enroll to this course'] = 'Pulse en el enlace siguiente si desea matricularse ahora.';
...
$_lang['Course language selector'] = 'Idiomas de cursos';
...
$_lang['Display all'] = 'Mostrar todos';
...
$_lang['File count'] = 'Número de archivos';
...
$_lang['Folder %path cleaned up'] = 'Carpeta %path vaciada';
$_lang['Folder %path does not exists'] = 'Carpeta %path inexistente';
...
$_lang['Impossible to add the announcement'] = 'Imposible añadir anuncio';
$_lang['Impossible to modify the announcement'] = 'Imposible modificar anuncio';
...
$_lang['Launch course data upgrade'] = 'Revisar datos de los cursos';
$_lang['Launch main platform tables upgrade'] = 'Revisar tablas de la plataforma';
$_lang['Launch platform main settings upgrade'] = 'Revisar ajhustes de la plataforma';
$_lang['Layout'] = 'Diseño';
...
$_lang['Manage cache'] = 'Gestión de caché';
...
$_lang['Manage webservices keyring'] = 'Gestión de claves de servicios web';
...
$_lang['Maximum lines in the active chat file. For performance, it\'s interesting to not work with too big file.'] = 'Cantidad máxima de líneas en el archivo de la conversación activa. Para un mejor rendimiento, se recomienda no trabajar con un archivo muy grande.';
...
$_lang['Merging users will alter the user data and cannot be undone. Are you sure to want to continue ?'] = 'La fusión de los usuarios va a alterar los datos del usuario y no se puede deshacer. ¿Está seguro de querer continuar?';
...
$_lang['Missing new service host'] = 'Falta el nombre del equipo para el nuevo servicio';
$_lang['Missing new service key'] = 'Falta la clave para el nuevo servicio';
$_lang['Missing new service name'] = 'Falta el nombre del nuevo servicio';
$_lang['Missing old service name or host'] = 'Falta un nombre de equipo o servicio previo';
...
$_lang['Missing service host'] = 'Falta el nombre del equipo para el servicio';
$_lang['Missing service key'] = 'Falta la clave para el servicio';
$_lang['Missing service name or host'] = 'Falta el nombre del servicio o del equipo';
$_lang['Missing service name, key or host'] = 'Falta el nombre del servicio, del equipo o la clave';
...
$_lang['My last messages'] = 'Mis últimos mensajes';
...
$_lang['New users will receive an e-mail with their username and password'] = 'Los usuarios nuevos recibirán un correo electrónico con su nombre de usuario y su contraseña';
...
$_lang['No service registered'] = 'No hay ningún servicio registrado';
...
$_lang['No user to delete'] = 'No hay ningún usuario que eliminar';
...
$_lang['Note :  this repository should be protected with a .htaccess or
       be placed outside the web. Because there contain data of private courses.'] = 'Nota: debido a que contiene datos de cursos privados este directorio debe ser protegido con un .htaccess o debe situarse fuera de la web. Claroline debe poder leer y escribir en esa ubicación';
$_lang['Note : this repository should be protected with a .htaccess or
...
$_lang['Once a user logs to the Claroline platform a cookie is sent to the user browser if the authentication process succeeds. The cookie value is also stored in a internal table of the Claroline platform for a certain time. If requested, the Claroline SSO '] = 'Una vez que un usuario se registra en la plataforma Claroline, si el proceso de autenticación tiene éxito se envía una cookie al navegador de usuario. El valor de la cookie también se almacena en una tabla interna de la plataforma Claroline durante un cierto tiempo. De ser solicitado, el servidor SSO de Claroline proporciona un modo de recuperar los parámetros de usuario de otro servidor en Internet en base a este valor de cookie.';
$_lang['Once a user logs to the Claroline platform a cookie is sent to the user browser if the authentication process succeeds. The cookie value is also stored in a internal table of the Claroline platform for a certain time. If requested, the Claroline SSO server provides a way to retrieve the user parameters from another server on the internet on the base of this cookie value.'] = 'Cuando un usuario accede a la plataforma Claroline, si el proceso de autenticación tiene éxito se envía una cookie al navegador web del usuario. El valor de la cookie también se almacena en una tabla interna de la plataforma Claroline durante un cierto tiempo. De ser solicitado, el servidor SSO de Claroline proporciona un modo de recuperar los parámetros de usuario de otro servidor en Internet en base al valor de esa cookie.';
...
$_lang['Personal language selector'] = 'Idiomas personales';
...
$_lang['Publish all corrections'] = 'Publicar todas las correciones';
...
$_lang['Register a service'] = 'Registrar nuevo servicio';
...
$_lang['Registered services'] = 'Servicios registrados';
...
$_lang['Repository for cache files'] = 'Repositorio para archivos caché';
...
$_lang['Sender'] = 'De';
$_lang['Service'] = 'Servicio';
$_lang['Service %service deleted'] = 'Servicio %service eliminado';
$_lang['Service host'] = 'Equipo';
$_lang['Service key'] = 'Clave';
$_lang['Service key added for service %service'] = 'Service key added for service %service';
$_lang['Service key administration'] = 'Claves de servicios';
$_lang['Service key changed for service %service'] = 'Clave del servicio %service modificada';
$_lang['Service name'] = 'Nombre del servicio';
...
$_lang['Step 1 of 4: platform main settings'] = 'Paso 1 de 4: ajustes de la plataforma';
$_lang['Step 2 of 4: main platform tables upgrade'] = 'Paso 2 de 4: repaso de las tablas principales';
$_lang['Step 3 of 4: courses upgrade'] = 'Paso 3 de 4: repaso de los cursos';
$_lang['Step 4 of 4: disable incompatible modules'] = 'Paso 4 de 4: deshabilitación de módulos incompatibles';
...
$_lang['The Claroline upgrade process is complete'] = 'El proceso de actualización de Claroline se ha completado';
...
$_lang['The claroline main tables have been successfully upgraded to %version'] = 'Las tablas principales de Caroline han sido exitosamente actualizadas a %version';
$_lang['The claroline main tables have been successfully upgraded to 1.6'] = 'Las tablas principales de Caroline han sido exitosamente actualizadas a 1.6';
...
$_lang['The data backup has been done'] = 'La copia de seguridad de los datos se ha completado';
...
$_lang['The domain that the cookie is available.  To make the cookie available on all subdomains of example.com, you\'d set it to ".example.com". The . is not required but makes it compatible with more browsers. Setting it to www.example.com  will make the cookie only available in the www  subdomain.'] = 'El dominio para el que la cookie está disponible. Para disponer de la cookie en todos los subdominios de «ejemplo.com» se pondría «.ejemplo.com». Aunque el punto «.» no es necesario, mejora la compatibilidad con un mayor número de navegadores web. Poniendo «www.ejemplo.com» la cookie solo es accesible por servidores del subdominio «www».';
...
$_lang['The path on the server in which the cookie will be available on.  If set to "/", the cookie will be available within the entire domain. If set to "/foo/", the cookie will only be available within the /foo/ directory and all sub-directories such as /foo/bar/ of domain. The default value is the current directory that the cookie is being set in.'] = 'La ruta del servidor web para el que la cookie estará disponible. Con «/», la cookie sirve para todo el dominio; con , la cookie es accesible solo desde el directorio y los subdirectorios de «/loquesea/" como «/loquesea/otromas/». El valor por defecto es el directorio actual en el que se ha creado la cookie.';
...
$_lang['The title is too long (max. 80 characters)'] = 'El título es demasiado largo (máx. 80 caracteres)';
$_lang['The upgrade tool is not able to upgrade this course'] = 'La herramienta no ha sido capaz de actualizar este curso';
...
$_lang['There is no submission available for download with these settings.'] = 'No hay envíos disponibles para descarga con esas opciones.';
$_lang['There is no upgrade needed between those versions'] = 'No es necesario actualizar ya nada entre esas versiones';
...
$_lang['Unable to create course database'] = 'No se puede crear la base de datos del curso';
$_lang['Unable to create database tables for %label%'] = 'No se pueden crear tablas en la base de datos para %label%';
$_lang['Unable to create directory :'] = 'No ha sido posible crear el directorio :';
$_lang['Unable to create file %file'] = 'No se puede crear el archivo %file';
$_lang['Unable to create file :'] = 'No ha sido posible crear el archivo :';
$_lang['Unable to create folder %folder'] = 'No se puede crear la carpeta %folder';
...
$_lang['Unable to create user %username, option is disabled in configuration'] = 'No se puede crear el usuario %username, la opción esta desactivada en la configuración';
...
$_lang['Unable to delete all events from the agenda'] = 'No se pueden eliminar todos los eventos de la agenda';
...
$_lang['Upgrade failed'] = 'Revisión fallida';
$_lang['Upgrade file'] = 'Revisar archivo';
$_lang['Upgrade succeeded'] = 'Revisión completada';
$_lang['Upgrade tool is not able to upgrade the following courses'] = 'No se han podido revisar los cursos siguientes';
$_lang['Upgrade tracking data'] = 'Upgrade tracking data';
$_lang['Upgrading course'] = 'Revisando curso';
$_lang['Upgrading main Claroline database'] = 'Actualizando la base de datos principal de Claroline';
$_lang['Upload'] = 'Subir';
...
$_lang['User not found in course'] = 'No se ha encontrado el usuario en el curso';
...
$_lang['Username is too long (maximum 60 characters)'] = 'Nombre de usuario excesivamente largo (máx. 60 caracteres)';
...
$_lang['Web services'] = 'Servicios web';
...
$_lang['Will delete %path'] = 'Se borrará %path';
...
$_lang['You are going to delete this cache content, continue ?'] = 'Se va a borrar este contenido de la caché. ¿Está seguro de querer continuar?';
...
$_lang['You aren\'t enroled to this course yet'] = 'Todavía no se encuentra matriculado en este curso.';
...
$_lang['blockWarningRemoveInstallDirectory'] = '<b>Nota :</b> El directorio que contiene el proceso de instalación de Claroline (<code>claroline/install/</code>) sigue visible en la web. Eso permite que cualquiera pueda reinstalar Claroline y destruir su instalación previa. Recomendamos encarecidamente que se proteja el directorio o se elimine del servidor.';
...
$_lang['class'] = 'clase';
$_lang['class enrolment'] = 'matricular clase';
$_lang['clear'] = 'ninguno';
...
$_lang['write n-1 times without check if (others) cached files are or not deprecated'] = 'escribe n-1 veces sin verificar si hay (otros) archivos en caché caducados';
