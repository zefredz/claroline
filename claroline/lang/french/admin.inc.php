...
$langPublic = "Public";
$langPrivate = "Privé";
$langAllowed = "permise";   //for inscription settings
...
$langCanCreateCourse = "Peut créer des nouveaux cours";
...
$langAddaListOfUsers = "Ajouter une liste d'utilisateurs";
$langModifOneProfile = "Paramètres de l'utilisateur";
$langBackToAdmin = "Retour à la page d'administration";
$langBackToCourseList = "Retour à la list des cours";
...
$langAddUserOneByOne = "Les nouveaux utilisateurs recevrons un email avec leur nom d'utilisateur et mot de passe";
...
$langBackToUserList ="Retour à la liste d'uitlisateur";
...
$langListUsers = "Liste des utilisateurs"; //for bredcrumps too
$langCourseList = "Liste des cours"; //for bredcrumps too

$langUserCourseList = "List des cours de l'utilisateur";
$langPersonnalInfo = "Information personnelle";
$langCourseRestore = "Restaurer un cours";
$langRegister = "Inscrire cet utilisateur à un cours";
$langDeleteUser = "Supprimer l'utilisateur";
...
$langEditUserSettings = "Paramètres de l'utilisateur";
$langCourseManager = "Responsable de cours";
