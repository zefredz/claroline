...
$_lang['This  prefix is added to each course table name. It\'s usefull in single database mode as it groups all course tables together.'] = 'Ce  préfixe est ajouté à tous les noms de table ou de base de données des cours.';
