...
$lang_faculty_CatHaveCat				=	"Cette catégorie contient d'autres catégories, supprimé les avant celle ci!";
...
$lang_faculty_NoParentSelf				=	" Vous ne pouvez pas avoir comme catégorie parente la catégorie elle même !";
...
$lang_faculty_CanHaveCatChild			=	"Peut elle avoir des catégories comme enfant ?";
...
$lang_faculty_HaveCourses				=	"La catégorie possède des cours, vous devez d'abord les supprimer avant d'interdire cette
...
$lang_faculty_CreateOk					=	"La creation a été réussie avait succès";
