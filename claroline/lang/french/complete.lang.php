...
$_lang['%nb_user new users in the platform'] = '%nb_user nouveau(x) utilisateur(s) sur la plateforme';
...
$_lang['Assignments tool'] = 'Outil de travaux';
...
$_lang['Chat tool'] = 'Outil de Chat (discussion synchrone)';
...
$_lang['Documents and Links tool'] = 'Outil de ressources et liens';
...
$_lang['Exercise tool'] = 'Outil Exercice';
...
$_lang['File system settings'] = 'Paramètres du système de fichier';
...
$_lang['Forums tool'] = 'Outil de Forums';
$_lang['From'] = 'Du';
...
$_lang['Platform & Organisation'] = 'Plateforme & Organisation';
...
$_lang['Set the default language of the platform. It doesn\'t prevent course managers to set an other language for each course they create.'] = 'Définis la langue par défaut de la plateforme. Ca n\'empêche pas les gestionnaires de cours de choisir un autre langage pour chaque cours qu\'ils créent.';
$_lang['Set the editor that will replace standard html textarea.'] = 'Définis l\'éditeur de texte.';
$_lang['Sets if user can see only his own submissions (or those from his groups) or if he can see every visible submission.'] = 'Définies si l\'utilisateur peut uniquement voir ses soumissions (ou celles de son groupe) ou s\'il peut voir chaque soumissions.';
...
$_lang['acceptedValue'] = 'Valeurs acceptées';
...
$_lang['for current and new works'] = 'pour le travail courrant et les nouveaux';
...
$_lang['sec.'] = 'sec.';
$_lang['sectionlabel'] = 'Nom de la section';
