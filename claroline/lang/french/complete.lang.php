...
$_lang['%chat_filename is now in  your document tool. (<em>This file is visible</em>)'] = '%chat_filename est maintenant dans l\'outil Documents. (<em>Ce fichier est visible</em>)';
$_lang['%claroLabel registered'] = '%claroLabel a été ajouté';
$_lang['%claroLabel registered as tool'] = '%claroLabel a été ajouté comme outil';
...
$_lang['%module files deleted'] = 'Les fichiers du module %module ont été supprimés';
...
$_lang['Back to Home page of %site_name'] = 'Revenir à la page d\'accueil de %site_name';
...
$_lang['Course'] = 'Cours';
$_lang['Course "%course_name" (%course_code) has been deleted'] = 'Le cours \'%course_name\' (%course_code) a été supprimé';
...
$_lang['Error while deleting %module files'] = 'Erreur à la suppression des fichiers du module %module';
...
$_lang['Imported exercises must consist of a zip file (IMS-QTI) and be compatible with your Claroline version.'] = 'Les exercices à importer doivent être des fichiers zip (IMS-QTI) ';
...
$_lang['Invisible to other users'] = 'Invisible aux autres utilisateurs';
...
$_lang['New learning path name'] = 'Nouveau ';
...
$_lang['Only visible by teacher and submitter'] = 'Visible uniquement par le(s) gestionnaire(s) de cours et le propriétaire de la soumission';
