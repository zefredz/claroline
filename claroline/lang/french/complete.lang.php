...
$_lang['Campus logo'] = ' Logo du Campus';
$_lang['Campus name'] = 'Nom du site';
$_lang['Can have courses'] = 'Peut-elle avoir des cours ? ';
$_lang['Can users create new accounts themselves ?'] = 'Les utilisateurs peuvent se créer un compte eux-même ?';
...
$_lang['Course removal allowed'] = 'Autorisé à supprimer les cours';
...
$_lang['Crypt passwords'] = 'Chiffrer les mots de passe';
...
$_lang['Display Local Auth Form'] = 'Afficher le formulaire local d\'authentification';
$_lang['Display Settings'] = 'Paramètres d\'affichage';
$_lang['Display banner'] = 'Afficher la banière';
...
$_lang['Empty list.'] = 'Liste vide';
$_lang['Enable Cas system'] = 'Activer le système de Cas';
...
$_lang['External Label (url)'] = 'Url de la référence externe';
...
$_lang['External label'] = 'Nom de la référence externe';
...
$_lang['From'] = 'Du';
$_lang['From dynamic content'] = 'Depuis un contenu dynamique';
...
$_lang['Go to today'] = 'Aller à aujourd\'hui';
$_lang['Group'] = 'Groupe';
...
$_lang['HTML in posts'] = 'HTML dans les messages';
...
$_lang['Hidden'] = 'Masquer';
$_lang['Hidden email address to anonymous user'] = 'Masquer l\'adresse email aux anonymes';
$_lang['Hide'] = 'Masqué';
...
$_lang['Language to display'] = 'Langue à afficher';
...
$_lang['Lenght of course code suffix'] = 'Longueur du suffix du codecours système';
...
$_lang['List updated'] = 'Liste mise à jour';
...
$_lang['User can leave course code (officialCode) field empty or not'] = 'Le gestionnaire peut laisser le code officiel du cours vide';
...
$_lang['View list of files'] = 'Voir la liste des fichiers';
...
$_lang['Where place RSS files.'] = 'Où mettre les fichiers RSS.';
$_lang['Where place iCal files.'] = 'Où mettre les fichiers iCal.';
$_lang['Whether include tutors in the displayed member list'] = 'Indique si les tuteurs doivent être affiché dans la liste des membres';
...
$_lang['You can modify the content of each text zones displayed in the docks.'] = 'Vous pouvez modifier le dontenu de chaque zone de texte affichée dans les docks';
...
$_lang['if false, other field are optional'] = 'si faux, les autres champs sont inutilisés';
...
$_lang['lines'] = 'lignes';
$_lang['loose change'] = 'Abandonner les modifications';
...
$_lang['number'] = 'nombre';
$_lang['on bottom'] = 'en bas';
$_lang['on top'] = 'en haut';
$_lang['only for new works'] = 'Seulement pour les nouveaux travaux';
$_lang['port of CAS server'] = 'port du serveur CAS';
...
$_lang['relative path from claroline web to iconset'] = 'Chemin relatif de la racine du campus à l\'emplacement des collection d\'icones';
$_lang['relative path from root campus to claroline code'] = 'Chemin relatif de la racine du campus à l\'emplacement du kernel';
$_lang['relative path from root campus to courses'] = 'Chemin relatif de la racine du campus à l\'emplacement des répertoire de cours';
$_lang['relative path from root web to user pic repository'] = 'Chemin relatif de la racine du site au réprtoire où se trouvent les photos d\'utilisateur';
$_lang['relpath'] = 'Chemin relatif';
...
$_lang['sso authentication key list'] = 'liste des clés de SSO';
$_lang['sso cookie domain'] = 'domaine du cookie de SSO';
$_lang['sso cookie name'] = 'nom du cookie de SSO';
$_lang['sso cookie path'] = 'chemin du cookie de SSO';
$_lang['sso cookie period validity'] = 'Temps de validité du cookie de SSO';
$_lang['string'] = 'chaîne';
$_lang['syspath'] = 'chemin système';
$_lang['time before really compute data. 86400 = 1 day.'] = 'Délais avant de réellement recalculer les données 86400 = 1 day.';
$_lang['to'] = 'au';
$_lang['type'] = 'type';
$_lang['uncompress zipped (.zip) file on the server'] = 'Décompresser fichier zippé (.zip)';
$_lang['unique id of the platform'] = 'Id unique de la plate-forme';
$_lang['unit'] = 'unité';
$_lang['unlimited'] = 'Essais illimités';
$_lang['url of logo'] = 'url du logo';
...
$_lang['write n-1 times without check if (others) cached files are or not deprecated'] = 'écrit n-1 fois dans les fichiers de cache sans vérifier si les autres fichiers sont déshuet ou non';
$_lang['Main'] = 'Général';
$_lang['Main Settings'] = 'Paramètres principaux';
...
$_lang['Course name table prefix'] = 'Préfix pour les noms de tables de cours';
$_lang['Displayed'] = 'Affiché';
$_lang['Docked text zones'] = 'Zones de textes placées dans des docks';
