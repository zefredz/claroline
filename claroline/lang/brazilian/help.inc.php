...
$langClarContent3="</p><p><b>Teoría Educacional</b><p>Para os professores,
 que preparam um curso na internet é uma questão de Teoria Educacional também.";
 
$langClarContent4="está ao seu dispor para ajuda-lo no decorrer dos diferentes
 passos da evolução do seu projeto de ensino: do desenvolvimento de uma ferramenta
 até a sua integração em uma estratégia objetiva e coerente até objetos de
 avaliação do seu impacto no aprendizado do aluno.</p>";
