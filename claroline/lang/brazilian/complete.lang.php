...
$langAddComment = "Adicionar um comentário";
...
$langAdministrationTools = "Ferramentas de AdministraÃ§Ã£o";
$langAdministrationTools = "Administração";
$langAdministrationTools = "Administrador";
...
$langAlreadyEnrolled = "Já inscrito";
$langAlt = "Array";
$langAltMakeBlocking = "Tornar bloqueado";
$langAltMakeInvisible = "Tornar invisível";
$langAltMakeNotBlocking = "Tornar não bloqueado";
$langAltMakeVisible = "Tornar visível";
$langAltMove = "Mover";
$langAltMoveDown = "Mover abaixo";
...
$langArchive = "arquivo";
$langArchiveCourse = "Fazendo backup do curso ";
...
$langAreYouSureToDelete = "você tem certeza de que deseja deletar ";
...
$langAreYouSureToDeleteScormModule = "Você tem certeza que quer deletar esses módulos em conformidade com o SCORM? O módulo não ficará mais disponível na plataforma.";
...
$langBackupSuccesfull = "Backup efetuado com sucesso";
$langBackupSuccesfull = "Arquivado com sucesso";
$langBackupThisCourse = "Exportar esse curso";
...
$langBUCourseDataOfMainBase = "Backup dos dados do curso para";
$langBUCourseDataOfMainBase = "Backup dos dados do curso do banco de dados principal para";
$langBuildTheCompressedFile = "2° - Criação do arquivo de backup";
$langBuildTheCompressedFile = "Criação do arquivo de backup";
$langBUUsersInMainBase = "Backup dos dados dos usuários para";
...
$langCategories = "Categorias de Curso";
...
$langCopy = "Copiar";
$langCopyDirectoryCourse = "Copia de arquivos do curso";
$langCopyDirectoryCourse = "Copiar os arquivos do curso";
$langCopyFailed = "Impressão falhou";
$langCopyOnServerBackupRepository = "colocar uma cópia do arquivo no espaço &laquo;arquivos&raquo; da plataforma";
...
$langCourseAdministratorOnly = "Administrador do curso apenas";
...
$langCourseHomePage = "Página Principal";
...
$langCourseProperties = "Propriedades do curso";
$langCourses = "Cursos";
$langCourses = "cursos.";
...
$langCreate = "criar";
$langCreateANewCourseNow = "criar um novo curso apartir desse arquivo";
$langCreateAnotherUser = "Criar outro usuário novo";
$langCreateClaroTables = "Criar Tabelas para o Banco de Dados principal";
$langCreateClaroTables = "Criar Tabela para o Banco de Dados principal";
...
$langCreateMissingDirectories = "Criação dos diretórios faltando";
...
$langEmailWrong = "O endereço de e-mail não é válido";
...
$langEnrollAsStudent = "Inscrever como Estudante";
...
$langFirstName = "Primeiro Nome";
$langFollowCourse = "Assistir cursos";
...
$langForum = "Fórum";
$langForumContent = "Conteúdo do Fórum";
$langForumGroup = "Fórum do grupo";
$langForumModified = "O fórum foi modificado";
$langForums = "Fóruns";
$langForumStructure = "Nome dos fóruns e categorias";
$langForumType = "Tipo de fórum";
$langFrom = "De";
...
$langGroupForumContent = "Conteúdo dos fóruns dos grupos";
$langGroupForumStructure = "Nomes dos fóruns dos grupos e suas categorias ";
...
$langGroupsProperties = "Configurações dos grupos";
...
$langGroupWork = "Trabalhos do grupo";
$langGroupWorkContent = "Trabalhos de grupos entregues";
$langGroupWorkStructure = "Anúncios dos trabalhos do grupo";
...
$langLinksToClaroProjectSite = "Links para o sítio do projeto";
$langLinksToClaroProjectSite = "Links para o website do projeto";
...
$langLogIdentLogout = "Listar ações de login";
$langLogIdentLogoutComplete = "Pesquisar ações de Login (com informações detalhadas)";
$langLogIdentLogoutComplete = "Pesquisar ações de Login (com o máximo de informação)";
$langLogIdentLogoutComplete = "Listar ações de login (com o máx. de informação)";
$langLogin = "login";
...
$langManage = "Gerenciando o campus";
$langManage = "Gerenciar Campus";
$langManage = "Manage Campus";
$langManage = "Gerenciamento do campus";
$langManage = "Gestão do Campus";
...
$langModifOneProfile = "Configurações de usuário";
$langModifProfile = "Modifique meu perfil";
...
$langNoLearnPath = "Nenhuma rota de aprendizagem";
$langNoLimitForQtyOfUserCanSubscribe = "Um usuário pode ser membro de todos os grupos";
...
$langSave = "Salvar";
$langSaveChange = "Salvar alterações";
$langSaveChanges = "Salvar alterações";
$langSaveContentDoc = "Documentos";
$langSaveSubscription = "Usuários registrados no curso e grupos";
$langScore = "Pontuação";
$langScoreAvg = "Média";
$langScoreMax = "Máx";
$langScoreMin = "Mín";
...
$langSearchACourse = "Procurar por um curso";
$langSearchACourse = "Procurar um curso";
$langSearchACourse = "Pesquisar por um curso";
$langSearchAgain = "Pesquisar novamente (avançado)";
$langSearchAUser = "Procurar por usuários";
$langSearchAUser = "Procurar por usuáros";
$langSearchAUser = "Pesquisar por usuários";
...
$langShowAllProcessDuringTheWork = "Mostrar todos os processos durante o trabalho ?";
...
$langSysInfo = "Informação sobre o Sistema";
$langTableStructureDontKnow = "Estrutura dessa tabela é desconhecida";
$langTableStructureDontKnow = "Estrutura desconhecida para essa tabela";
...
$langUpgradeAll = "Atualizar toda a plataforma.";
...
$langUserFree = "Este nome de usuário já existe.";
...
$langUserNo = "O nome de usuário que você escolheu ";
...
$langUserTaken = "Esse nome de usuário já está em uso";
...
$langWhatDoAfterBackup = "Tarefas a serem executadas antes do arquivamento";
$langWikiContent = "Conteúdo Wiki";
$langWork = "Trabalhos";
$langWorkAuthors = "Autores";
$langWorkContent = "Trabalhos entregues";
$langWorksDetails = "Trabalhos enviados pelo estudante em nome dos 'Autores'";
$langWorkStructure = "Anúncios de trabalhos";
...
$lang_no_access_here = "Acesso negado ";
...
$l_infoupdated = "Suas informações foram atualizadas";
$l_interests = "Interesses";
$l_itemsreq = "Ítens marcados com * são requeridos";
$l_joined = "Entrado";
$l_lastpost = "Ultima Postagem";
$l_location = "De";
$l_logout = "Logout";
$l_messenger = "MSN Messenger";
$l_mismatch = "Senhas não conferem.";
$l_msn = "MSN";
$l_new = "Novo";
$l_nextpage = "Próxima página";
$l_nomatches = "Registros não encontrados nesta pesquisa. Por favor refaça a sua pesquisa.";
$l_nopmsgs = "Você não tem Menssagens privadas.";
$l_nopostlock = "Você não pode postar uma resposta para este tópico, ele está bloqueado.";
$l_noposts = "Postagens negados";
$l_norecipient = "Você precisa entrar com um nome de usuário e senha para emviar Menssagem para.";
...
$l_nousers = "Não há usuários atualmente visualizando os fóruns";
$l_number = "Número";
$l_occupation = "Ocupação";
$l_oftotal = "do total";
$l_onlyreq = "Apenas solicitada se for modificada";
$l_options = "Opções";
$l_password = "Senha";
...
$l_replies = "Respostas";
$l_reply = "Responder";
$l_replyquote = "Responder com quota";
...
$l_searchallfrm = "Procurar em todos os Fóruns";
...
$l_sendpmsg = "Enviar Mensagem Privada";
$l_separator = " > ";
$l_sigexplain = "Este bloco de texto pode ser adicionado as suas postagens.<BR>255 caracteres no máximo!";
$l_signature = "Assinatura";
$l_sortby = "Classificar por";
...
$l_url = "URL";
$l_userdisallowed = "O Nome do usuário que você selecionou está desabilitado pelo administrador. Por favor volte e tente novamente.";
$l_username = "Nome do usuário";
$l_userpass = "Por favor entre com o seu nome de usuário e senha.";
$l_userremoved = "Este usuário foi removido do banco de dados de usuários";
$l_usertaken = "O Nome do usuário que você selecionou já está em uso.";
$l_viewforum = "Ver Fórum";
$l_viewmsg = "para visualizar sua Menssagem.";
$l_viewpostuser = "Ver postagens desse usuário";
$l_website = "Endereço do Web Site";
$l_whosonline = "Quem está on-line?";
$l_wrongpass = "Você forneceu a senha incorreta.";
