...
$l_website = "Adresse de l'espace Web";
...
$langBUAnnounceInMainBase = "Sauvegarde des données 'annonces' de l'espace pour";
$langBUCourseDataOfMainBase = "Sauvegarde des données de l'espace pour";
$langBUUsersInMainBase = "Sauvegarde des données 'utilisateurs' de l'espace pour";
$langBack = "Retour";
$langBack = "Retour";
...
<p>Procédez come suit. Inscription > Remplissez tous les champs et choissez 'Créer des sites
...
liste de vos sites. Cliquez sur l'intitulé de l'espace que vous venez de créer. Vous voici dans un
...
$langCourseAdministratorOnly = "Réservé à l'administrateur de l'espace";
$langCourseContent = "Contenu de l'espace";
$langCourseCreate = "Créer un espace";
$langCourseDescription = "Description de l'espace";
$langCourseDescription = "Description de l'espace
...
de Claroline).";
$langCourseHomePage = "Page d'accueil de l'espace";
$langCourseManager = "Gestionnaire de l'espace";
$langCourseProgram = "Description de l'espace";
...
$langDocumentsDetails = "Documents téléchargés par  l'utilisateur";
...
$langEdit = "Editer";
$langEditCourseProgram = "Cr&eacute;er et &eacute;diter &agrave; l'aide des formulaires une description de l'espace";
...
$langEmailSent = "et envoyée par courriel aux utilisateurs de l'espace";
...
l'exécution de l'exercice par l'étudiant.<br><br>
Enregistrez ensuite votre exercice. Vous arriverez à la gestion des questions de cet
exercice.</p>
<hr>
<b>Ajout d'une question</b>
<p>Vous pouvez à présent ajouter une question à l'exercice précédemment créé. La description
...
en cliquant sur le bouton adéquat</li>
  ...
  <li>Ajoutez un éventuel commentaire. Celui-ci ne sera vu par l'étudiant qu'une fois qu'il aura
...
<p>Il s'agit du texte à trous. Le but est de faire trouver à l'étudiant des mots que vous avez
...
commentaire qui sera vu par l'étudiant lorsqu'il aura répondu à la question.<br><br>
...
<hr>
<b>Correspondance</b>
<p>Ce type de réponse peut être choisi pour créer une question où l'étudiant devra relier des
...
sur l'image <img src=\"img/edit.gif\" border=\"0\" align=\"absmiddle\"> à côté de l'exercice à
modifier, et suivez les instructions ci-dessus.</p>
<hr>
<b>Suppression d'un exercice</b>
<p>Pour supprimer un exercice, cliquez sur l'image <img src=\"img/delete.gif\" border=\"0\"
align=\"absmiddle\"> à côté de l'exercice à supprimer.</p>
<hr>
<b>Activation d'un exercice</b>
<p>Avant qu'un exercice ne puisse être utilisé par un étudiant, vous devez l'activer en cliquant
sur l'image <img src=\"img/invisible.gif\" border=\"0\" align=\"absmiddle\"> à côté de
l'exercice à activer.</p>
<hr>
...
différent lorsque les étudiants exécuteront l'exercice.<br><br>
Si vous avez un grand nombre de questions, vous pouvez aussi choisir de ne prendre
aléatoirement que X questions sur l'ensemble des questions disponibles dans cet exercice.</p>
<hr>
...
exercices.<br><br>
Par défaut, toutes les questions de votre cours sont affichées. Vous pouvez afficher les
...
$langExplanation = "Cette page doit être au format HTML (p. ex. \"ma_page.htm\"). Elle sera accrochée par un lien sur la page d'accueil de l'espace. Si vous désirez envoyer un document non HTML (PDF, Power Point, Word...) utilisez l'outil <a href=../document/document.php> Documents</a>";
$langExplanation = "La page doit être au format HTML (ex. \"ma_page.htm\"). Elle devra pouvoir être accessible depuis le sommaire de votre espace. Si vous souhaitez envoyer un document non HTML (PDF, Word, Power Point, Video, etc.) utilisez <a href=\"../document/document.php\">l'outil de documents</a>.";
...
$langGroupStudentsRegistered = "participants inscrits à l'espace";
...
$langOneResp = "L'un des gestionnaires de l'espace";
...
$langProfessors = "Brève description
Gestionnaire(s) de cours";
$langProfileReg = "Votre nouveau profil a été enregistré";
$langPropModify = "Modifier les propriétés";
$langPubl = "Publiée le";
$langPublic = "public";
$langPublicAccess = "Accès public (depuis la page d'accueil de l'espace sans identifiant)";
$langPublish = "Publier";
...
<p>Pour faire figurer le nom d'un co-modérateur dans l'en-tête de votre
 ...
 de l'espace. Ce sont deux actions distinctes.</p><hr>
...
$langAddCSVUsersInCourse = "Ajouter une liste d'utilisateurs à l'espace";
...
$langAddedToCampusAndClass = "a été ajouté au campus et à l'espace";
$langAddedToCampusAndCourse = "a été ajouté au campus et à l'espace";
$langAdmin = "Admin";
...
Confirmer ?";
$langAllUsersOfThisCourse = "Membres de l'espace";
...
$langClassRegisterWholeClass = "Inscrire la sélection à un cours";
$langClassRegisterWholeClassAgain = "Inscrire la sélection à un autre cours";
...
$langConfirmEnrollClassToCourse = "Etes-vous sûr d'inscrire la sélection entière à ce cours ?";
$langCourseContentComment1 = "Quelle est l'importance des différents contenus à traiter dans le cadre de l'espace&nbsp;?
...
$langCourseContentComment2 = "Présentation de la table des matières de l'espace, de la structuration du
contenu, de la progression et du calendrier";
$langCourseCreator = "Créateur de l'espace";
$langCourseDelete = "L'espace a été supprimé";
$langCourseHome = "Accueil";
$langCourseList = "Liste des espaces";
$langCourseSettings = "Paramètres de l'espace";
$langCourse_Repository = "Dossier de l'espace";
...
$langDelCourseStats = "Effacer les statistiques de l'espace";
$langDelCourseStatsDone = "Les statistiques de l'espace ont été effacées.";
...
$langDeleteOfUserWasDoneSucessfully = "Suppression de l'utilisateur réussie";
$langDeleteUser = "Supprimer l'utilisateur";
$langDeletedExternalTool = "Lien externe effacé";
$langDepartment = "Département";
$langDescriptionComment1 = "Quelle est la place et la spécificité de l'espace dans le programme&nbsp;?
Existe-t-il des cours pré-requis&nbsp;?
Quels sont les liens avec les autres cours&nbsp;?";
$langDescriptionComment2 = "Information permettant d'identifier l'espace
...
$langDescriptionCours = "Description de l'espace";
...
$langEnrollAsManager = "Inscrire comme gestionnaire de l'espace";
...
$langInsertMyModulesTitle = "Insérer un module de l'espace";
$langInsertNewModuleName = "Insérer le nouveau nom";
$langInstalled = "L'importation du parcours pédagogique a réussi.";
$langIntroCourse = "Bienvenue sur la page d'accueil de l'espace.<br /><br />Vous pouvez sur cette page :
<ul>
...
<br />Il permet au gestionnaire de cours de créer différents travaux dans lesquels chaque étudiant peut envoyer un document (Word, Excel, HTML... ) vers l'espace de l'espace, ou composer un texte, afin de le rendre accessible aux autres étudiants ainsi qu'au gestionnaire.
...
$langListCourseUsers = "Liste des utilisateurs de l'espace";
...
$langModifOneProfile = "Paramètres de l'utilisateur";
...
$langQualificationsAndGoalsComment1 = "Présentation des objectifs généraux et spécifiques de l'espace, des compétences auxquelles la maîtrise de tels objectifs pourrait conduire.";
$langQualificationsAndGoalsComment2 = "Quels sont les apprentissages visés par l'enseignement&nbsp;?
<br>
Au terme de l'espace, quelles sont les compétences, les capacités et les connaissances que les étudiants seront en mesure de maîtriser, de mobiliser&nbsp;?";
...
$langRegisterUserToClass = "Inscrire l'utilisateur à la sélection";
...
$langTitleUpgrade = "<h2>Mettre à jour Claroline<br />
                     de 1.4.* à 1.5</h2>";
$langToCourseSettings = "Retour aux propriétés de l'espace";
$langTool = "Outil";
$langTopLevel = "racine";
...
$langUserAlreadyInClass = "L'utilisateur est déjà inscrit à la sélection";
$langUserCanCreateCourse = "Peut créer des cours";
$langUserCourseList = "Liste des espaces de l'utilisateur";
$langUserCreated = "Le nouvel utilisateur a bien été créé";
$langUserDelete = "La suppression de l'utilisateur a bien été effectuée";
$langUserIsNowCourseManager = "L'utilisateur est maintenant gestionnaire de l'espace";
...
$langUserNotInClass = "L'utilisateur n'est pas inscrit à la sélection";
...
$langUserNotUnsubscribedFromCourse = "Erreur!! vous ne pouvez pas radier un gestionnaire de l'espace";
$langUserRegisteredClass = "L'utilisateur a été inscrit à la sélection";
...
$langUserUnregisteredClass = "L'utilisateur a été désinscrit de la sélection";
$langUserUnregisteredFromClass = "L'utilisateur a été désinscrit de la sélection";
$langUserUnregisteredFromCourse = "L'utilisateur  a été radié de l'espace";
$langUserUnsubscribed = "L'utilisateur a été radié";
$langUserUnsubscribedFromCourse = "L'utilisateur a bien été radié de l'espace";
...
$lang_config_siteName = "Nom de l'espace : ";
...
$lang_footer_p_CourseManager = "Gestionnaire(s) de l'espace %s";
