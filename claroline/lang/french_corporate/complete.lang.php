...
$l_aim = "AIM";
$l_author = "Auteur";
$l_banned = "Vous avez été banni de ce forum. Contactez l&acute;administrateur système si vous avez des questions.";
...
$l_emptymsg = "Vous devez taper un Message à poster. Vous ne pouvez poster un Message vide.";
...
$l_nopmsgs = "Vous n'avez pas de Messages Privés.";
$l_nopostlock = "Vous ne pouvez répondre sur ce sujet, il a été fermé.";
$l_noposts = "Pas de Messages";
$l_norecipient = "Vous devez entrer le nom d'utilisateur à qui vous désirez envoyer ce Message.";
...
$l_nouser = "Ce Nom d'Utilisateur n'existe pas.";
...
$l_returnindex = "pour retourner à l&acute;index du forum";
...
$l_sortby = "Trier par";
$l_stored = "Votre Message a été enregistré.";
$l_subject = "Sujet";
$l_topic = "Sujet";
...
$l_url = "URL";
$l_userdisallowed = "Le Nom d'Utilisateur choisi n'a pas été autorisé par l&acute;administrateur. Revenez en arrière et réessayez.";
$l_userdisallowed = "Le Nom d'Utilisateur choisi n'a pas été autorisé par l'administrateur. Revenez en arrière et réessayez.";
...
$l_usertaken = "Le Nom d'Utilisateur que vous avez choisi existe déjà.";
$l_viewforum = "Voir Forum";
$l_viewmsg = "pour voir votre Message.";
$l_viewpostuser = "Voir les messages de ce membre";
$l_website = "Adresse de l&acute;espace Web";
...
$langAdd = "Ajouter";
$langAddAClass = "Inscrire une sélection";
...
$langAddNewCourse = "Ajouter un nouvel espace";
...
$langAdminEmail = "E-mail de l&acute;administrateur";
$langAdminLogin = "Identifiant de l&acute;administrateur";
$langAdminName = "Nom de l&acute;administrateur";
$langAdminPass = "Mot de passe de l&acute;administrateur";
$langAdminSetting = "Paramètres d'administration";
$langAdminSurname = "Prénom de l&acute;administrateur";
$langAdministration = "Administration";
$langAdministrationClassTools = "Classes";
$langAdministrator = "Administrateur";
$langAdminsOfThisCours = "Responsables de ce site";
...
$langArchive = "archive";
$langArchiveCourse = "Archivage d'un espace";
$langArchiveCourse = "Archivage d'un site";
$langArchiveLocation = "Emplacement de l&acute;archive";
$langArchiveLocation = "Emplacement de l'archive";
$langArchiveName = "Nom de l&acute;archive";
$langArchiveName = "Nom de l'archive";
$langArchiveNotFound = "Archive introuvable";
$langArchiveUncompressed = "l&acute;archive a été décompressée et installée.";
...
Vous ne pourrez plus l&acute;utiliser dans aucun parcours pédagogique.
...
$langBUAnnounceInMainBase = "Sauvegarde des données 'annonces' de l&acute;espace pour";
$langBUAnnounceInMainBase = "Sauvegarde des données 'annonces' du site pour";
$langBUCourseDataOfMainBase = "Sauvegarde des données 'site' du site pour";
$langBUCourseDataOfMainBase = "Sauvegarde des données de l&acute;espace pour";
$langBUUsersInMainBase = "Sauvegarde des données 'utilisateurs' de l&acute;espace pour";
$langBUUsersInMainBase = "Sauvegarde des données 'utilisateurs' du site pour";
$langBack = "Retour";
...
$langBackupCourseInformation = "Sauvegarder les informations de l&acute;espace";
$langBackupOfDataBase = "Sauvegarde de la base de données";
$langBackupSuccesfull = "archivage réussi";
$langBackupSuccesfull = "Archivé avec succès";
$langBackupThisCourse = "Archiver ce site";
$langBackupThisCourse = "Archiver cet espace";
...
$langBuildTheCompressedFile = "2° - Création d'une archive";
...
$langChangedTool = "l&acute;accès au lien a été changé";
$langChat = "Discussion";
$langChat = "Discussion  en ligne";
$langChat = "Discuter";
$langChatResetBy = "La discussion a été réinitialisée par";
$langCheckemail = "Vérification de l&acute;adresse email";
...
$langClass = "Sélection";
$langClassAddCSV = "Ajouter une liste d'utilisateurs dans une sélection";
...
$langConfirmBackup = "Voulez-vous vraiment archiver l&acute;espace";
...
$langCopy = "Copier";
$langCopyDirectoryCourse = "Copie des fichiers de l&acute;espace";
$langCopyDirectoryCourse = "Copie des fichiers du site";
$langCopyFailed = "La copie du fichier courrant n'a pas réussi...";
$langCopyOnServerBackupRepository = "placer une copie de l&acute;archive dans l&acute;espace &laquo;archives&raquo; de la plateforme";
$langCopyOnServerBackupRepository = "placer une copie de l'archive dans l'espace &laquo;archives&raquo; de la plateforme";
...
$langCountCourseByFaculte = "Nombre de sites par cat&eacute;gorie";
$langCountCourseByLanguage = "Nombre d'espaces  par langue";
$langCountCourseByLanguage = "Nombre de sites par langue";
$langCountCourseByVisibility = "Nombre de sites par visibilit&eacute;";
...
$langCourse = "Le site ";
$langCourse = "Site";
$langCourseAccess = "Acc&egrave;s à ce site";
...
$langCourseAdministratorOnly = "Réservé à l'administrateur du site";
$langCourseContent = "Contenu de l&acute;espace";
$langCourseContent = "Contenu du site";
...
$langCourseContentComment2 = "Présentation de la table des matières de l&acute;espace, de la structuration du
contenu, de la progression et du calendrier";
$langCourseCreate = "Créer un espace";
$langCourseCreate = "Créer un site pour les cadres";
...
de Claroline).";
$langCourseDescription = "Description du site";
...
$langCourseHomePage = "Disposition de la page d'acceuil du site";
$langCourseHomePage = "Page d'accueil de l&acute;espace";
...
$langCourseWithoutAccess = "Sites inutilis&eacute;s";
$langCourseWithoutProf = "Espaces sans mod&eacute;rateur";
$langCourseWithoutProf = "Sites sans mod&eacute;rateur";
$langCourseWithoutStudents = "Cours sans cadres";
...
$langCourses = "Sites";
$langCreate = "créer";
$langCreateANewCourseNow = "créer un nouveau site à partir de cette archive";
$langCreateANewCourseNow = "créer un nouvel espace à partir de cette archive";
...
$langCsvPutIntoDocTool = "Le fichier 'users.csv' a été placé dans l&acute;outil Documents.";
...
$langDbPrefixForm = "Préfixe pour le nom de la base MySQL";
$langDear = "Cher(ère)";
...
$langDeleteOfUserWasDoneSucessfully = "Suppression de l&acute;utilisateur réussie";
...
$langDocumentsDetails = "Documents t&eacute;l&eacute;charg&eacute;s par le cadre";
...
$langEmailOption = "Envoyer cette annonce par courriel aux cadres";
...
$langExInsertedAsModule = "a été ajouté comme module de cet espace et comme module de ce parcours pédagogique";
...
$langFileCopied = "fichiers copiés";
...
$langFollowCourse = "Suivre des espace";
...
$langForumStructure = "Nom des forums et catégories";
$langForums = "Forums";
$langFrom = "De";
...
$langGiveExerciseName = "Veuillez introduire l&acute;intitulé du Quizz";
...
$langGroupForum = "Forums des groupes";
$langGroupForumContent = "Contenu des forums des groupes";
$langGroupForumStructure = "Nom des forums des groupes et leurs catégories ";
...
$langGroupStudentsRegistered = "participants inscrits au site";
...
$langGroupWork = "Contributions des groupes";
$langGroupWorkContent = "Contributions de groupes postées";
$langGroupWorkStructure = "Intitulé des contributions de groupe";
$langGroups = "Groupes";
...
$langIntroCourse = "Bienvenue sur la page d'accueil de l&acute;espace.<br /><br />Vous pouvez sur cette page :
<ul>
...
$langLastCheck = "Dernier contrôle avant installation";
...
$langLocalFileTips = "Fichier sur l&acute;espace de stockage des cours";
...
$langModifOneProfile = "Paramètres de l&acute;utilisateur";
$langModifUserCourseSettings = "Paramètres des espaces de cet utilisateur";
$langModify = "modifier";
$langModifyInAllExercises = "pour l&acute;ensemble des Quizz";
...
$langMyCourses = "Liste de mes sites";
...
$langNbProf = "Nombre de gestionnaires d'espace";
$langNbProf = "Nombre de professeurs";
$langNbStudents = "Nombre d'étudiants";
$langNbStudents = "Nombre de participants";
$langNbrAccess = "Nombre d'accès";
$langNever = "Jamais";
$langNeverBrowsed = "Jamais visité";
$langNeverConnectedStudents = "Cadres qui ne se sont jamais connect&eacute;s : ";
...
$langNotAllowed = "Vous n'êtes pas identifié en tant que responsable de ce site";
...
$langOneMyGroups = "sous ma coordination";
...
$langOtherProperties = "Autres propriétés trouvées dans l&acute;archive";
...
$langPlatformCoursesAccess = "Acc&egrave;s aux sites";
...
$langReply = "Répondre";
$langRequestCourseManagerStatus = "Demander le rôle de gestionnaire d'espaces";
$langRequired = "Requis";
$langRequirements = "Conditions requises";
$langResetChat = "Vider";
$langRestore = "Récupération";
$langRestore = "Restaurer";
$langRestoreACourse = "Restaurer un espace";
...
Lorsque vous aurez cliqué sur 'Restaurer', l&acute;archive sera décompressée et le cours recréé.";
$langRestoreNotice = "Ce script ne permet pas encore la restauration automatique des utilisateurs, mais les données sauvegardées dans le fichier 'users.csv' sont suffisantes pour que l&acute;administrateur puisse effectuer cette opération manuellement.";
$langRestoreNow = "récuperer l&acute;archive sur votre ordinateur";
$langRestoreNow = "récuperer l'archive sur votre ordinateur";
$langResult = "Résultat";
$langReuse = "Récupérer";
...
$langSaveContentDoc = "Documents";
$langSaveSubscription = "Sauver les inscriptions";
$langSaveSubscription = "Utilisateurs inscrits au cours et aux groupes";
$langScore = "Résultat";
...
$langShowAllProcessDuringTheWork = "Show all process during works ?";
...
$langTo = "vers";
$langToCourseSettings = "Retour aux propriétés de l&acute;espace";
$langToDate = "à";
$langToDate = "au";
...
$langUpgradeAll = "Mise à jour de l&acute;ensemble.";
$langUpgradeDataBase = "Mettre à jour la base de données";
...
$langUserNotUnsubscribed = "Radiation non effectuée !!! <br> Cet utilisateur ne peut pas être radié,<br>
                            vous ne pouvez pas radier un gestionnaire d'espace, changez son statut d'abord";
...
$langUserUnregisteredClass = "l&acute;utilisateur a été désinscrit de la sélection";
$langUserUnregisteredFromClass = "l&acute;utilisateur a été désinscrit de la sélection";
$langUserUnregisteredFromCourse = "l&acute;utilisateur  a été radié de l&acute;espace";
...
$langVersionClaro = "Version de claroline lors de l&acute;archivage";
$langVersionDb = "Version de la base de donnée lors de l&acute;archivage";
...
$langWhatDoAfterBackup = "Tâches à effectuer après l&acute;archivage";
$langWhatDoAfterBackup = "Tâches à effectuer après l'archivage";
$langWiki = "Wiki";
$langWikiContent = "Contenu du Wiki";
$langWork = "Contributions";
$langWork = "Contributions des uns et des autres";
$langWorkAuthors = "Auteur";
$langWorkContent = "Contributions jpostées";
$langWorkStructure = "Intitulés des contributions";
$langWorkTitle = "Titre";
