...
$langAddForums = "Da bi dodali forum, kliknite na\"Forum\"  kategoriju po Vašem izborniku. Prazna kategorija (bez foruma) neæe biti vidljiva za studente";
...
$langAdminBy = "Nadzor: ";
$langAdminEmail = "Administratorov email";
$langAdministrationTools = "Alati za nadzor";
$langAdminLogin = "Administratorova korisnièko ime";
$langAdminName = "Administratorovo ime";
$langAdminPass = "Administratorova zaporka";
$langAdminsOfThisCours = "administrator ove grupe";
$langAdminSurname = "Administratorovo prezime";
...
$langBackupOfDataBase = "Pohrana baze podataka";
$langBackupSuccesfull = "Pohrana uspješno obavljena";
$langBackUser = "Povratak na korisnièku listu";
$langBUAnnounceInMainBase = "Pohrana najavljenih podataka u bazi podataka za";
$langBUCourseDataOfMainBase = "Pohrana podataka predmeta u bazu podataka za";
$langBUCourseDataOfMainBase = "Pohrana podataka kolegija u bazu podataka za";
$langBuildTheCompressedFile = "2° - Stvaranje datoteke za pohranu";
$langBUUsersInMainBase = "Pohravna korisnièkih podataka u bazi podataka za";
...
$langCourseTitle = "Naziv kolegija";
$langCourseTitle = "Naziv predmeta";
$langCreate = "stvorite";
$langCreateClaroTables = "Napravi tablicu u bazi podataka";
...
$langDBSetting = "MySQL postavke baza podataka ";
$langDear = "Poštovani";
...
$langEnter = "Unesi";
$langEnter = "Povratak na popis predmeta";
$langEnter = "Ulaz";
...
$langExplanation = "Kad pritisnete OK web stranice æe biti stvorene, ukljuèujuæi forum, program rada , upravljanje dokumentima ";
$langExplanation = "Stranica mora biti u HTML formatu (e.g.\"my_page.ht\"). Bit æe link na poèetnoj stranici. Ako želite poslati u nekom drugom formatu (PDF, Word, Power Point, Video, itd.) koristite <a href=../document/document.php>Alati dokumenata</a>";
$langFac = "Kategorija";
$langFaculty = "Fakultet";
$langFields = "Ostavili ste neka prazna polja";
$langFieldsRequ = "Potrebno je ispuniti sve podatke";
$langFileCopied = "datoteka iskopirana";
...
$langGroupSpace = "Podruèje Groupe";
$langGroupSpace = "Podruèje grupa";
$langGroupSpaceLink = "Groupno podruèje";
...
$langIn = "u";
$langIndeed = "Zaista. Sokratova ironija je metoda govorništva. Grèki \"eirota\" znaèi\"postavi pitanj\"";
...
$langLinkSite = "Dodaj link na poèetnu stranicu";
$langLinkSite = "Link stranice";
$langLinksToClaroProjectSite = "Website projekta - link ";
$langLn = "Jeziène postavke";
$langLogIdentLogout = "Dnevnik prijava i odjava sa sustava";
$langLoginBeforePost1 = "Da bi poslali poruku forumu, ";
$langLoginBeforePost2 = "prije svega, morate ";
$langLoginBeforePost3 = "se prijaviti na Campus";
$langLogout = "Odjava";
$langMainDB = "Glavna claroline baza podataka";
$langManager = "Manager";
...
$langModifInfo = "Izmjeni podatke o kolegiju";
...
$langPrintVers = "Printajuæa verzija";
...
$langPropModify = "Promjeni karakteristike";
...
$langSubTitle = "Dodajte poèetnoj stranici kolegija link, stranicu ili bilo koju URL. Napomena: Ako želite dodati link za stanicu, poðite na tu stranicu uèilajte adresu  s adresne trake na vrhu vašeg preglednika i umetnite je u\"lin\" polje.";
...
$langTooBig = "Niste izabrali datoteku, ili je datoteka prevelika.";
$langTools = "Alati";
$langTrue = "Toèno";
$langTutor = "Tutor";
...
$l_aim = "AIM";
$l_author = "Autor";
$l_banned = "Vi ste uklonjeni iz ovog foruma. Kontaktirajte sistemskog administratora ukoliko imate pitanja.";
$l_body = "Poruka tijelo";
$l_by = "od";
$l_cancelpost = "Otkaži slanje";
$l_click = "Klik";
$l_confirm = "Potvrðeno";
$l_date = "Datum";
$l_delete = "Obriši ovu oruku";
$l_deleted = "Vaša Poruka je izbrisana.";
$l_deletesucces = "Uspješno brisanje.";
$l_disable = "Onemoguæi";
$l_email = "Email";
$l_emailaddress = "Email adresa";
$l_emptymsg = "Morate napisati oruku da bi je poslali. Ne možete poslati praznu poruku.";
...
$l_infoupdated = "Vaše informacije su obnovljene";
$l_interests = "Interesi";
$l_itemsreq = "Stavke oznaèene sa * su pretpostavljene";
$l_joined = "Udruženo";
$l_lastpost = "Posljednja Poruka";
$l_location = "Od";
$l_logout = "Odjava";
$l_messenger = "MSN Messenger";
$l_mismatch = "Pogrešna zaporka.";
$l_msn = "MSN";
$l_new = "Novo";
$l_nextpage = "Sljedeæa stranica";
$l_nomatches = "Nema zapisa koji odgovara vašem upitu. Molimo vas da proširite svoj upit.";
$l_nopmsgs = "Nemate novih Privatne Poruke poruka.";
...
$l_nouser = "To Korisni;ko ime ime ne postoji.";
$l_nousers = "Trenutno nema korisnika koji pregledavaju forume";
$l_number = "Broj";
$l_occupation = "Zanimanje";
$l_oftotal = "od svih";
$l_onlyreq = "Zahtjeva se samo ukoliko se mijenja";
$l_options = "Moguænost";
$l_password = "Zaporka";
$l_perday = "Poruke na dan";
$l_pmposted = "Odgovor je oslan, možete kliknuti <a href\"viewpmsg.ph\">ovdje</a> da bi vidjeli  Privatne Poruke ";
$l_posted = "Oglašeno";
$l_poster = "Oglas";
$l_posts = "Poruke";
$l_profile = "Profil";
$l_profileof = "Vidi Profile od";
$l_publicmail = "dozvoli ostalim korisnicima da vide moju Email adresa";
$l_recptname = "Korisnièko ime primatelja Korisni;ko ime";
$l_replies = "Odgovori";
$l_reply = "Odgovori";
$l_replyquote = "Vrati u navodima";
$l_returnindex = "povratak na indeks foruma";
$l_returntopic = "povratak na forumski popis.";
$l_search = "Traži";
$l_searchall = "Traži po svim rijeèima";
$l_searchallfrm = "pretraži sve forume";
$l_searchany = "Traži po bilo kojoj rijeèi";
$l_searchin = "Traži u";
$l_searchterms = "Kljuène rijeèi";
$l_selectforum = "Odaberite Forum";
$l_sendothermsg = "Pošalji još jednu privatnu poruku";
$l_sendpmsg = "Pošalji Privatnu poruku";
$l_separator = "» »";
$l_sigexplain = "Ovo je tekst koji može biti dodan poruci koju ste napravili.<BR>255 slova max!";
$l_signature = "Potpis";
$l_sortby = "Sortiraj rema";
$l_stored = "Vaša Poruka je pohranjena u bazi podataka.";
$l_subject = "Predmet";
$l_submit = "Podnijeto";
$l_topic = "Tema";
...
$l_toreturn = "povratak";
$l_tryagain = "Vratite se natrag i probajte ponovno.";
$l_url = "URL";
$l_userdisallowed = "Korisni;ko ime ime koje ste izabrali nije odobreno od strane administratora. Vratite se natrag i probajte ponovno.";
$l_username = "Korisni;ko ime";
$l_userpass = "Unesite svoje korisnièko ime i zaporku.";
$l_userremoved = "Ovaj korisnik je uklonjen iz korisnièke baze podataka";
$l_usertaken = "Korisni;ko ime ime koje ste izabrali væ' postoji.";
$l_viewforum = "Vidi Forum";
$l_viewmsg = "da vidite svoju Poruka.";
$l_viewpostuser = "Vidi poruku od ovog korisnika";
$l_website = "Web Site Adresa";
$l_whosonline = "Tko je online?";
$l_wrongpass = "Unijeli ste pogrešnu zaporku.";
$l_yahoo = "Yahoo Messenger";
$l_yim = "YIM";
$l_yourname = "Vaše Korisni;ko ime";
?>