<?php
$_lang['!!!! size of course repository (include claroline and garbage in old systems)'] = 'veli�?ina repozitorija predmeta (uklju�?uje Claroline i eventualne ostatke iz starijih verzija Claroline sustava)';
$_lang['%moduleName has been added as module'] = 'vježba je dodana u redoslijed u�?enja';
$_lang['%moduleName is already used as a module in this learning path'] = 'Ova se vježba vec koristi u redoslijedu u�?enja';
$_lang['(When an user open the index of the campus)'] = '(Kada korisnik pristupi po�?etnoj stranici u�?ilišta)';
...
$_lang['<strong>Approved</strong><p>Your campus registration has been approved by the Claroline.net team.</p>'] = '<strong>U�?ilište je prijavljeno</strong><p>Registracija vašeg u�?ilišta je prihvaćena od strane Claroline.net teama.<br /><i>Link</i> na stranice Vašeg u�?ilišta je dodan na <i>web</i> stranice www.claroline.net.</p>';
$_lang['<strong>Deleted</strong><p>Your campus registration has been desactivated, contact us (see our website) if you think this is an error.</p>'] = '<strong>U�?iliste odjavljeno</strong><p>Vaše u�?ilište je odjavljeno sa sustava www.claroline.net. Kontaktirajte administratore Claroline sustava u slu�?aju pogreške</p>';
$_lang['<strong>Removed</strong><p>Your campus has been removed from the worldwide page.</p>'] = '<strong>Uklonjen</strong><p><i>Link</i> na Vaše u�?ilište je uklonjen sa stranice www.claroline.net</p>';
$_lang['<strong>Submitted</strong><p>Waiting for validation by Claroline.net team.</p>'] = '<strong>Zahtjev poslan</strong><p>Zahtjev za registracijom Vašeg u�?ilišta je poslan Claroline.net teamu</p>';
...
$_lang['Access to campus'] = 'Statistike pristupa u�?ilistu';
$_lang['Access to courses'] = 'Statistike pristupa stranicama predmeta';
$_lang['Access to tools'] = 'Pristup alatima';
$_lang['Accounts with same <i>Email</i>'] = 'Korisni�?ki ra�?uni s istom <i>email adresom</i>';
$_lang['Accounts with same <i>User name</i>'] = 'Korisni�?ki ra�?uni s jednakim <i>korisni�?kim imenom</i>';
$_lang['Accounts with same <i>User name</i> AND same <i>Password</i>'] = 'Korisni�?ki ra�?uni kod kojih je <i>Korisni�?ko ime</i> jednako <i>Zaporci</i>';
...
$_lang['All modules of this course are already used in this learning path.'] = 'Svi moduli ovog predmeta već se koriste u ovom redoslijedu u�?enja';
...
$_lang['Among'] = 'od';
$_lang['An error occured.  Learning Path import failed.'] = 'Pogreška!  <i>Importiranje</i> redoslijeda u�?enja nije uspjelo';
...
$_lang['Are you sure you want to remove the following module from the learning path :'] = 'Želite li zaista  izbrisati odabrani modul iz redoslijeda u�?enja:';
...
$_lang['Average Time'] = 'Prosje�?no vrijeme (s)';
$_lang['Average score'] = 'Prosje�?no bodova';
$_lang['Back'] = 'Natrag';
$_lang['Back to Home page'] = 'Natrag na po�?etnu stranicu';
$_lang['Back to administration page'] = 'Natrag na administriranje';
$_lang['Back to class list'] = 'Natrag na popis razreda';
$_lang['Back to class members'] = 'Natrag na �?lanove razreda';
$_lang['Back to course list'] = 'Natrag na popis predmeta';
$_lang['Back to learning path administration'] = 'Natrag na administriranje redoslijeda u�?enja';
...
$_lang['Back to user settings'] = 'Natrag na korisni�?ke postavke';
...
$_lang['Campus name'] = 'Ime u�?ilista';
...
$_lang['Changes have been applied to the user settings'] = 'Korisni�?ke postavke su promijenjene';
$_lang['Changes have been saved'] = 'Promjene su spremljene';
$_lang['Chat'] = 'Chat';
$_lang['Chat reset by'] = '<i>Chat</i> je izbrisao:';
$_lang['Check this box to delete the attached file'] = 'Ozna�?ite kućicu da biste izbrisali priloženu datoteku Check this box to delete the attached file.';
$_lang['Choice'] = 'Vaš odabir';
$_lang['Clarodoc'] = 'Clarodoc';
$_lang['Claroline.net news'] = 'Claroline.net vijesti';
$_lang['Class members'] = '�?lanovi razreda';
...
$_lang['Complete language files'] = 'Svih jezi�?nih datoteka';
...
$_lang['Course Home'] = 'Po�?etna stranica predmeta';
$_lang['Course Repository'] = 'Repozitorij predmeta';
$_lang['Course access'] = 'Pristup stranicama predmeta';
$_lang['Course administrator only'] = 'Vidljivo isklju�?ivo voditeljima predmeta';
...
$_lang['Course progression'] = 'Napredak u redoslijedu u�?enja ';
...
$_lang['Courses without a lecturer'] = 'Predmeti bez predava�?a';
...
$_lang['Create a new learning path'] = 'Stvori novi redoslijed u�?enja';
$_lang['Create a new user'] = 'Stvori korisni�?ki ra�?un';
...
$_lang['Create user'] = 'Stvori korisni�?ki racun';
$_lang['Create user account'] = 'Otvori korisni�?ki ra�?un';
...
$_lang['Current registration status :'] = 'Stanje registracije u�?ilista: <br /> <br />
';
...
Ukoliko ste, zbog postavki sustava za upravljanje bazama podataka, ograni�?eni na jednu bazu podataka,
...
$_lang['Delete my account'] = 'Izbriši moj korisni�?ki ra�?un';
...
$_lang['Empty language file'] = 'Prazne jezi�?ne datoteke';
...
$_lang['Enrol as teacher'] = 'Prijavi u ulozi predava�?a';
...
$_lang['Error : Name already exists in the learning path or in the module pool'] = 'Pogreška: Ime se već koristi u redoslijedu u�?enja ili u zbirci modula';
$_lang['Error : One or more values are doubled'] = 'Pogreška: na više mjesta pojavljuje se jednaka vrijednost';
$_lang['Error : cannot read RSS feed'] = 'Pogreška prilikom �?itanja RSS <i>feeda</i>';
$_lang['Error in SQL statement'] = 'Pogreška u SQL upitu';
$_lang['Error reading <i>manifest</i> file'] = 'Pogreška pri �?itanju <i>manifest</i> datoteke';
$_lang['Error reading a secondary initialisation file :'] = 'Pogreška pri �?itanju sekundarne inicijalizacijske datoteke: ';
$_lang['Error reading zip file.'] = 'Pogreška pri �?itanju <i>zip</i> datoteke';
$_lang['Error!! you cannot unregister a course manager'] = 'Pogreška! Nije moguće odjaviti voditelja predmeta';
$_lang['ErrorInvalidParms'] = 'Pogrešan parametar (koristite isklju�?ivo brojeve)';
...
$_lang['Extract language variables'] = 'Ekstrakcija jezi�?nih varijabli';
...
$_lang['From'] = 'From';
$_lang['From language files'] = 'Iz jezi�?nih datoteka';
...
$_lang['Groups'] = 'Grupe';
$_lang['Groups (from groups tool, only group members can post)'] = 'Grupni (isklju�?ivo �?lanovi grupe mogu slati rješenja)';
...
$_lang['He or she will receive email confirmation with login and password'] = 'Korisniku će biti poslan email s korisni�?kim imenom i zaporkom';
$_lang['Heading'] = 'Zaglavlje';
$_lang['Help'] = 'Pomoć';
$_lang['Here you can modify the content of the text zones displayed on the platform home page.'] = 'Primjenom ovog alata moguće je promijeniti sadržaj tekstualnih podru�?ja koja se prikazuju na po�?etnoj stranici.';
$_lang['Hits'] = 'Broj pregleda';
$_lang['Home page text zones'] = 'Tekstualna podru�?ja po�?etne stranice';
$_lang['Hour'] = 'Za sat';
...
$_lang['Import a learning path'] = '<i>Importiraj</i> redoslijed u�?enja';
...
$_lang['Insert a document as module'] = 'Dodavanje dokumenta u redoslijed u�?enja';
...
$_lang['Invalid user : this user doesn\'t exist in your group'] = 'Pogreška: korisnik nije �?lan ove grupe';
$_lang['Invisible'] = 'Nevidljivi';
$_lang['Is platform admin'] = 'Administrator sustava';
$_lang['It seems that you already have registered your campus.'] = 'Vaše je u�?ilište već registrirano';
...
$_lang['Learning path'] = 'Redoslijed u�?enja';
$_lang['Learning path admin'] = 'Administranje redoslijeda u�?enja';
$_lang['Learning path content'] = 'Sadržaj redoslijeda u�?enja';
$_lang['Learning path has been successfully imported.'] = 'Redoslijed u�?enja je <i>importan</i>';
$_lang['Learning path list'] = 'Popis redoslijeda u�?enja';
$_lang['Learning path progression :'] = 'Napredak u redoslijedu u�?enja: ';
$_lang['Learning paths tracking'] = 'Praćenje napretka korisnika';
$_lang['Lecturer(s)'] = 'Predava�?i';
$_lang['Licence'] = 'Licenca';
$_lang['Limit'] = 'Ograni�?enje';
$_lang['Line Number'] = 'Broj linija';
$_lang['List of students in this group'] = 'Popis studenata ove grupe';
$_lang['Load default format'] = 'U�?itaj <i>default</i> format';
$_lang['Location'] = 'Smještaj';
$_lang['Login'] = 'Prijava';
$_lang['Login request'] = 'Informacije o korisni�?kom ra�?unu na sustavu';
$_lang['Logins'] = 'Prijavci';
$_lang['Logins and access to tools'] = 'Prijavci i pristup alatima';
$_lang['Logins not used'] = 'Neupotrebljeni korisni�?ki ra�?uni';
$_lang['Logout'] = 'Odjava';
...
$_lang['Make invisible'] = 'U�?ini nevidljivim';
$_lang['Make new search'] = 'Pretraživanje:';
$_lang['Make search'] = 'Traženje korisnika';
$_lang['Make visible'] = 'U�?ini vidljivim';
...
$_lang['Manifest read.'] = '<i>Manifest</i> je pro�?itan.';
$_lang['Matching'] = 'Povezivanje';
$_lang['Max file size'] = 'Maksimalna veli�?ina datoteke:';
$_lang['Max.'] = 'Maks.';
...
$_lang['Missing language files'] = 'Jezi�?nih datoteka koje nedostaju';
...
$_lang['Modules of this path will still be available in the pool of modules'] = 'Moduli ovog redoslijeda u�?enja i dalje će biti dostupni preko zbirke modula';
$_lang['Month'] = 'Mjesec';
...
$_lang['New learning path name :'] = 'Ime redoslijeda u�?enja: ';
$_lang['New question'] = 'Dodaj pitanje';
$_lang['New topic'] = 'Nova tema';
$_lang['New users will receive an e-mail with their user name and password'] = 'Novim korisnicima bit ce poslan e-mail s korisni�?kim imenom i zaporkom';
...
$_lang['No learning path'] = 'Nema redoslijeda u�?enja';
...
$_lang['No time limitation'] = 'Bez vremenskog ograni�?enja';
...
$_lang['Notify by email when replies are posted'] = 'Po�?ni pratiti temu (obavijest na email-om prilikom objave odgovora)';
$_lang['Now'] = 'Sada';
...
$_lang['Number of learning paths using this module :'] = 'Broj redoslijeda u�?enja koji koriste ovaj modul: ';
...
$_lang['Ooops, stranges cases detected !!'] = '<center>Pronađeni su problemati�?ni slu�?ajevi</center>';
...
$_lang['Password given is too simple or too close to the username.'] = 'Zaporka je prejednostavna, ili je previše sli�?na korisni�?kom imenu';
$_lang['Period'] = 'Period';
...
$_lang['Production language files'] = 'Jezi�?nih datoteka za produkcijski sustav';
$_lang['Progress'] = 'Napredak';
$_lang['Progress in learning paths'] = 'Napredak u redoslijedima u�?enja';
$_lang['Progression of users on all learning paths'] = 'Napredak korisnika po svim redoslijedima u�?enja';
$_lang['Public'] = 'Javan';
...
$_lang['Random questions'] = 'Nasumi�?an redoslijed pitanja';
...
$_lang['Register my campus'] = 'Prijavi u�?iliste';
...
$_lang['SCORM conformant modules are definitively removed from server when deleted in their learning path.'] = 'SCORM moduli su izbrisani sa servera i redoslijeda u�?enja';
$_lang['SDK'] = 'SDK';
$_lang['Save'] = 'Spremi';
...
$_lang['Send account information to user by email'] = 'Pošalji korisniku putem emaila podatke o korisni�?kom ra�?unu';
...
$_lang['Size'] = 'Veli�?ina';
$_lang['Start Module'] = 'Zapo�?ni rad s modulom';
$_lang['Start date'] = 'Može se predati od';
$_lang['Start date must be before end date ...'] = 'Rok predaje mora biti nakon po�?etka vježbe';
...
$_lang['Statistics of user'] = 'Korisni�?ka statistika';
$_lang['Status'] = 'Status';
...
$_lang['SwitchEditorToTextConfirm'] = 'Ova naredba prebacuje editor u tekstualni na�?in rada. Želite li nastaviti?';
$_lang['Take'] = 'odaberi';
$_lang['Technical Tools'] = 'Technical Tools';
$_lang['Text only (text required, no file)'] = 'Isklju�?ivo tekst (tekst obavezan, bez datoteke)';
...
$_lang['There is no start asset defined for this module.'] = 'Nedostaje po�?etak modula';
...
$_lang['This official code already appears in a previous line of the CSV file.'] = 'Mati�?na šifra već postoji u CSV datoteci';
$_lang['This official code is already used by another user.'] = 'Navedena mati�?na oznaka se već koristi';
$_lang['This user name is already taken'] = 'Korisni�?ko ime se već koristi';
...
$_lang['Time in learning path'] = 'Vrijeme u redoslijedu u�?enja';
...
$_lang['To'] = 'u';
$_lang['To send a message, select groups of users (marked with a * in the front) or single users from the list on the left.'] = 'Kako biste poslali poruku, odaberite grupu korisnika (sa zvjezdicom (*) na po�?etku) ili pojedine korisnike iz liste';
$_lang['Tool'] = 'Alat';
...
$_lang['Topics'] = 'Teme';
$_lang['Topics started'] = 'Zapo�?etih tema';
$_lang['Total'] = 'Ukupno';
...
$_lang['Unamed path'] = 'Neimenovani redoslijed u�?enja';
...
$_lang['User course settings'] = 'Korisni�?ke postavke za predmet';
...
$_lang['User settings'] = 'Korisni�?ke postavke';
$_lang['User unregistered'] = 'Korisnik odregistriran';
$_lang['User\'s course'] = 'Prijavljivanje/odjavljivanje s predmeta';
$_lang['Username'] = 'Korisni�?ko ime';
$_lang['UsernameAppearAlready'] = 'Korisni�?ko ime se prethodno pojavljuje u CSV datoteci';
$_lang['UsernameUsed'] = 'Navedeno korisni�?ko ime se već koristi';
...
$_lang['Variables with same content and different name'] = 'Varijable istog sadržaja s razli�?itim imenom';
$_lang['Variables with same name and different content'] = 'Varijable istog imena s razli�?itim sadržajem';
...
$_lang['Yesterday'] = 'Ju�?er';
$_lang['You are not a member of this group'] = 'Niste �?lan grupe';
...
$_lang['You didnt choose any file to send, or it is too big'] = 'Nije odabrana datoteka, ili je veli�?ina datoteke veća od dozvoljene';
...
$_lang['Your campus has been submitted and is waiting to be validate by Claroline.net team'] = 'Zahtjev za registracijom Vašeg u�?ilišta je poslan Claroline.net teamu';
...
$_lang['Your request to remove your account has been sent'] = 'Zahtjev za uklanjanjem korisni�?kog ra�?una je poslan';
...
Polaznici mogu uređivati rad �?ak i nakon što je predan.
...
Postoji ograni�?enje na veli�?inu datoteke, ovisno o postavkama sustava.
Tekstualni opis rješenja nije obavezan.

</li><li>Isklju�?ivo tekst (tekst obavezan, bez datoteke) - rješenje zadatka u tekstualnom obliku, koje se unosi putem Claroline editora teksta.
...
</li><li>Grupni (isklju�?ivo �?lanovi grupe mogu slati rješenja) - da bi predali rad, korisnici moraju biti �?lanovi barem jedne grupe ovog predmeta.
</li></ul>
...
<p>Ispravak može biti tekst, datoteka ili oboje. Voditelj predmeta odlu�?uje kada će se automatski ispravak prikazati polaznicima - nakon roka predaje ili nakon prve predaje rada.
</p>
...
<ul>
<li><strong>Uredi</strong> - Klikom na \'Uredi\' ikonu moguće je uredjivati rad. Rad može uređivati korisnik koji ga je predao, bilo koji �?lan
...
<li><strong>Vidljiv/nevidljiv</strong> - Ukoliko je rad ozna�?en kao vidljiv, svi polaznici predmeta će mu moći pristupiti.
</li>
...
\'napomene\', koje su vidljive isklju�?ivo voditeljima predmeta.
</li>
</ul>
...
Ako ozna�?ite ovaj modul kao nevidljiv, polaznici će moći pristupati modulima koji slijede nakon ovog.
Želite li zaista ozna�?iti ovaj modul kao nevidljiv?';
$_lang['blockConfirmBlockingPathMadeInvisible'] = 'Ovaj redoslijed u�?enja je blokiran.
Ako ozna�?ite ovaj redoslijed kao nevidljiv, polaznici će moći pristupati modulima redoslijeda u�?enja koji slijede nakon ovog.
Želite li zaista ozna�?iti ovaj redoslijed u�?enja kao nevidljiv?';
$_lang['blockConfirmDeleteModule'] = 'Ukoliko izbrišete modul, modul će biti uklonjen iz svih redoslijeda u�?enja u kojima se koristi.
Želite li zaista izbrisati ovaj modul?';
$_lang['blockConfirmDeleteScorm'] = 'Ovaj redoslijed u�?enja je dio SCORM <i>import</i> paketa. Ako obrišete ovaj redoslijed, svi SCORM moduli i datoteke će biti obrisani.  Želite li zaista izbrisati redoslijed u�?enja ';
...
$_lang['blockCourseDescriptionCourseContentComment1'] = 'Koja je važnost gradiva koje se podu�?ava u sklopu predmeta? Koliko je gradivo teško?
...
$_lang['blockCourseDescriptionHumanAndPhysicalResourcesComment1'] = 'Tko su predava�?i i asistenti? Koja je oprema dostupna?';
$_lang['blockCourseDescriptionHumanAndPhysicalResourcesComment2'] = 'Predstavljanje predava�?a i asistenata koji organiziraju predmet. Koja oprema je dostupna polaznicima?';
...
$_lang['blockCourseDescriptionTeachingTrainingActivitiesComment2'] = 'Popis aktivnosti i njihovo predstavljanje (opis aktivnosti, što se o�?ekuje od prijavljenih korisnika i sl.)';
...
najjednostavniji na�?in je da omogućite prijavljivanje na predmet tijekom jednog tjedna, obavijestite korisnike da se prijave, te
zatim onemogućite prijavljivanje i pronađete <i>uljeze</i> u listi prijavljenih korisnika.';
$_lang['blockDefaultLearningPathComment'] = 'Uvodni tekst redoslijeda u�?enja. Da biste ga zamijenili proizvoljnim/vlastitim tekstom kliknite na modify (ikonu/olovcicu)   This is the introduction text of this learning path. To replace it by your own text, click below on <b>modify</b>.';
...
<hr />
<h4>Na�?ini pregledavanja</h4>
Dokumenti se mogu pregledavati kao:
<ul>
<li>Popis datoteka (<i>default</i>)</li>
<li><i>Thumbnailovi</i></li>
</ul>
Na�?in pregledavanja možete odabrati klikom na odgovarajući link koji se nalazi s desne strane
...
<i>thumbnail</i> na�?inu pregledavanju.
</li>
...
<blockquote><small>
<i>Napomena</i>: Prilikom <i>uploada</i> <i>zip</i> datoteke moguće je ozna�?iti opciju \'<i>Odzippaj</i> .zip datoteku na serveru\'
</small></blockquote>
</li>
<li>
...
<blockquote><small>
<i>Napomena</i>: Ne preporu�?uje se <i>online</i> pisanje dužih dokumenata. Umjesto toga, napišite dokument <i>offline</i>, te ga zatim <i>uploadajte</i> na sustav.
</small></blockquote>
</p>
...
rješavati vježbe. U slu�?aju da je korisnik prijavljen, rezultati vježbi bit će spremljeni u statistikama predmeta.
<hr />
...
<ul>
<li> Odaberite kada vježba zapo�?inje</li>
<li> Odaberite kada vježba završava</li>
<li> Odredite vremensko ograni�?enje vježbe</li>
...
<ul>
<li>Ozna�?iti je li odgovor istinit</li>
...
<p>Pitanja su zadana u obliku teksta u kojem su neke rije�?i izostavljene.</p>
<p>
Praznine se definiraju pomoću uglatih zagrada [...] u koje korisnici upisuje rije�? koju nedostaju.
</p>
...
<p>Preporu�?ljivo je izbrisati oglednu temu i promijeniti ime foruma. Kategorije koje ne sadrže
forume neće biti prikazane polaznicima predmeta.</p>';
$_lang['blockIntroCourse'] = 'Nalazite se na po�?etnoj stranici predmeta.<br /><br />Pomoću ove stranice možete:
<ul>
...
$_lang['blockIntroLearningPath'] = 'Pomoću ovog alata moguće je stvoriti redoslijed u�?enja, koji definira redoslijed korištenja dokumenata, vježbi, HTML stranica, linkova i sl.<br />Kako biste redoslijedu u�?enja dodali uvodni tekst, kliknite na link:<br>';
...
$_lang['blockModulePoolHelp'] = 'Ova stranica omogućava pregled svih modula ovog predmeta<br>Sve vježbe i dokumenti koje dodate u redoslijed u�?enja, također će se pojaviti i u ovom popisu.';
$_lang['blockRegisterLocalUrl'] = 'URL Vaseg u�?ilista je lokalan.
Da biste registrirali u�?iliste, potreban je URL dostupan putem <i>weba</i>.<br /><br />
Provjerite vrijednost \'Web base\' varijable u konfiguracijskim datotekama Claroline sustava';
$_lang['blockUsedInSeveralPath'] = 'Vježba se koristi u jednom ili više redoslijeda ucenja. Ako je izbrišete, onemogućit ćete korištenje vježbe iz redoslijeda u�?enja.';
$_lang['blockUsersHelp'] = '<p>Alat \'Korisnici\' je namijenjen radu s korisni�?kim podacima. Tablica korisnika sadrži sljedeće podatke:
<ul>
<li>
<b>Korisni�?ko ime</b>. Klikom na korisni�?ko ime, moguće je dobiti podatke o odabranom korisniku, kao što je npr. Email
</li>

<li>
<b>Uloga</b>.
Vrijednost uloge nema utjecaja na prava korisnika unutar Claroline sustava, već služi isklju�?ivo kao sredstvo
ozna�?avanje uloga korisnika u sustavu.
...
Mentor grupe ima pristup svim funkcijama alata \'Grupe\' uklju�?ujući dozvole za mijenjanje poruka na forumu grupe.
...
<li>
<b>Promijeni</b> (rezervirano za voditelje predmeta). Naredba omogućava voditeljima predmeta mijenjanje korisni�?kih podataka vezanih za ovaj predmet.
Voditelji predmeta putem ove naredbe ne mogu mijenjati osobne podatke korisnika, kao što su ime, email i sli�?no.
...
Novostvorenom korisniku će prilikom stvaranja korisni�?kog ra�?una biti poslan email s obavijestima o registraciji, koji
sadrži korisni�?ko ime i zaporku.
</li>
<li><b>Dodaj korisnike iz datoteke</b></li> Naredbom se u sustav registriraju korisnici iz CSV datoteke.
</li>
<li>
<b>Prijavi razred na predmet</b>. Naredbom se na predmet prijavljuju svi �?lanovi razreda.
</li>
<li>
...
$_lang['if you choose to continue, lines with errors will simply be ignored'] = 'Ako odlu�?ite nastaviti, linije koje sadrže pogrešku bit će zanemarene';
...
$_lang['sampleLearnPathDescription'] = 'Ovo je ogledni redoslijed u�?enja, u kojem se nalaze ogledna vježba i ogledni dokument. Da biste promijenili ovaj tekst kliknite na olov�?icu';
...
$_lang['sampleLearnPathTitle'] = 'Ogledni redoslijed u�?enja';
$_lang['sampleQuizAnswer1'] = 'Ismijavanjem navesti sugovornika da prizna da je u krivu';
$_lang['sampleQuizAnswer1Comment'] = 'Neispravno. Sokratska ironija nije stvar psihologije, već se ti�?e rasprave';
$_lang['sampleQuizAnswer2'] = 'Priznavanje vlastitih pogrešaka da bi se sugovornika ponukalo da u�?ini to isto';
...
$_lang['sampleQuizAnswer3Comment'] = 'Doista. Sokratska ironija je metoda ispitivanja. "Eirotao" u gr�?kom zna�?i "postavljati pitanja"';
$_lang['sampleQuizAnswer4'] = 'Korištenje principa nekontradikcije da bi se sugovornika stjeralo u kut';
$_lang['sampleQuizAnswer4Comment'] = 'Odgovor nije neispravan. Istina je da se neznanje sugovornika otkriva pokazivanjem proturje�?nih zaklju�?aka koji slijede iz njegovih premisa.';
...
$_lang['warning : Installation cannot find the description of the learning path and has set a default comment.  You should change it'] = 'Upozorenje: Opisu redoslijeda u�?enja je dodijeljena <i>default</i> vrijednost, jer instalacija ne može pronaći opis redoslijeda u�?enja.';
$_lang['warning : Installation cannot find the name of the learning path and has set a default name.  You should change it.'] = 'Upozorenje: Naslovu redoslijeda u�?enja je dodijeljena <i>default</i> vrijednost, jer instalacija ne može pronaći naslov redoslijeda u�?enja.';
?>