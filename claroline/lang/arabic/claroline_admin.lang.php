...
$langPasswordWrong = "يجب إدخال كلمة السر مرتين بشكل متطابق حتى يتم تغيير كلمة لاسر القديمة";
$langPeriodDay = "اليوم";
...
$langUserCanCreateCourse = "يستطيع انشاء مقرر";
...
$langUserNameTaken = "اسم المستخدم الذي اخترته محجوز من قبل مستخدم آخر, اختر اسماً أخر من فضلك";
$langUserNoCourseToDisplay = "لا يوجد مقررات";
$langUserNotInClass = "المستخدم ليس في الصف";
$langUserNotUnsubscribed = "فشل إلغاء التسجيل !!! ?<br> لا يمكن إلغاء تسجيل هذا المستخدم <br>
لا تستطيع إلغاء تسجيل مدير المقرر , قم أولا يتغيير الإعدادات";
...
$langUserUnregisteredFromCourse = "قام المستخدم بإلغاء تسجيله في المقرر";
