...
<p> اتّبعوا الخطوات - اتّبعوا الخطوات التالية : التسجيل : عمّروا كل الحقول واختاروا\" خلق مواقع للدرو�\" للاشتغال:\" ثب�\"، ادرج (ادخل) رمز الدرس وابتكر رمزا ما عدا بعض المحتويات العرضية المهيئة لتجنيبكم الشعور بالقلق إزاء الصفحة البيضاء. وعند التسجيل يكون ثمة مراسلة قد بعثت إليكم لنذكركم باسم المستعمل وبكلمة السر التي يجب عليكم رقنها عند زيارتكم المقبلة
</p>
...
$langCopy = " نسخ ";
$langCopyDirectoryCourse = " نسج جذاذيات الدرس                              ";
...
$langForContent = " إذا أردتم مثلا ، خلق صنف\" نقاشات في إطار مجموعات صغيرة\" عليكم أن تخلقوا مجموعا من المنتديات في صنف كان ، مثال\"مجموعة\" ،\"مجموعة \" ،\" مجموعة \"...الخ يمكن أن يكون وصف منتدى مجموعة ما قائمة الأشخاص الذين يستدعون النقاش، مع إضافة تبرير لإقامته. إن خلقتم سبب أو لآخر منتدى\" نداء للإعان�\" يمكنكم لغاية الوصف، إضافة\" الإشارة للصعوبات بالنسبة إلى المحتوى أو إلى الجهاز.";
$langFormula = " أستاذكم  ";
...
$langHomeContent = " جلّ جداول (خانات) ايكامبوس ممتلئة بعد بنص صغير أو برابط حمل وضعهما عن طريق الخطأ أو على سبيل المثال. فالمطلوب منكم تحويرهما. كأن يكون ثمّة نصّ صغير. واضح للرؤية يتصدر موقعكم . يبتدئ هذا النص ب�\" هذا هو نص مدخل موقعكم..\" حوّروه واستغلوه لوصف درسكم وأهدافكم وجهازكم. فمرئيّة عملكم رهينة ذلك. فعديد الأدوات ( اجيندا، وثائق، تمارين..)تنشط من أجلكم عن طريق الخطأ عندما تتولون خلق موقعكم. فمن المستحسن بالنسبة إليكم أن تعطّلوا الأدوات التي لا تستعملونها حتى لا تضيعوا الوقت على مستعمليكم أو زائريكم. يمكنكم إضافة ورقات لورقة الاستقبال أيضا. استعملوا  أداة\" أضف صفح�\" لإضافة صفحة مع إرسالها نحو المزوّد. أمّا إذا أردتكم الإحالة على صفحة أو موقع موجودين، فاستعملوا أداة\"الربط نحو الموق�\". ويمكن للصفحات والروابط التي تضيفونها للصفحة الأولى أن تكون معطّلة ثمّ ملغاة خلافا للأدوات الموجودة عن طريق الخطأ والتي يمكن أن تكون معطلة دون أن تكون ملغاة. والأمر موكول لكم أن تقرّروا إن كان يجب على درسكم أن يظهر بقائمة الدروس من المفضّل أن لا يظهر بقائمة الدروس (انظر وظيفة\" خاصيات الدر�\") كلّ درس لا يزال في حالة\" تجري�\" أو بصدد الإعداد، وأن يظل إمكانية تسجيل طيلة الوقت الذي يستغرقه تصوّر إعداده.";
$langHour = " ساعة ";
$langHUser = "Aide utilisateurs";
$langImpossible = " عملية مستحيلة  ";
$langIn = "فى";
$langIndeed = " وفعلا، بأن السخرية السقراطية طريقة تساؤلية. وكلمة\" ايروتا�\" الإغريقية تعني\" سأل\".";
...
$langLinksToClaroProjectSite = " روابط نحو موقع المشروع ";
$langLogIdentLogout = "Log  login et logout";
...
$langSysInfo = " معلومات عن النظام ";
$langTableStructureDontKnow = " هذا الجدول غير  معروفة  ";
...
$l_password = " ???? ????? ";
$l_perday = " ????? ?? ????? ";
$l_pmposted = "Réponse postée, vous pouvez cliquer <a href\"viewpmsg.ph\">ici</a> pour voir vos  ??????? ??????? ";
$l_posted = " ??? ??? ";
$l_poster = " ???? ";
$l_posts = " ????? ";
$l_profile = " ????? ";
