...
$l_body = "نص الرسالة";
$l_click = "انقر";
$l_delete = "إلغاء هذه الرسالة";
$l_deleted = "تم حذف مشاركتك";
$l_emptymsg = "يجب عليك ان تكتب نص الرسالة, الرسئل الفارغة غير مسموحة";
$l_here = "هنا";
$l_indextitle = "فهرس المنتدى";
$l_lastpost = "الرسالة السابقة";
$l_notify = "إعلامي من خلال البريد الالكتروني عندما يتم إضافة ردود";
$l_notifybody = "
...
$l_notopics = "لا يوجد أي مشاركة في هذا المنتدى, تستطيع ان تقوم بالإضافة";
$l_posted = "تم الإرسال";
$l_poster = "المرسل";
$l_posts = "عدد المشاركات";
$l_returnindex = "العودة لفهرس المنتدى";
$l_returntopic = "العودة لقائمة مواضيع المنتدى";
$l_separator = " > ";
$l_stored = "تم تخرين رسالتك في قاعدة البيانات";
$l_subject = "الموضوع";
$l_topic = "الفقرة";
$l_topicreview = "معاينة المشاركة";
$l_topics = "المشاركات";
...
$langAdminName = "الكنية";
$langAdminPass = "كلمة السر";
$langAdminSurname = "الاسم الاول";
...
$langAuthenticationRequired = "التحقق من اسم المستخدم و كلمة السر مطلبو";
...
$langConfirmDeleteThisGroup = "هل انت متأكد من رغبتك بحذف هذه المجموعة؟";
...
$langDBConnectionParameters = "المتحولات الخاصة بالاتصال مع قاعدة بيانات MySQL";
$langDBHost = "قاعدة البيانات";
$langDBSettingNamesIntro = "سينشئ برنامج التنصيب قواعد البيانات الرئيسية لـ Claroline.
...
$langDBUse = "استخدام قاعدة البيانات";
$langDOCUMENTTypeDesc = "الوثيقة";
$langDate = "التاريخ";
$langDateLastWrite = "اخر رسالة كانت بتاريخ: ";
$langDay = "اليوم";
$langDay_of_weekNames = "مصفوفة";
$langDbName = "اسم قاعدة البيانات";
$langDbPrefixForm = "بادئة لاسماء قواعد بيانات المقررات";
$langDear = "عزيزي";
...
$langDocContent = "<p>إن أداة الوثائق تشبه إلى حد كبير مدير الملفات الذي تستخدمه في حاسبك الشخصي</p> <p> تستطيع ان تقوم بتحميل أي نوع من الملفات مثل ملفات الوثائق و الجداول الحسابية و صفحات الانترنت و العروض التقديمية و ملفات الاكروبات او الفلاش...إلخ.
...
$langExerciseContent = "<h4>ماهي أداة التمرين ؟ </h4>
...
$langFirstname = "الاسم";
$langForContent = "<p>المنتدى أداة تهدف لإيجاد بيئة مناسبة للنقاش التفاعلي , ففي حين أن البريد الالكتروني يسمح بالنقاش بين شخصين فالمنتدى يسمح بالنقاش العام او النقاش ضمن المجموعات الخاصة </p>
...
$langGroupsNotEmptied = "فشل في إفراغ المجموعات";
$langHClar = "بدء المساعدة";
$langHDoc = "ملفات المساعدة";
$langHExercise = "تمارين مساعدة";
$langHFor = "منتديات المساعدة";
$langHHome = "صفحة المساعدة";
$langHUser = "مستخدمين المساعدة";
$langHasBeenEnrolled = "تم تسجيله";
$langHasDel = "تم حذفه";
$langHeading = "الترويسة";
$langHelp = "المساعدة";
$langHelpAssignment = "الوظائف و المهام";
...
";
$langHelpGroups = "مساعدة المجموعات";
...
$langLastCheck = "التحقق الأخير قبل التنصيب";
...
$langMaxStudentGroup = "عدد الطلاب الأعظمي في كل مجموعة";
$langMaximum = "أعظمي : ";
$langMemorizeYourPassord = "قم بحفظ هذه المعلومات لانها ستلزمك عند دخولك للموقع المرة القادمة.";
$langMessage = "عندما تقوم بحذف المنتدى التجريبي سيتم حذف جميع الرسائل الموجودة ضمنه أيضاً";
$langMessageEnrollToCourseNotAllowed = "التسجيل في المقرر غير مسموح";
$langMessageRegistrationNotAllowed = "التسجيل في الموقع غير متاح";
...
$langMysqlNames = "  و اسماء الجداول MySQL اسم قاعدة بيانات";
...
$langNoTrackingForExerciseAttempt = "لا يوجد بيانات تتبع لهذه المحاولة";
...
$langNumGroup = "عدد المجموعات من اجل كل مقرر";
$langNumGroupStudent = "عدد الفرق التي يستطيع الطالب الالتحاق بها ضمن هذا المقرر";
$langNumero = "لا";
...
$langTheSystemIsCaseSensitive = "النظام يتحسس لحالة الأحرف الكبيرة او الصغيرة";
$langTheU = "المستخدم";
...
$langUserContent = "<p> أداة 'المستخدمين' تعرض معلومات المستخدمين في جدول مصنف , و فيما يلي وصف موجز لأعمدة الجدول
<ul>
<li>
