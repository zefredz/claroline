...
$langWikiDescriptionFormText = " Μπορείτε να επιλέξετε έναν τίτλο μια περιγραφή για το wiki : ";
$langWikiDiffAddedLine = " Προστιθέμενη γραμμή ";
$langWikiDiffDeletedLine = " Διαγραμμένη γραμμή ";
$langWikiDiffMovedLine = " Κινούμένη γραμμή ";
$langWikiDiffUnchangedLine = " Αμετάβλητη γραμμή ";
$langWikiDifferenceKeys = " Κλειδιά :";
$langWikiDifferencePattern = " διαφορές μεταξύ της έκδοσης %1\$s τροποποιημένη από %2\$s και έκδοση %3\$s τροποποιημένη απο %4\$s";
...
$langWikiIdenticalContent = " Ίδιο περιεχόμενο <br />καμιά αλλαγη δεν φυλάχτηκε";
$langWikiInvalidWikiId = "Μη έγκυρο Wiki Id";
$langWikiList = "Λίστα του Wiki";
$langWikiMainPage = "Κύρια σελία";
$langWikiMainPageContent = "Αυτη είναι η κύρια σελίδα του Wiki %s. Κανε σλικ στο '''Edit''' για να τροποποιήσεις το περιεχόμενο.";
$langWikiNoWiki = "Κενένα Wiki";
...
$langWikiNotAllowedToRead = "Δεν επιτρέπεται να διαβάσεις αυ΄τη τη σελίδαYou are not allowed to read this page";
$langWikiNumberOfPages = "Αριθμός σελίδων";
$langWikiOtherUsers = "Others (*);ανώνυμοι χρήστες, χρήστες που δεν είναι μέλοι αυτού του μαθήματος...";
$langWikiPageHistory = "Ιστορικό σελίδας";
$langWikiPageSaved = "Η σελίδα φυλάχτηκε";
$langWikiPreviewTitle = "Προεπισκόπηση : ";
$langWikiPreviewWarning = " ΠΡΟΕΙΔΟΠΟΙΗΣΗ: αυτή η σελίδα είναι μια προεπισκόπηση.  Οι τροποποιήσεις σας στο wiki δεν έχει φυλαχθεί ακόμα ! Για να τις φυλάξετε μη ξεχάσετε να κάνεε κλικ στο κουμπί 'save' στο τέλος της σελίδας.";
$langWikiProperties = "Ιδιότητες";
$langWikiReadPrivilege = "Διάβασε σελίδας";
$langWikiRecentChanges = "Πρόσφατες αλλαγές";
$langWikiRecentChangesPattern = "%1\$s τροποποιήθηκε στις %2\$s απο %3\$s";
$langWikiShowDifferences = "Δείξε τις διαφορές";
$langWikiTitle = "Τίτλος του wiki";
$langWikiTitleEdit = "Wiki : Αλλαξετε τις ιδιότητες";
$langWikiTitleNew = "Wiki : Δημιουργησε καινούργιο Wiki";
$langWikiTitlePattern = "Wiki : %s";
$langWikiVersionInfoPattern = "(εκδοση απο %1\$s τροποποιημένος απο%2\$s)";
