...
$langAddWrongAnswers = " Προσθέστε τις λανθασμένες απαντήσεις για τη λίστα καταλόγου <small>(Optionnal. Μια λανθασμένη απάντηση σε κάθε  γραμμή.) </small>";
...
$langCannotRemoveGroupForum = "Δεν μπορείται να αφαιρέσετε μια ομάδα συζήτησης. Πρέπει να αφαιρέσετε την ομάδα πρώτα";
$langCannotSeeExerciseDetails = "Προβολή λεπτομερών απαντήσεων γιατι δεν έγινε εξουσιοδότηση.";
...
$langConfirmDeleteThisGroup = " Είστε βέβαιοι να διαγράψετε αυτήν την ομάδα?";
...
$langExport = " Εξαγωγή ";
$langExportTrackingCsv = " Πάρτε τα στοιχεία σε ένα αρχείο CSV ";
...
<small>Αν δεν έχετε λογαριασμό χρήστη ακόμα, χρησιμοποιήστε <a href=\"%s\">τη φόρμα για δημιουργία λογαρισμού</a></small>";
...
$langMessageRegistrationNotAllowed = " Η Εγγραφή δεν επιτρέπεται στην πλατφόρμα";
...
$langMissing = "λείπει";
$langMissingFields = " Ελλειπή πεδίο(α) ";
...
$langNoGroupsDeleted = "Καμιά ομάδα δεν διαγράφτηκε";
...
$langNoTrackingForExerciseAttempt = "Δεν υπάρχουν αποτυπώματα για αυτή τη προσπάθειαt.";
...
$langNotSaved = "Μη δυνατή η φύλαξη";
...
$langRegisterCampusAdvice = "Παρακαλώ έλεγξτε ότι η διεύθυνση Url της πανεπιστημιούπολης μπορεί να ανοικτεί απο το διαδίκτυο.";
...
$langStatsByUser = "Στατιστικη χρηστών";
...
$langStatsOfExerciseAttempt = "Στατιστική με προσπάθειες άσκησης ";
$langStatsOfLearnPath = "Στατιστικά ";
$langStatsOfQuestion = "Στατιστική ερώτησης";
...
$langTrackExerciseError = "Οι λεπτομέρειες είναι λανθασμένες , απο ότι φαίνετε διότι ορισμένες ερωτήσεις έχουν αλλάξει μεταξύ αυτής της προσπάθειας και τώρα.";
$langTrackForumUsage = "Χρήση Forum ";
$langTrackNotEnoughAttempts = "Πρέπει να φτάσεις στο μέγιστο αριθμό προσπαθειών για να δείτε αυτά τα στατιστικά.";
...
$lang_p_FeedOf_s = "Rss τροφή για %s";
...
$lang_p_youNeedToBeAuthenticatedWithYour_s_account = "Πρέπει να επικυρωθείς με το  %s λογαριασμό σου";
...
$lang_toolsToFill = "Εργαλεία για δημοσιέυση";
