...
$_lang['Access count'] = 'Μέτρηση εισόδου';
$_lang['Access to campus'] = 'Είσοδος στο campus';
$_lang['Access to courses'] = 'Είσοδο στα μαθήματα';
...
$_lang['Accounts with same <i>User name</i> AND same <i>Password</i>'] = 'Λογαριαμοί με το ίδιο <i>User name</i> ΚΑΙ το ίδιο <i>Password</i>';
...
$_lang['Add a comment (optionnal) :'] = 'Πρόσθεσε σχόλιο (προαιρετικό) :';
...
$_lang['Add feedback'] = 'Πρόσθέστε Eπικοινωνία';
$_lang['Add forum'] = ' Προσθέστε συζήτηση';
$_lang['Add introduction text'] = 'Προσθήκη Εισαγωγικού Κειμένου';
...
$_lang['Add wrong answers for drop down lists <small>(Optionnal. One wrong answer by line.)</small>'] = ' Προσθέστε τις λανθασμένες απαντήσεις για τη λίστα καταλόγου <small>(Optionnal. Μια λανθασμένη απάντηση σε κάθε  γραμμή.) </small>';
$_lang['Add/modify a comment to'] = 'Πρόσθεσε/ Μετέτρεψε παρατήρηση';
$_lang['Added line'] = ' Προστιθέμενη γραμμή ';
$_lang['Admin'] = 'Διαχειριστής';
$_lang['Administration'] = 'Διαχείριση';
$_lang['Administrative code'] = 'Κωδικός διαχείρησης';
$_lang['Administrator'] = 'Διαχειριστής';
$_lang['Advanced'] = 'Προχωρημένο';
$_lang['Advanced course search'] = 'Προχωρημένη έρευνα μαθήματος';
$_lang['Advanced user search'] = 'Προχωρημένη έρευνα χρήστη';
$_lang['After last allowed attempt'] = 'Μετά απο την τελευταία επιτρεπόμενη προσπάθεια';
$_lang['Agenda'] = 'Ατζέντα';
$_lang['Agenda next events'] = 'Έπομενα γεγονόντα της Ατζέντας';
$_lang['All'] = 'Όλα';
...
$_lang['Allowed : do not record usernames in tracking, anonymous users can do the exercise.'] = 'Επιτρέπεται : μη καταγραφή των ονομάτων χρηστών στην παρακολούθηση, ανώνυμοι χρήστες μπορούν να κάνουν την άσκηση.';
...
$_lang['An error occurred while contacting Claroline.net'] = 'Σφαλμα προέκυψε κατα την επικοινωνία με το Claroline.net';
...
$_lang['Answers to the question'] = 'Απαντήσεις σε ερώτηση';
$_lang['Are you sure to delete'] = 'Είστε βέβαιος ότι θέλετε να το διαγράψετε';
$_lang['Are you sure to delete this group ?'] = ' Είστε βέβαιοι να διαγράψετε αυτήν την ομάδα?';
$_lang['Are you sure you want to completely delete this question ?'] = 'Είσαι σίγουρος επιθυμείς να διαγράψεις εντελώς αυτή την ερώτηση ?';
$_lang['Are you sure you want to delete all groups ?'] = 'Είσαι σίγουρος επιθυμείς να διαγράψεις όλες τις ομάδες ';
$_lang['Are you sure you want to delete this exercise ?'] = 'Είστε σίγουρος επιθυμείτε να διαγράψετε αυτή την άσκηση ?';
$_lang['Are you sure you want to empty all groups ?'] = 'Είσαι σίγουρος οτι επιθυμείς να αδειάσεις/καθαρίσεις όλες τις ομάδες  ?';
$_lang['Are you sure you want to enrol the whole class on the course ?'] = 'Είσαι σίγουρος επιθυμείς να εγγράψεις όλοκληρη την τάξη (class) στο μάθημα (course) ?';
...
$_lang['Are you sure you want to remove this course from your list ?'] = 'Είσαι σίγουρος επιθυμείς να αφαιρέσεις αυτό το μάθημα απο τη λίστα σου ?';
$_lang['Are you sure you want to unregister'] = 'Είσαι σίγουρος επιθυμείς να διαγραφείς';
$_lang['Area for this group'] = 'Περιοχή για την ομάδα χρηστών';
$_lang['Asset not found :'] = 'Στοιχείο δεν ευρέθη : ';
$_lang['Assignment'] = 'Εργασία';
$_lang['Assignment deleted'] = 'Εργασία διαγράφηκε';
$_lang['Assignment modified'] = 'Εργασίας τροποποιήθηκε';
...
$_lang['Attached file'] = 'Το αρχείο έχει επισυναπθεί';
...
$_lang['Author(s) is(are) required'] = 'Συγγραφέας -εις/Δημιουργός-οι απαιτούνται';
...
$_lang['Average score'] = 'Μέσο όρο';
$_lang['Back'] = 'Επιστροφή';
$_lang['Back to Home page'] = 'Επιστροφή στην αρχική σελίδα';
$_lang['Back to administration page'] = 'Επιστροφή στη σελίδα διαχείρησης';
...
$_lang['Back to learning path administration'] = 'Επιστροφή στη διαχείρηση της πορείας μάθησης';
$_lang['Back to list'] = 'Επιστροφή στη λίστα';
$_lang['Back to my course list'] = 'Επιστροφή στη λίστα του μαθήματος μου';
...
$_lang['By deleting a label you will delete all modules or label it contains.'] = 'Διαγράφοντας μία ετικέτα θα διαγραφούν και όλες οι ενότητες ή ετικέτες που περιέχει.';
$_lang['CSV file with the user list :'] = 'CSV αρχείο με τη λίστα χρήστη : ';
$_lang['Campus name'] = 'Όνομα site';
$_lang['Can have courses'] = 'Μαθήματα που μπορεί να έχει : ';
$_lang['Cancel'] = 'Ακύρωση';
$_lang['Cannot copy the file'] = 'Δεν αντιγράφεται το αρχείο.';
$_lang['Cannot extract manifest from zip file (corrupted file ? ).'] = 'Δεν μπορεί να εμφανίσει απόσπασμα απο το zip αρχείο .';
$_lang['Cannot find <i>manifest</i> file in the package.<br /> File not found : imsmanifest.xml'] = 'Δεν μπορεί να βρεί το αρχείο <i>manifest</i> στο πακέτο.<br /> Αρχείο δε βρέθηκε : imsmanifest.xml';
$_lang['Cannot find secondary initialisation file in the package.<br /> File not found :'] = 'Δεν μπορει να βρεί δευτερεύον ρύθμιση έναρξης αρχείου στο πακέτο.<br /> Αρχείο δε βρέθηκε  : ';
$_lang['Categories'] = 'Κατηγορίες';
$_lang['Category'] = 'Κατηγορία';
$_lang['Category code'] = 'Κωδικός κατηγορίας :';
$_lang['Category code is required'] = 'Κωδικός κατηγορίας απαιτείται';
...
$_lang['Change picture'] = 'Αλλαγή εικόνας';
$_lang['Changes have been applied to the user settings'] = 'Οι αλλαγές έχουν εφαρμοστεί στις ρυθμίσεις του χρήστη';
$_lang['Changes have been saved'] = 'Αλλαγές έχουν αποθηκευτεί';
$_lang['Chat'] = 'Κουβεντούλα';
$_lang['Chat of the group'] = ' Συνομιλία της ομάδας ';
$_lang['Chat reset by'] = ' Ρύθμιση Chat Νέο από';
...
$_lang['Choose now a username and a password for the user account'] = ' Επιλέξτε τώρα ένα όνομα χρήστη και έναν κωδικό πρόσβασης για το λογαριασμό χρήστη σου. ';
...
$_lang['Course title needed'] = 'Τίτλος μαθήματος απαιτείται';
$_lang['Course users list'] = 'Λίστα χρηστών μαθήματος';
$_lang['Courses'] = 'μαθήματα.';
$_lang['Courses not used'] = 'Μαθήματα που δεν χρησιμοποιούνται';
...
$_lang['Create hyperlink'] = 'Δημιουργία υπερσύνδεσης';
...
$_lang['Current attached file'] = 'Τρέχων επισυναπτόμενο αρχείο';
$_lang['Current feedback file'] = 'Τρέχων αρχείο Επικοινωνίας';
$_lang['Current file'] = 'Τρέχων αρχείο ';
...
';
$_lang['Database Host'] = 'Host Βάσης Δεδομένων';
$_lang['Database name'] = 'Όνομα Βάσης Δεδομένων';
$_lang['Database usage'] = 'Χρήση της Βάσης Δεδομένων';
$_lang['Date'] = 'Ημερομηνία';
$_lang['Day'] = 'Ημέρα';
$_lang['Default works visibility'] = 'Εμφάνιση προκαθορισμένων εργασιών';
...
$_lang['Department'] = 'Πανεπιστήμιο';
$_lang['Department URL'] = 'Ιστοσελίδα Πανεπιστημίου';
$_lang['Department URL is not valid'] = 'Τμήμα URL δεν είναι έγκυρο';
$_lang['Description'] = 'Περιγραφή';
$_lang['Description added.'] = 'Ποσθήκη περιγραφής.';
$_lang['Description deleted.'] = 'Διαγραφή περιγραφής.';
$_lang['Description of the Wiki'] = 'Περιγραφή του Wiki';
$_lang['Description updated'] = 'Περιγραφή ενημερώθηκε.';
$_lang['Detail'] = 'Λεπτομέρειες';
$_lang['Details'] = 'Λεπτομέρειες';
$_lang['Details may be incorrect as it seems that some questions have change between this attempt and now.'] = 'Οι λεπτομέρειες είναι λανθασμένες , απο ότι φαίνετε διότι ορισμένες ερωτήσεις έχουν αλλάξει μεταξύ αυτής της προσπάθειας και τώρα.';
$_lang['Devel Tools'] = 'Εργαλεία Devel';
$_lang['Differences :'] = ' Διαφορές :';
$_lang['Directory created'] = 'Ο κατάλογος δημιουργήθηκε';
$_lang['Disable'] = 'Αδύνατο';
$_lang['Disable text editor'] = 'Απενεργοποίηση επεξεργαστή κειμένου';
$_lang['Disk Usage'] = 'Χρήση δίσκου';
$_lang['Display of detailled answers is not authorized.'] = 'Προβολή λεπτομερών απαντήσεων γιατι δεν έγινε εξουσιοδότηση.';
...
$_lang['Document content'] = 'Περιεχόμενο εγγράφου : ';
$_lang['Document deleted'] = 'Διαγράφτηκε το έγγραφο';
$_lang['Document in module'] = 'Έγγαρφο σε ενότητα';
$_lang['Document name'] = 'Όνομα εγγράφου : ';
$_lang['Documents'] = 'Έγγραφα';
$_lang['Documents and Links'] = 'Εγγραφα';
$_lang['Documents downloaded by the student'] = 'Αρχεία που κατέβασε (donwloads) ο εκπαιδευόμενος';
$_lang['Documents help'] = 'Αρχεία Βοήθειας';
$_lang['Documents of the group'] = 'Έγγραφα της ομάδας ';
$_lang['Down'] = 'Εντολή συνέχειας';
$_lang['Download attached file'] = 'Κατεβάστε επισυναπτόμενο αρχείο';
$_lang['EG'] = 'π.χ.';
$_lang['ERROR: The format you gave is not compatible with Claroline'] = 'ΣΦΑΛΜΑ: Η φόρμα-διάταξη που δώσατε δεν είναι συμβατή με το Claroline';
$_lang['Edit'] = 'Διόρθωση';
...
$_lang['Enable text editor'] = 'Ενεργοποίηση επεξεργαστή κειμένου';
...
$_lang['Enter new password twice to change, leave empty to keep it'] = 'Βάλτε δυο φορές νεο κωδικό (password) για να γίνει αλλαγή, αφήστε το κενό για να κρατήσετε το ίδιο';
...
$_lang['Error : Cannot initialize chat'] = 'Σφαλμα : Δεν μπορεί να ξεκινήσει το chat';
...
$_lang['Error : cannot read RSS feed'] = 'Σφάλμα : δεν ειναι δυνατόν να διαβαστούν τα RSS δεδομένα';
$_lang['Error copying existing SCORM content'] = 'Λάθος αντιγραφής υπάρχων περιεχομένου SCORM';
$_lang['Error in SQL statement'] = 'Σφλαμα στη δήλωση SQL';
$_lang['Error reading <i>manifest</i> file'] = 'Σφαλμα ανάγνωσης αρχείου <i>manifest</i>';
$_lang['Error reading a secondary initialisation file :'] = 'Σφάλμα ανάγνωσης δευτερεύουσας ρύθμισης έναρξης αρχείου : ';
$_lang['Error reading zip file.'] = 'Σφάλμα ανάγνωσης αρχειου zip.';
$_lang['Error when copying needed SCORM files'] = ' Λάθος κατά την αντιγραφή των αναγκαίων αρχείων SCORM ';
$_lang['Error!! you cannot unregister a course manager'] = 'Σφάλμα!! δεν μπορείς να καταργήσεις την εγγραφή ενός διαχειρηστή μαθήματος';
$_lang['ErrorInvalidParms'] = 'Σφάλμα : μη έγγυρη παράμετρος (χρήση αριθμών μόνο)';
$_lang['Event added to the agenda'] = 'Γεγονός προστέθηκε στην Ατζέντα';
$_lang['Event deleted from the agenda'] = 'Γεγονός διαγράφεται απο την Ατζέντα.';
$_lang['Event updated into the agenda'] = 'Γεγονός ενημερώνεται στην ημερήσια διάταξη.';
$_lang['Exercice not found'] = '’σκηση δεν εβρέθει';
...
$_lang['Exercise description'] = 'Περιγραφή άσκησης';
...
$_lang['Exercise management'] = '’σκηση διαχείρησης';
$_lang['Exercise name'] = 'Όνομα άσκησης';
$_lang['Exercise no longer available'] = '’σκηση όχι πια διαθέσιμη';
$_lang['Exercise not available'] = 'άσκηση όχι διαθέσιμη';
...
$_lang['External link'] = ' Εξωτερική σύνδεσμος ';
$_lang['External tool deleted'] = 'Eξωτερικό εργαλείο διαγράφηκε';
$_lang['External tool updated'] = 'Εξωτερικό εργαλείο ενημερώθηκε';
$_lang['Extract language variables'] = 'Ποικιλία αποσπασμάτων γλώσσας';
$_lang['False'] = ' Λανθασμένο ';
$_lang['Feedback'] = 'Feedback';
$_lang['Feedback added'] = 'Feedback προστέθηκε';
$_lang['Feedback file'] = 'Feedback αρχείο';
$_lang['Feedback text'] = 'Feedback κείμενο';
$_lang['Feedbacks'] = 'Feedbacks';
$_lang['Fields enclosed by'] = 'Πεδία που είναι κλεισμένα απο';
$_lang['Fields separator used'] = 'Διαχωριστικά πεδίων σε χρήση';
$_lang['File (file required, description text optional)'] = 'Aρχείο (Απαιτείται αρχείο,περιγραφή κειμένου προαιρετική)';
$_lang['File Name or URL is missing.'] = 'Ονομα αρχείου ή το URL λείπει.';
$_lang['File content modified'] = 'Περιεχόμενο αρχείου επεξεργάζεται';
...
$_lang['File name is missing'] = 'Ελλιπες όνομα αρχείου';
$_lang['File received : %filename'] = 'Αρχείο ελήφθη :  %filename';
$_lang['File structure checker'] = ' Ελεγκτής δομής αρχείων ';
...
$_lang['Fill the area to explain your motivation and submit your request. An e-mail will be sent to platform adminisrator(s).'] = 'Συμπλήρωσε την περιοχή εξηγόντας το κίνητρό σου και υπέβαλε το αίτημά σου. Ένα e-mail θα σταλεί στον -ους διαχειρηστή-ές πλατφόρμας(platform).';
...
$_lang['From script files'] = 'Απο αρχεία κειμένων';
...
$_lang['Get tracking data in a CSV file'] = ' Πάρτε τα στοιχεία σε ένα αρχείο CSV ';
$_lang['Go back to the exercise'] = 'Επιστροφή στην άσκηση';
$_lang['Go back to the question list'] = 'Επιστροφή στην λίστα ερωτήσεων';
$_lang['Go back to the question pool'] = 'Επιστροφή στο σύνολο ερωτήσεων';
...
$_lang['He or she will receive email confirmation with login and password'] = 'Αυτός (αυτή) θα λάβει ειδοποίηση μέσω email με όνομα χρήστη και συνθηματικό';
$_lang['Heading'] = 'Επικεφαλίδα';
$_lang['Help'] = 'Βοήθεια';
$_lang['Here you can modify the content of the text zones displayed on the platform home page.'] = 'Εδώ μπορείσ να επεξεργαστείς το περιεχόμενο επόμενων ζώνων καταχωρημένα στη platform αρχικής σελίδας';
$_lang['Hits'] = 'Hits (χτυπήματα/βολές???)';
$_lang['Home page help'] = 'Αρχική σελίδα βοήθειας';
$_lang['Home page text zones'] = 'Αρχικής σελίδας κείμενα ζωνων';
$_lang['Hour'] = 'Ώρα';
$_lang['Identical content<br />no modification saved'] = ' Ίδιο περιεχόμενο <br />καμιά αλλαγη δεν φυλάχτηκε';
$_lang['If you wish to enrol on this course'] = 'Εαν επιθυμείτε να εγγραφείτε στο μάθημα αυτό';
$_lang['IfNotRedirect'] = 'Αν δεν έχουν προωθηθεί';
$_lang['Import'] = 'εισαγωγή';
$_lang['Import a learning path'] = 'Εισαγωγή διαδρομής μάθησης';
$_lang['Imported packages must consist of a zip file and be SCORM 1.2 conformable'] = 'Εισαγώμενα πακέτα πρεπει να αποτελούνται απο ένα zip αρχείο και να είναι συμβατά με το SCORM 1.2 ';
...
$_lang['Include picture'] = 'Συμπεριέλαβε εικόνα';
$_lang['Individual'] = 'ατομικά';
$_lang['Information'] = 'πληροφορία';
$_lang['Information to give to students'] = 'Πληροφορία για τους φοιτητές';
$_lang['Insert a document as module'] = 'Εισαγωγή εγγράφου σαν ενότητα';
$_lang['Insert a module of the course'] = 'Εισαγωγή ενότητας μαθήματος';
$_lang['Insert my exercise'] = 'Εισαγωγή της άσκησης μου';
$_lang['Insert my module'] = 'Εισαγωγή της ενότητας';
$_lang['Insert new name'] = 'Εισαγωγή νέου ονόματος';
$_lang['Institution'] = 'Καθιέρωση';
$_lang['Institution URL'] = 'Καθιέρωση URL';
...
$_lang['Is platform admin'] = 'είναι διαχειρηστής της πλατφόρμας ';
...
$_lang['Last 31 days'] = 'Τελεθταίες 31 ημέρες';
$_lang['Last 7 days'] = 'Τελευταίες 7 μέρες';
$_lang['Last access'] = 'Τελευταία είσοδο';
...
$_lang['Learning path admin'] = 'Διαχειρηση διαδρομής μάθησης';
...
$_lang['Learning path list'] = 'Λίστα διαχείρησης διαδρομής ';
...
$_lang['Load default format'] = 'Load default format(Φόρτωση εξ ορισμού ????)';
$_lang['Location'] = 'Τοποθεσία';
$_lang['Locked'] = 'Κελιδωμένο';
$_lang['Login'] = 'Login';
$_lang['Login request'] = 'Login απαιτείται';
$_lang['Logins'] = 'Logins';
$_lang['Logins and access to tools'] = 'Logins και εργαλεία εισόδου';
$_lang['Logins not used'] = 'Logins δεν χρησιμοποιούνται';
$_lang['Logout'] = 'Εξοδος';
$_lang['Lost password'] = 'Υπενθύμιση κωδικού';
$_lang['Mail is already used by another user.'] = 'Mail χρησιμοποιείται ήδη απο άλλο χρήστη';
$_lang['Mail synthax error.'] = 'Mail synthax σφάλμα.';
$_lang['Main Group Settings'] = 'Ρυθμίσεις κύριας ομάδας';
$_lang['Main database'] = 'Κεντρική βάση δεδομένων';
$_lang['Main page'] = 'Κύρια σελία';
$_lang['Maintenance'] = ' Συντήρηση ';
$_lang['Make correspond'] = 'Γίνεται Αντιστοίχιση';
$_lang['Make invisible'] = 'Γίνεται μη ορατό';
$_lang['Make new search'] = 'Γίνεται νέα έρευνα : ';
$_lang['Make search'] = 'Γίνεται έρευνα';
$_lang['Make visible'] = 'Γίνεται ορατό';
$_lang['Manage classes'] = 'Διαχείρηση τάξεων';
$_lang['Manage course categories'] = 'Διαχείρηση κατηγοριων μαθήματος';
$_lang['Manager'] = 'Διαχειριστής';
$_lang['Manifest found in zip file :'] = 'Ανακοίνωση εβρέθη σε zip αρχείο : ';
$_lang['Manifest read.'] = 'Ανακοίνωση διαβάστηκε.';
$_lang['Matching'] = 'Matching (Ταίριασμα???)';
$_lang['Max file size'] = 'Μέγιστο μέγεθος αρχείου : ';
$_lang['Max.'] = 'μέγ.';
$_lang['Memorize them, you will use them the next time you will enter to this site.'] = 'Αποστήθησε τα, θα τα χρείαστεις την επόμενη φορά που θα μπείς σε αυτή τη σελίδα.';
...
$_lang['Missing field(s)'] = ' Ελλειπή πεδίο(α) ';
$_lang['Missing images detected'] = 'Εντοπ\'ιστηκαν ελλιπείς εικόνες-σύμβολα';
$_lang['Missing language files'] = 'Ελλιπή αρχεία γλώσσας';
$_lang['Missing value'] = 'Ελλειπής αξιολόγηση';
$_lang['Modifies this announcement'] = 'Αλλαγή της ανακοίνωσης';
$_lang['Modify'] = 'Διόρθωση';
$_lang['Modify a work'] = 'Επεξεργασία εργασίας';
$_lang['Modify exercise'] = ' Τροποποιήστε την άσκηση ';
...
$_lang['Module type'] = 'τύπος ενότητας';
$_lang['Modules'] = 'Ενότητες';
$_lang['Modules of this path will still be available in the pool of modules'] = 'Ενότητες αυτής της διαδρομήςθα είναι ακόμα διαθέσιμες στο σύνολο των ενοτήτων';
$_lang['Month'] = 'Mήνας';
...
$_lang['Moved line'] = ' Κινούμένη γραμμή ';
$_lang['Multiple answers'] = 'Πολλαπλές απαντήσεις';
...
$_lang['My calendar'] = 'Το ημερολόγιο μου';
...
$_lang['My results'] = 'Τα αποτελέσματα';
$_lang['MySQL Database and Table Names'] = 'MySQL Βάση δεδομένων και πίνακα ονομάτων';
$_lang['Mysql Repository'] = 'Mysql Repository (πηγή πληροφοριών???)';
$_lang['Mysql connection parameters'] = 'Mysql παράμετροι σύνδεσης';
$_lang['Name cannot be empty'] = 'Το όνομα πρέπει να συμπληρωθεί';
$_lang['Name link'] = 'Ονόμασε το σύνδεσμο';
$_lang['Name of the class has been changed'] = 'Όνομα τάξης έχει αλλαχθεί';
$_lang['Name of the new directory'] = 'Όνομα του καινούριου καταλόγου';
$_lang['Name of the tool'] = 'Όνομα εργαλείου';
$_lang['Never browsed'] = 'browsed ποτέ';
...
$_lang['New assignment created'] = 'Νέα Εργασία δημιουργήθηκε';
$_lang['New chat'] = 'Νέο chat';
$_lang['New exercise'] = 'Καινούρια Ασκηση';
$_lang['New learning path name :'] = 'Νέο όνομα διαδρομής μάθησης : ';
...
$_lang['No course available fitting this keyword'] = 'Δεν υπάρχει μάθημα διαθέσιμο που να ταιριάζει σε αυτή τη λέξη κλειδί';
$_lang['No course to display'] = 'Δεν υπάρχει μάθημα για να παρουσιαστεί';
$_lang['No email address specified'] = 'Δεν έχει γίνει συγκεκριμένη η διεύθυνση του email';
$_lang['No error in file found.'] = 'Δεν βρέθηκε σφάλμα σε αρχείο.';
$_lang['No event in the agenda'] = 'Δεν υπάρχουν γεγονότα στην ημερήσια Ατζέντα';
$_lang['No forum'] = ' Καμιά συζήτηση ';
$_lang['No group deleted'] = 'Καμιά ομάδα δεν διαγράφτηκε';
$_lang['No image to display'] = 'Καμία εικόνα να εμφανίσει';
$_lang['No learning path'] = 'Καμία διαδρομή μάθησης';
$_lang['No module'] = 'Καμία ενότητα';
$_lang['No module in package'] = 'Δεν υπάρχει ενότητα στο πακέτο';
$_lang['No new post allowed'] = 'Καμια καινούργια γνωστοποίηση δεν επιτρέπεται';
$_lang['No post'] = 'Καμία καταχώρηση';
$_lang['No quota'] = 'Καμια αναλογία';
$_lang['No result'] = 'Κανένα αποτέλεσμα';
$_lang['No score'] = 'Καμία βαθμολογία';
$_lang['No scripts'] = 'Δεν υπάρχουν scripts';
$_lang['No stats to show.  You haven\'t registered any course.'] = 'Δεν υπάρχουν στατιστικά να εμφανίσει.  Δεν έχετε εγγραφεί σε κανένα μάθημα.';
$_lang['No time limitation'] = 'Κανένας χρονικός περιορισμός';
$_lang['No user found'] = 'Δεν βρέθηκε χρήστης';
$_lang['No user to display'] = 'Κανένας χρήστης για να εμφανίσει';
...
$_lang['Not allowed : record usernames in tracking, anonymous users cannot do the exercise.'] = 'Δεν επιτρέπεται: καταγραφή των ονομάτων χρηστών στην παρακολούθηση, ανώνυμοι χρήστες δεν μπορούν να κάνουν την άσκηση.';
...
$_lang['Number of courses by faculty'] = 'Αριθμός μαθημάτων κατά κλάδο';
$_lang['Number of courses by language'] = 'Αριθμός μαθημάτων κατά γλώσσα';
$_lang['Number of courses by visibility'] = 'Αριθμός μαθημάτων κατά εμφάνιση ';
$_lang['Number of learning paths using this module :'] = '
Αριθμός διαδρομών μάθησης που χρησιμοποιούν αυτή την ενότητα : ';
$_lang['Number of logins'] = 'Αριθμό των logins';
$_lang['Number of pages'] = 'Αριθμός σελίδων';
$_lang['Number of rows'] = 'Αριμός σειρών/γραμμών';
$_lang['Number of users'] = 'Αριθμός χρηστών';
$_lang['Number of users by course'] = 'Αριθμός χρηστών κατά μάθημα';
$_lang['Number of users by faculty'] = 'Αριθμός χρηστών κατά κλάδο';
$_lang['Number of users by status'] = 'Αριθμός χρηστών κατά κατάσταση/υπόσταση (status)';
$_lang['Number proposed exceeds max. that you allowed (you can modify it below). Group composition has not been modified'] = 'Ο αριθμός που προτάθηκε υπερβαίνει το μέγιστο επιτρεπόμενο (μπορείτε να το αλλάξετε παρακάτω).
...
$_lang['Ooops, stranges cases detected !!'] = 'Οοοπς, παράξενες περιπτώσεις εντοπίστηκαν !!';
$_lang['Operation impossible'] = 'Δεν είναι δυνατή η λειτουργία';
$_lang['Operation impossible.<br />A file with this name already exists.'] = 'Δεν είναι δυνατή η λειτουργία.<br />Υπάρχει ήδη ένα αρχείο με το ίδιο όνομα.';
$_lang['Optional'] = 'Προαιρετικό';
$_lang['Order'] = 'Εντολή ';
$_lang['Orphan questions'] = 'ερωτήσεις που μείναν';
$_lang['Other'] = 'Αλλοr';
$_lang['Others (*)'] = 'Others (*);ανώνυμοι χρήστες, χρήστες που δεν είναι μέλοι αυτού του μαθήματος...';
$_lang['PHP system information'] = 'PHP σύστημα πληροφοριών';
$_lang['Page history'] = 'Ιστορικό σελίδας';
$_lang['Page saved'] = 'Η σελίδα φυλάχτηκε';
...
$_lang['Platform Administration'] = 'Διαχείρηση Πλατφόρμας';
$_lang['Platform Administrator'] = 'Διαχειρηστής Πλατφόρμας';
$_lang['Platform statistics'] = 'Στατιστικά Πλατφόρμας';
$_lang['Please check that your campus URL is reachable from the internet.'] = 'Παρακαλώ έλεγξτε ότι η διεύθυνση Url της πανεπιστημιούπολης μπορεί να ανοικτεί απο το διαδίκτυο.';
$_lang['Please choose a good answer'] = 'Παρακαλώ διαλέξτε μια καλή απάντηση';
$_lang['Please choose one or more good answers'] = 'Παρακαλώ διαλέξτε μια ή περισσότερες καλές απαντήσεις';
$_lang['Please confirm your choice'] = 'Παρακαλώ επιβεβαιώστε την επιλογή σας';
$_lang['Please define at least one blank with brackets [...]'] = 'Παρακαλώ ορίστε τουλάχιστον ένα κενό με αγκύλες [...]';
...
$_lang['Please give the exercise name'] = 'Παρακαλώ δώστε όνομα στην άσκηση';
$_lang['Please give the question'] = 'Παρακαλώ δώστε την ερώτηση';
$_lang['Please type the text'] = 'Παρακαλώ πληκτρολογήστε το κείμενο';
$_lang['Please type your text below'] = 'Παρακαλώ πληκτρολογήστε το κείμενο παρακάτω';
$_lang['Pool of modules'] = 'Σύνολο ενοτήτων';
$_lang['Posted'] = 'Στάλθηκε';
$_lang['Posts'] = 'Αποστολές';
$_lang['Powered by'] = 'Με τη βοήθεια του';
$_lang['Prefix for names of course databases'] = 'Πρόθεμα ονόματα για Βάσεις Δεδομένων μαθήματος';
$_lang['Preview'] = 'Παρουσίαση/προβολή';
$_lang['Preview :'] = 'Προεπισκόπηση : ';
$_lang['Previous'] = 'Προηγουμενου';
$_lang['Previous day'] = 'Προηγούμενης ημέρας';
$_lang['Previous month'] = 'Προηγούμενου μήνα';
$_lang['Previous week'] = 'Προηγούμενης Εβδομάδας';
$_lang['Previous year'] = 'Προηγούμενου έτους';
...
$_lang['Progression of users on all learning paths'] = 'Πρόοδο χρηστών σε όλες τις διαδρομές μάθηαης';
...
$_lang['Published on'] = 'Τοποθετήθηκε την';
$_lang['Question'] = 'Ερώτηση';
$_lang['Question / Answer management'] = 'Διαχείρηση Ερώτησης / Aπάντησης ';
$_lang['Question list of the exercise'] = 'Λίστα ερωτήσεων της άσκησης';
$_lang['Question not found'] = 'Ερώτηση δεν βρέθηκε';
...
$_lang['Read Pages'] = 'Διάβασε σελίδας';
...
$_lang['Register my campus'] = 'Εγγραφή στο campus μου';
...
$_lang['Registration not allowed on the platform'] = ' Η Εγγραφή δεν επιτρέπεται στην πλατφόρμα';
...
$_lang['Remove picture'] = 'Απομάκρυνση εικόνας';
$_lang['Rename'] = 'Μετονομασία';
$_lang['Repair category structure'] = 'Επιδιόρθωση της δομής κατηγοριών';
$_lang['Replace attached file'] = 'Αντικατάσταη επισυναπτόμενου αρχείου';
...
$_lang['Restore course repository'] = 'Επαναφορά πηγης πληροφοριών';
$_lang['Result'] = 'Βαθμολογία';
$_lang['Results of the exercises done'] = 'Αποτελέσματα ασκήσεων έτοιμα';
...
$_lang['SCORM conformant modules are definitively removed from server when deleted in their learning path.'] = 'Ενότητες σύμφωνες με το SCORM θα αφαιρεθούν οριστικά απο το server όταν διαγράψεις τη πορεία μάθησης.';
$_lang['SDK'] = 'SDK';
...
$_lang['Score required'] = 'Βαθμολογία απαιτείται';
$_lang['Scores of exercises done'] = 'Βαθμοί ασκήσεων έτοιμοι';
$_lang['Scorm'] = 'Scorm';
$_lang['Script missing'] = 'Το Script λείπει';
$_lang['Script not in claroline'] = 'Το Script δεν υπάρχει στο claroline';
$_lang['Search'] = 'Έρευνα';
$_lang['Search again (advanced)'] = 'έρευνα εκ νεου (προχωρημένη)';
$_lang['Search course'] = 'Έρευνα μαθήματος';
$_lang['Search from keyword'] = 'Αναζήτηση με λέξη κλειδί';
$_lang['Search on'] = 'Ανοιγμα/ξεκίνημα έρευνας';
$_lang['Search result'] = 'Αποτέλεσμα έρευνας';
$_lang['Search user'] = 'Ερευνα χρήστη';
...
$_lang['Seen'] = 'Παλιά';
$_lang['Select course in'] = 'Επιλογή μαθήματος σε ';
...
$_lang['Start date must be before end date ...'] = 'Η ημερομηνία έναρξησς πρέπει να είναι πριν το τέλος /λήξη της ημερομηνίας ...';
$_lang['Statement'] = 'Δήλωση';
$_lang['Statistics'] = 'Στατιστικά';
$_lang['Statistics by question'] = 'Στατιστική ερωτήσεων';
$_lang['Statistics by user'] = 'Στατιστικη χρηστών';
$_lang['Statistics of course'] = 'Στατιστικά του μαθήματος';
$_lang['Statistics of exercise'] = 'Στατιστικά της άσκησης';
$_lang['Statistics of exercise attempt'] = 'Στατιστική με προσπάθειες άσκησης ';
$_lang['Statistics of question'] = 'Στατιστική ερώτησης';
...
$_lang['Students are allowed to self-register in groups'] = 'Οι φοιτητές επιτρέπονται να εγγραφούν στις ομάδες χρηστών';
$_lang['Subject'] = 'Θέμα';
...
$_lang['Subscribe a class'] = 'Γράψτε μια τάξη';
$_lang['Subscribe to course'] = 'Εγγραφή σε μάθημα';
...
$_lang['Text only (text required, no file)'] = 'Μόνο κειμενο (απαιτείατι κείμενο, όχι αρχείο)';
$_lang['Text with attached file (text required, file optional)'] = 'Κείμενο με επισυναπτόμενο αρχείο (απαιτείατι κείμενο, προαιρετικά αρχείο)';
$_lang['The changes have been carried out correctly'] = 'Οι αλλαγές έχουν πραγματοποιηθεί σωστά';
$_lang['The class has been moved'] = 'Η τάξη έχει μετακινηθεί';
...
$_lang['The following errors were found'] = 'Τα ακόλουθα λάθη βρέθηκαν ';
$_lang['The information has been modified'] = 'Η πληροφορία έχει αλλάξει';
$_lang['The module will still be available in the pool of modules.'] = 'Η ενότητα θα είναι ακόμα διαθέσιμη στην ομάδα των ενοτήτων.';
...
$_lang['The upload has failed. There is not enough space in your directory'] = 'Το ανέβασμα του αρχείου απότυχε. Δεν υπάρχει αρκετός χώρος στον κατάλογο σας';
...
$_lang['The user has been successfully unregistered from course'] = 'O χρήστης έχει καταργήσει επιτυχώς την εγγραφή του απο το μάθημα';
...
$_lang['There is no course matching such criteria'] = 'Δεν υπάρχει μάθημα να ταιριάζει τα κριτήρια αυτά';
$_lang['There is no exercise for the moment'] = 'Αυτή τη στιγμή δεν υπάρχει άσκηση';
$_lang['There is no question for the moment'] = 'Δεν υπάρχει ερώτηση αυτή τη στιγμή';
...
$_lang['There is no tracking for this attempt.'] = 'Δεν υπάρχουν αποτυπώματα για αυτή τη προσπάθειαt.';
...
$_lang['This class still contains some sub classes, delete them first'] = 'Αυτή η τάξη περιέχει ακόμα κάποιες υποκατηγορίες τάξεων, να τις διαγράψετε πρώτα';
$_lang['This course is currently not described'] = 'Το μάθημα δεν διαθέτει περιγραφή';
...
$_lang['This is the main page of the Wiki %s. Click on \'\'\'Edit\'\'\' to modify the content.'] = 'Αυτη είναι η κύρια σελίδα του Wiki %s. Κανε σλικ στο \'\'\'Edit\'\'\' για να τροποποιήσεις το περιεχόμενο.';
...
$_lang['Title'] = 'Tίτλος';
$_lang['Title added :'] = 'Τίτλος προστέθηκε : ';
$_lang['Title of the wiki'] = 'Τίτλος του wiki';
$_lang['To'] = 'στο';
$_lang['To send a message, select groups of users (marked with a * in the front) or single users from the list on the left.'] = 'Για να στείλεις μήνυμα, επέλεξε ομάδες χρηστών (σημειωμένα με ένα * μπροστά)

ή μεμονομένουσ χρήστες απο τη λίστα αριστερά.';
$_lang['Tool'] = 'Εργαλείο';
$_lang['Tool accesses changed'] = 'Εργαλείο/μέσο εισόδου άλλαξε';
...
$_lang['Tracking database'] = 'Στατιστικά της βάσης δεδομένων';
$_lang['Tracking has been disabled by system administrator.'] = 'Η παρακολούθηση (Tracking) έχει  απενεργοποιηθεί (disabled) απο τον διαχειρηστή του συστήματος.';
...
$_lang['URL :'] = 'URL : ';
$_lang['URL link'] = 'URL σύνδεσμος';
$_lang['Unable to add description'] = 'Αδυνατεί να προσθέσει περιγραφή';
$_lang['Unable to add external tool'] = 'Αδυνατεί να προσθέσει εξωτερικό εργαλείο';
$_lang['Unable to add the event to the agenda'] = 'Αδυνατεί να προσθέσει το γεγονός στην Ατζέντα.';
$_lang['Unable to change tool access'] = 'Αδυνατεί να αλλάξει εργαλείο/μέσο  πρόσβασης';
...
$_lang['Unable to delete event from the agenda'] = 'Αδυνατεί να διαγράψει το γεγονός στην Ατζέντα.';
$_lang['Unable to delete external tool'] = 'Αδυνατεί να διαγράψει εξωτερικό εργαλείο';
...
$_lang['Unable to save'] = 'Μη δυνατή η φύλαξη';
$_lang['Unable to update'] = 'Αδύνατο να ενημερωθεί';
$_lang['Unable to update category'] = 'Μη δυνατή η αναβάθμιση της κατηγορίας.';
$_lang['Unable to update external tool'] = 'Αδυνατεί να ενημερώσει εξωτερικό μέσο-εργαλείο';
$_lang['Unable to update forum'] = ' Μη δυνατή η αναβάθμιση της της συζήτησης.';
$_lang['Unable to update the event into the agenda'] = 'Αδυνατεί να ενημερώσει το γεγονός στην Ατζέντα.';
...
$_lang['Unique answer'] = 'Μοναδική απάντηση';
$_lang['Unregister'] = 'Διαγραφή';
$_lang['Unregister all students'] = ' Διαγραψε όλους τους μαθητές';
$_lang['Unregister from class'] = 'Κατάργηση εγγραφής απο τάξη';
...
$_lang['Upload a new file to replace the file'] = 'Ενημερώστε/κατεβάστε καινούριο αρχείο για να αντικαταστήσετε αυτό';
...
$_lang['Use a document'] = 'Χρήση εγγράφου';
$_lang['Use a module of this course'] = 'Χρήση ενότητας αυτού του μαθήματος';
$_lang['Use an exercise'] = 'Χρήση της άσκησης';
$_lang['Use format defined in first line of file'] = 'Χρησιμοποίειστε το format που έχει ορισθεί στη πρώτη σειρά του αρχείου';
$_lang['User'] = 'Χρήστες';
...
$_lang['User has been sucessfully unregistered from the class'] = 'Η εγγραφή του χρήστη απο την τάξη έχει καταργηθεί';
$_lang['User is now course manager'] = 'Ο χρήστης είναι τώρα διαχειρηστής μαθήματος';
...
$_lang['Users not in this group'] = 'Χρήστες όχι σε αυτή την ομάδα';
...
$_lang['View my statistics'] = 'Εμφανιση των στατιστιών μου';
...
$_lang['WARNING: this page is a preview. Your modifications to the wiki has not been saved yet ! To save them do not forget to click on the \'save\' button at the bottom of the page.'] = ' ΠΡΟΕΙΔΟΠΟΙΗΣΗ: αυτή η σελίδα είναι μια προεπισκόπηση.  Οι τροποποιήσεις σας στο wiki δεν έχει φυλαχθεί ακόμα ! Για να τις φυλάξετε μη ξεχάσετε να κάνεε κλικ στο κουμπί \'save\' στο τέλος της σελίδας.';
$_lang['Warning ! This question and its answers are used in several exercises. Would you like to modify them'] = 'Προσοχή ! Αυτή η ερώτηση και οι απαντήσεις της χρησιμοποιούνται σε πολλές ασκήσεις. Θα θέλατε να τις επεξεργαστείτε';
$_lang['Week'] = 'Εβδομάδα';
$_lang['Weighting'] = 'Ζύγισμα';
$_lang['Wiki'] = 'Wiki';
$_lang['Wiki : %s'] = 'Wiki : %s';
$_lang['Wiki : Create new Wiki'] = 'Wiki : Δημιουργησε καινούργιο Wiki';
$_lang['Wiki : Edit properties'] = 'Wiki : Αλλαξετε τις ιδιότητες';
...
$_lang['Wiki of the group'] = 'Το Wiki της ομάδας';
$_lang['Wiki syntax'] = 'Σύνταξη του Wiki ';
$_lang['Work'] = 'Εργασία';
$_lang['Work added'] = 'Εργασία προστέθηκε';
...
$_lang['Wrong operation'] = 'Λάθος λειτουργία';
$_lang['Year'] = 'Έτος';
$_lang['Yes'] = 'Ναι';
...
$_lang['You are not allowed to read this page'] = 'Δεν επιτρέπεται να διαβάσεις αυ΄τη τη σελίδαYou are not allowed to read this page';
$_lang['You are now a member of this group.'] = 'Είσαι τώρα μέλος της ομάδας';
$_lang['You can choose a title an a description for the wiki :'] = ' Μπορείτε να επιλέξετε έναν τίτλο μια περιγραφή για το wiki : ';
$_lang['You can delete these scripts from you server'] = 'Μπορείς να διαγράψεις αυτά τα scripts απο τον εξυπηρέτη σου.';
$_lang['You can not change your own settings!'] = 'Δεν μπορείς να αλλάξεις τις προσωπικές σου ρυθμίσεις!';
$_lang['You can not change your own status'] = 'Δεν μπορείτε να αλλάξετε τη δική σας κατάσταση';
$_lang['You can not move a class in itself!'] = 'Δεν μπορείτε αν μετακινήσετε μια τάξη μεσα στην ίδια!';
$_lang['You can not remove a group forum. You have to remove the group first'] = 'Δεν μπορείται να αφαιρέσετε μια ομάδα συζήτησης. Πρέπει να αφαιρέσετε την ομάδα πρώτα';
...
$_lang['You cannot unsubscribe the last course manager of the course'] = 'Δεν μπορείτε να διαγραψετε  τον τελευταίο διευθυντή σειράς μαθημάτων αυτό του μαθήματος';
$_lang['You didnt choose any file to send, or it is too big'] = 'Δεν διαλέξατε κάποιο αρχείο για να στείλετε,ή είναι πολύ μεγάλο';
$_lang['You have already answered the question'] = 'έχετε ήδη απαντήσει στην ερώτηση';
$_lang['You have just created the course website'] = 'Μόλις δημιουργήσατε το μάθημα';
...
$_lang['You must install these scripts to run correctly claroline'] = 'Πρέπει να εγκαταστήσεις αυτά τα scripts για να τρέχει σωστά το claroline';
$_lang['You must introduce the message text'] = 'Πρέπει να παρουσιάσετε το κείμενο μηνύματος.';
$_lang['You must reach the maximum number of allowed attempts to view these statistics.'] = 'Πρέπει να φτάσεις στο μέγιστο αριθμό προσπαθειών για να δείτε αυτά τα στατιστικά.';
...
$_lang['You\'ve been enroled on the course'] = 'Ολοκληρώθηκε η εγγραφή στο μάθημα';
$_lang['Your best performance'] = 'Η καλύτερη σου εκτέλεση/παρουσίαση';
$_lang['Your browser cannot see frames.'] = 'Ο browser σου δεν αναγνωρίζει τα πλαίσια.';
...
$_lang['Your message has been deleted'] = 'Το Αποστολή διαγράφτηκε.';
$_lang['Your message has been entered'] = 'Το Μήνυμα αποθηκεύτηκε στη βάση.';
$_lang['Your mother is'] = 'Η μητέρα σου είναι';
$_lang['Your new profile has been saved'] = 'Το καινούριο σας προφίλ έχει σωθεί';
...
$_lang['Your request to become a course creator has been sent to platform administrator(s).'] = 'Το αίτημα σου να γίνεις δημιουργός μαθήματος έχει σταλεί στο διαχειρηστή -ες της πλατφόρμας.';
$_lang['Your request to remove your account has been sent'] = 'Το αίτημα σου για να αφαιρεθεί ο λογαριασμός έχει σταλεί';
$_lang['Your time is'] = 'Ο χρόνος σου είναι';
$_lang['Your total score is'] = 'Η συνολική βαθμολογία σου είναι';
...
$_lang['Zlib php extension is required to use this tool. Please contact your platform administrator.'] = 'Επέκταση Zlib php απαιτείται για τη χρήση αυτού του εργαλείου.  Παρακαλώ επικοινωνήστε με τον διαχειρηστή της πλατφόρμας σας.';
...
Confirm ?';
$_lang['blockConfirmBlockingPathMadeInvisible'] = 'Αυτή η πορεία ειναι φραγμένη.
...
$_lang['blockConfirmDeleteScorm'] = 'H διαδρομή μάθησης αποτελεί μέρος ενός  πακέτου SCORM. Αν διαγράψεις αυτή τη διαδρομή -πορεία, όλες οι ενότητες που συμβαδίζουν με το SCORM και όλα τα σχετικά αρχεία θα διαγραφούν απο την πλατφόρμα.Είσαι σίγουρος θέλεις να διαγράψεις τη διαδρομή μάθησης';
$_lang['blockConfirmDeleteStats'] = 'Αν διαγράψεις τα στατιστικά των μαθημάτων (courses)δεν υπάρχει τρόπος να τα ξανααποκτήσεις !<br /><br />Είσαι σίγουρος επιθυμείς να διαγράψεις εντελώς τα στατιστικά ?';
...
$_lang['blockCourseDescriptionQualificationsAndGoals'] = 'Προυποθέσεις και στόχοι';
...
$_lang['blockDefaultLearningPathComment'] = 'Αυτό είναι το εισαγωγικό κείμενο αυτής της διαδρομής μάθησης. Για να το αντικαταστήσετε με δικό σας κείμενο, καντε κλικ παρακάτω στο <b>μετατροπή</b>.';
...
$_lang['blockFeedbackHelp'] = 'Feedback είναι προαιρετικό. Είναι ο σωστός τρόπος αυτής της ανάθεσης (εργασίας). Αν δεν αδειάσει θα φαινέται στους χρήστες σύμφωνα με την διάταξη \'υποβολής του feedback\'.';
...
$_lang['blockIntroCourse'] = 'Βρίσκεσαι στην αρχική σελίδα μαθήματος.<br /><br />Σε αυτή τη σελίδα, μπορείτε :
...
$_lang['blockIntroWork'] = 'Αυτό το εργαλείο σας επιτρέπει να αναθέσετε εργασίες στις οποίες οποιοσδήποτε φοιτητής (σύμφωνα με τις ρυθμίσεις της κάθε ανάθεσης) θα μπορεί να καταχωρήσει καποιο έγγραφο, ή να γράψει κάποιο κείμενο, στη σελίδα του μαθήματος.
...
$_lang['blockModulePoolHelp'] = 'Αυτή η σελίδα ειτρέπει να δείς όλες τις ενότητες διαθέσιμες σε αυτό το μάθημα. <br />
...
$_lang['blockUsedInSeveralPath'] = 'Αυτή η άσκηση χρεισιμοποιείται σε μια ή περισσότερες διαδρομές μάθησης. Εάν τη διαγράψετε δεν θα είναι πλέον διαθέσιμη στη διαδρομή μάθησης.';
...
$_lang['differences between version of %1\$s modified by %2\$s and version of %3\$s modified by %4\$s'] = ' διαφορές μεταξύ της έκδοσης %1$s τροποποιημένη από %2$s και έκδοση %3$s τροποποιημένη απο %4$s';
$_lang['e.g. <em>History of Literature</em>'] = 'π.χ. <i>Ιστορία της Τέχνης</i>';
$_lang['good looking'] = ' όμορφος ';
$_lang['group(s) has (have) been added'] = 'Η ομάδα χρηστών έχει προστεθεί';
$_lang['has been enroled'] = 'έχει εγγραφεί';
...
$_lang['in all exercises'] = 'σε όλες τις ασκήσεις';
$_lang['line'] = 'γραμμή';
$_lang['lines'] = 'γραμμες';
...
$_lang['only in the current exercise'] = 'μόνο στην τρέχουσα άσκηση';
$_lang['previous level'] = 'Προηγούμενου επιπέδου';
$_lang['register'] = 'εγγραφή';
$_lang['rich'] = ' πλούσιος ';
...
$_lang['sampleForumMessage'] = 'Οταν διαγράψετε τη δοκιμαστική περιοχή συζητήσεων, θα διαγραφτεί και το παρόν μήνυμα.';
...
$_lang['sampleQuizAnswer2'] = 'Παραδοχή των δικών σας σφαλμάτων ώστε να ενθαρρύνετε το συνομιλητή σας να κάνει το ίδιο.';
...
$_lang['this password is too simple. Use a password like this <code>%passpruposed</code>'] = 'Το συνθηματικό σας είναι πολύ απλό. Χρησιμοποιήστε ένα συνθηματικό σαν και αυτό';
$_lang['to'] = 'σε';
$_lang['uncompress zipped (.zip) file on the server'] = 'αποσυμπίεση του αρχείο (.zip) στον εξυπηρέτη';
$_lang['use brackets [...] to define one or more blanks'] = 'Χρησιμοποίειστε αγκύλες [...] για να ορίσετε ένα ή περισσότερα κενά';
$_lang['warning : Installation cannot find the description of the learning path and has set a default comment.  You should change it'] = 'προειδοποίηση : Η εγκατάσταση δε μπορεί να βρεί τη περιγραφή της διαδρομής μάθησης και έχει ορίσει σχόλιο/παρατήρηση.  Θα πρέπει να το αλλάξεις';
$_lang['warning : Installation cannot find the name of the learning path and has set a default name.  You should change it.'] = 'προειδοποίηση : Η εγκατάσταση δε μπορεί να βρεί το όνομα της διαδρομής μάθησης και έχει ορίσει καποιο όνομα .  Θα πρέπει να το αλλάξεις.';
?>