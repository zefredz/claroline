...
$langCourseTitle = "Τιτλος μαθήματος";
...
$langExplanation = "Η σελίδα πρέπει να είναι σε μορφή HTML (π.χ.\"my_page.ht\"). Θα δημιουργηθεί σύνδεσμος στην αρχική σελίδα προς αυτήν. Αν θέλετε να στείλετε αρχεία που δεν είναι σε μορφή HTML (π.χ. PDF, Word, Power Point, Video, κ.λπ.) χρησιμοποιήστε το <a href=../document/document.php>Documents tool</a>";
$langFac = "Σχολή / Τμήμα";
$langFaculty = "Τμήμα";
...
$l_pmposted = "Στάλθηκε απάντηση, πιέστε <a href\"viewpmsg.ph\">εδώ</a> για να δείτε τα προσωπικά σας μηνύματα";
$l_posted = "Στάλθηκε";
$l_poster = "Αποστολέας";
$l_posts = "Αποστολές";
$l_profile = "Προφίλ";
