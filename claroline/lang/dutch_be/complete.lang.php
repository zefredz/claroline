...
$_lang['Fill in the text area to motivate your request and then submit the form to send it to platform administrators'] = 'Gebruik deze zone om uw motivatie uit te leggen en dien uw vraag in. Een e-mail zal naar de administrators van het platform verzonden worden.';
...
$_lang['Teachers are allowed to register whole classes to their courses'] = 'Docent kan een bestaande klas in zijn cursus toevoegen';
