...
$langAddNewHeading = "Agregar nuevo encabezado";
...
$langAlreadyEnrolled = "Ya se encuentra inscrito";
$langAlt = "Array";
$langAltMakeBlocking = "Bloquearlo";
$langAltMakeInvisible = "Hacerlo invisible";
$langAltMakeNotBlocking = "No bloquearlo";
$langAltMakeVisible = "Hacerlo visible";
$langAltMove = "Mover";
$langAltMoveDown = "Ordenar hacia abajo";
...
$langArchiveCourse = "Backup de Curso";
$langArchiveCourse = "Backup del Curso";
$langArchiveLocation = "Direcci&oacute;n del archivo";
$langArchiveLocation = "Localizaci&oacute;n del archivo";
$langArchiveName = "Nombre de archivo";
...
$langAreYouSureToDelete = "¿Está seguro de querer eliminarlo? ";
...
$langAreYouSureToDeleteScormModule = "Está seguro de que desea eliminar este módulo de conformación SCORM?.El módulo no estará disponible nunca más en la plataforma.";
...
$langBackToList = "Regresar a la lista";
...
$langBackToUsersList = "Regresar a la lista de usuarios";
$langBackup = "Backup";
...
$langBUAnnounceInMainBase = "Backup de los datos de anuncios en la base de datos principal para";
...
$langBuildTheCompressedFile = "2° - Creaci&oacute;n de un archivo de backup";
$langBuildTheCompressedFile = "Creaci&oacute;n de backups de los archivos";
$langBUUsersInMainBase = "Backup de los datos de los usuarios en la base de datos principal para";
...
$langCategories = "Categoría de cursos";
...
$langCheckDatabase = "Revisar base de datos";
...
<p>El enlace a 'Inscripci&oacute;n' (si existe) est&aacute; en la p&oacute;gina
...
$langCopyOnServerBackupRepository = "poner una copia del archivo en el espacio Archivos de la plataforma";
...
$langCourse = "Curso";
$langCourse = "El curso ";
$langCourseAccess = "Acceso a cursos";
...
$langCourseAdministratorOnly = "S&oacute;lo administrador del curso";
...
$langCourseDescription = "Descripci&oacute;n del Curso";
...
$langCreate = "crear";
$langCreateANewCourseNow = "crear un nuevo curso a partir de este archivo";
$langCreateAnotherUser = "Crear otro nuevo usuario";
$langCreateClaroTables = "Crear tabla de la base de datos principal";
...
$langCreateMissingDirectories = "Creaci&oacute;n de los directorios perdidos";
...
$langDefineHeadings = "Definir cabeceras";
...
<p>Los documentos se presentan en pantalla por orden alfab&eacute;tico.<br>
  <b>Consejos:</b> si usted desea que los documentos se ordenen de 
  manera diferente, usted puede hacer que se precedan de un n&uacute;mero, a partir de este momento se ordenar&aacute;n seg&uacute;n esta base. </p>
<p>Usted puede:</p>
...
<ul>
  ...
  <li>Haga click en el bot&oacute;n  <img src=../document/../document/img/comment.gif width=20 height=20> 
	...
	<p>Si usted desea suprimir un comentario, haga click en el bot&oacute;n <img src=../document/../document/img/comment.gif width=20 height=20>, 
...
<ul>
  ...
  <li>lecci&oacute;n m&uacute;ltiple (Respuestas m&uacute;ltiples )</li>
  <li>Relacionar</li>
...
<p>Para crear un ejercicio, pulse sobre el enlace &quot;Ejercicio Nuevo&quot;.<br><br>
...
<ul>
  <li>Preguntas en una s&oacute;la p&aacute;gina</li>
...
Una vez que el texto se ha escrito y definido los huecos, puede a&ntilde;adir un comentario que verá el estudiante
...
asincr&oacute;nica por escrito. A diferencia del email, el foro coloca la
discusi&oacute;n en un espacio p&uacute;blico o semi-p&uacute;blico.
 ...
 s&oacute;lamente tienen necesidad de un simple navegador web (Netscape, Explorer...),
  no se necesita tener un cliente de email (Eudora, Outlook...).</P>
...
$langForum = "Foro";
$langForum = "Foros";
$langForumContent = "Contenido del Foro";
$langForumGroup = "Foro del grupo";
$langForumModified = "El foro ha sido modificado";
$langForums = "Foros";
$langForumStructure = "Nombre de los foros y categor&iacute;as";
$langForumType = "Tipo de Foro";
$langFrom = "De";
$langFtpFileTips = "Si el fichero est&aacute; en otro ordenador y es accessible por ftp";
...
$langGroupForum = "Foro";
$langGroupForumContent = "Contenido de los foros de los grupos";
$langGroupForumStructure = "Nombre de los foros de los grupos y sus categor&iacute;as ";
...
$langGroupsProperties = "Caracter&iacute;sticas de los Grupos";
...
$langGroupWork = "Trabajos de grupo";
$langGroupWorkContent = "Contenidos de los Trabajos en grupo";
$langGroupWorkStructure = "Anuncios de los trabajos en grupo";
...
$langHomeContent = "La mayor&iacute;a de las rúbricas de iCampus est&aacute;n ya rellenadas con un corto texto o por un enlace dados por defecto, o por un ejemplo. A usted le corresponde el modificarlos.</p><p>As&iacute aparece un texto corto, bien a la vista, en la cabecera de vuestra web.  'Este es el texto de introducci&oacute;n de vuestra web...' Modif&iacute;quelo y aproveche para describir su curso, vuestros objectivos, vuestros dispositivos. Es importante para la correcta presentaci&oacute;n de vuestro trabajo.</p><p>En el momento de la creaci&oacute;n de vuestra web, numerosas herramientas (Agenda, documentos, ejercicios...) se activan para usted por defecto. Es aconsejable desactivar aquellas que usted no utilice con el fin de no hacer perder el tiempo a sus usuarios o a sus visitantes.</p><p>Usted puede tambi&eacute;n a&ntilde;adir p&aacute;ginas a la p&aacute;gina principal. Utilice la funci&oacute;n 'a&ntilde;adir p&aacute;gina' para a&ntilde;adir una p&aacute;gina y enviarla al servidor. Si por el contrario usted quiere enlazar con una p&aacute;gina o web ya existente, utilice la funci&oacute;n 'Enlace a la web'. Las p&aacute;ginas y enlaces que usted a&ntilde;ada a la p&aacute;gina principal pueden ser desactivadas y luego suprimidas, a diferencia de las herramientas existentes por defecto, las cuales pueden ser desactivadas, pero no suprimidas.</p><p>Tambi&eacute;n le corresponde a usted el decidir si su curso debe aparecer en la lista de los cursos. Es aconsejable que un curso en fase de pruebas o 'en obras' no aparezca en la lista (ver la funci&oacute;n 'Modificar informaci&oacute;n sobre el curso') y permanezca privado sin posibilidad de inscribirse en el durante &eacute;l tiempo de su creaci&oacute;n.</p>";
$langHomePageTextZone = "Zonas de texto en la pagina de principal";
$langHomePageTextZone = "Zona de texto de la página principal";
$langHour = "Hora";
...
$langLast30Days = "Los últimos 30 días";
$langLast31days = "En los &uacute;ltimos 31 d&iacute;as";
$langLast7Days = "Los último 7 días";
$langLast7Days = "En los &uacute;ltimos 7 d&iacute;as";
...
$langLineNumber = "N&uacute;mero de l&iacute;neas";
...
$langLinksToClaroProjectSite = "Enlace a la pagina wen del proyecto";
$langLinksToClaroProjectSite = "Enlace hacia el sitio web del proyecto";
...
$langModifInfo = "Modificar las informaciones del curso";
$langModifOneProfile = "Configuración de usuario";
...
$langNbStudents = "Número de alumnos";
$langNever = "Nunca";
...
$langSaveSubscription = "Usuarios registrados en el curso y grupos ";
...
$langSearchAUser = "Buscar a usuarios";
...
$langShowAllProcessDuringTheWork = "¿Mostrar todo el proceso?";
...
$langStatOf = "Estadisticas def ";
$langStatOf = "Estadisticas de ";
$langStatOf = "Estadisticas de  ";
...
$langStrangeCases = "Casos extra&ntilde;os";
...
$langSysInfo = "Acerca del status del sistema";
$langSysInfo = "Información acerca del status del sistema";
$langTableStructureDontKnow = "Estructura de esta tabla desconocida";
$langTake = "tomar";
...
$langTooBig = "No has seleccionado el archivo a enviar, o es demasiado grande";
...
$langTraduction = "Herramienta de traducción";
...
$langUpgradeAll = "Actualizar la plataforma completa.";
...
<p>Los derechos de administraci&oacute;n, por el contrario, se refieren al sistema inform&aacute;tico. Actualmente, se puede escoger entre <b>todos</b> (modificar todo, suprimir todo, a&ntilde;adir todo) y <b>ninguno</b> (a parte del derecho de visitar la web, de publicar mensajes en el foro y trabajos via la p&aacute;gina 'trabajos').</P>
<p>Para permitir a un co-titular, un asistente, un tutor o quien sea el co-administrar la web con usted, debe inscribirlo previamente en su curso o asegurarse que ya est&aacute; inscrito y despu&eacute;s modificar los derechos que le corresponden haciendo click sobre 'modificar' debajo 'derechos de administraci&oacute;.' y luego marcando 'todos'.</P><hr>
<b>Co-titulares</b>
<p>Para hacer que figure el nombre de un co-titular en la cabecera de su curso, utilice la p&aacute;gina 'Modificar la informaci&oacute;n sobre el curso' (en las herramientas de color naranja). Esta modificaci&oacute;n de la cabecera del curso no inscribe autom&aacute;ticamente a este co-titular como usuario del curso. Se trata de dos acciones distintas.</p><hr>
...
$langVersionClaro = "Versión de Claroline usada en tiempo de archivo";
$langVersionDb = "Versi&oacute;n de la base de datos";
$langView = "Ver";
...
$langWhatDoAfterBackup = "Tareas a efectuar despu&eacute;s del backup";
$langWikiContent = "Contenido Wiki";
$langWork = "Trabajos";
$langWorkAuthors = "Autores";
$langWorkContent = "Contenido de los trabajos";
$langWorksDetails = "Trabajos subidos por el estudiante en el nombre de 'Autores'";
$langWorkStructure = "T&iacute;tulos de los trabajos";
...
$lang_categories = "Categorías";
$lang_click_here = "click here";
$lang_config_AdministrationTools = "Herramienta de administración";
$lang_config_ButtonSend = "Cambiar la configuración";
...
$lang_config_ErrorConnectMySQL = "El login o el password del servidor debe estar incorrecto ya que es imposible conectarse a la base de datos";
$lang_config_ErrorEmailAdmin = "El email del administrador está malo, por favor corríjalo";
$lang_config_ErrorEmailManager = "El email del jefe de carrera está malo, por favor corríjalo";
$lang_config_ErrorHostEmpty = "El nombre del host no puede ir vacío!";
$lang_config_ErrorLoginBDEmpty = "El login de la base de datos no puede estar vacía!";
$lang_config_ErrorOpenFile = "Error al tratar de habrir el archivo config.php";
$lang_config_ErrorRootWeb = "La pagina web principal (rootweb) está mala, por favor corríjalo";
$lang_config_ErrorRootWebEmpty = "La página principal(root web) no puede estar vacía!";
$lang_config_ErrorURLInstitution = "La URL de la institución está malo, por favor corríjalo";
$lang_config_Info = "(*) Valores requerido";
$lang_config_langage = "Lenguaje :";
$lang_config_name = "Nombre : ";
$lang_config_NoAdmin = "usted no a ingresado a la plataforma como administrador";
$lang_config_phone = "Telefono : ";
$lang_config_rootWeb = "Página web principal(Root Web)";
$lang_config_siteName = "Nombre del sitio : ";
$lang_config_TitleAdministrator = "Administrador : ";
$lang_config_TitleBD = "Base de datos : ";
...
$lang_config_urlAppend = "Añadir URL ";
...
$lang_EditFile_NoAdmin = "No ho ingresado como admin";
...
$lang_faculty_EditCat = "Editar las categorias";
...
$lang_faculty_No = "No";
$lang_faculty_NoAdmin = "Debe ingresar como administrador";
...
$lang_SearchUser_SearchUser = "Buscar un usuario";
...
$l_nopmsgs = "No tiene Mensajes Privados.";
...
$l_nouser = "El Nombre de Usuario no existe.";
...
$l_publicmail = "Permitir a otros usuarios ver mi Direcci&oacute;n de correo electr&oacute;nico";
$l_quotemsg = "[quote]\nEl %s1, %s2 ha escrito:\n%s3\n[/quote]";
...
$l_url = "URL";
$l_userdisallowed = "El Nombre de Usuario elegido no puede ser autorizado por el administrador. Por favor regrese y vuelva a intentarlo.";
...
$l_usertaken = "El Nombre de Usuario que ha elegido, ya existe.";
