...
*/
   ...
   $langModuleAdmin = "Administrar módulo";
   $langModuleHelpDocument = "Usted puede escogió un documento que sustituirá por el actual.";
//assent
   $langAsset = "Activo";
   $langStartAsset = "Comenzar activo";

   $langRename = "Renombrar";
   $langRemoveFromLPShort = "Remover";
   $langRemoveFromLPLong = "Remover de este seguimiento de aprendizaje";
   ...
   $langModifyCommentModuleName="Insertar un nuevo comentario para";
   ...
   $langNewModuleName = "Nuevo  nombre de módulo y tipo de contenido: ";
   $langButtonImport= "Importar";
   $langAddComment = "Agregar un comentario";
   $langAddAddedComment = "Agregar un comentario agregado";
   $langChangeOrder = "Cambiar el orden";

   // lang for learningPathAdmin
   $langNewModule = "Crear un módulo vacío";
...
//si hay una mejor traduccion de esto , mejor:  SCORM conformant modules are definitively removed from server when deleted in their learning path. 
 ...
 $langAreYouSureToRemoveSCORM = "La conformación SCORM de los módulos serán removidos definitivamente del servidor cuando estos sean eliminados del seguimiento de aprendizaje.";
   ...
   // success messages
   $langOKNewPath  = "Creación exitosa";
   ...
   $langClose ="Cerrar";
   $langAvailable = "modulos(s) disponible(s)";
   ...
   $langExAlreadyUsedInModule = "Este ejercicio está siendo utilizado en este módulo";
   ...
   $langModuleHelpExercise = "usted puede cambiar los requisitos mínimos de un estudiante para pasar este módulo.";
   $langRawHasBeenChanged = "Los requisitos mínimos para pasar han sido cambiados";
   $langExerciseInModule = "Ejercicios en módulos";
   $langModifyAll = "En todos los  seguimiento de aprendizaje";
   $langModifyThis = "Solo en este seguimiento de aprendizaje";
   $langUsedInSeveralModules = "Advertencia ! Este módulo es usado en varios ejercicios.¿Le gustaría modificarlo?";

   $langModuleModified = "Este módulo ha sido modificado.";
   ...
   $langAlt['handmade'] = "Hecho a mano";
   $langAlt['exercise'] = "Ejercicio";
