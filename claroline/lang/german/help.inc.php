...
$langHomeContent="Zur Vereinfachung sind die Claroline Werkzeuge nicht leer. Es gibt ein kleines Beispiel zu jedem Werkzeug, um die Funktionsweise zu verdeutlichen. Sie können die Beispiele ändern oder löschen.</p><p>Auf der Homepage der Seminarwebsite befindet sich ein kurzer Einführungstext, mit folgendem Text 'Dies ist der Einführungstext Ihres Kurses. Ersetzen Sie ihn mit Ihrem eigenen Text. Klicken Sie unten auf ändern.' Auf Ändern klicken, verändern und bestätigen. So einfach ist das. Jedes Werkzeug hat die gleiche Logik: hinzufügen, löschen, ändern.</p><p>Zu Beginn der Websiteerstellung sind die meisten Werkzeuge aktiv. Sie können diejenigen deaktivieren, die Sie nicht benötigen. Sie müssen auf 'deactivate' klicken. Es wird dann in den grauen unteren Bereich Ihrer Homepage verschoben. Es ist dann nicht mehr für Ihre Teilnehmer/innen sichtbar, aber Sie können es jederzeit reaktivieren.</p>
<p>Sie können auch eigene Seiten zu Ihrer Homepage hinzufügen.
Diese Seiten müssen in HTML geschrieben sein (dazu können Sie eine beliebeige Textverarbeitung oder andere Software zu Webseitenerzeugung nutzen). Benutzen Sie 'Seite Hochladen und zur Homepage verknüpfen' um Ihre Seite zum Server zu senden. Der Standard-Header Ihrer Webseite wird automatisch mit dem neuen Dokument verbunden. So können Sie sich auf den Inhalt konzentrieren. Wenn Sie von Ihrer Homepage auf bereits bestehende Webseiten oderr Seiten im Web verknüpfen möchten (auch innerhalb Ihrer eigenen Seite), benutzen Sie 'Verknüpfung auf Homepage hinzufügen'. Die Seiten, die Sie hinzugefügt haben können deaktivert und anschließend gelöscht werden. Die Standardwerkzeuge können indes nur deaktiviert aber nicht gelöscht werden.</p>
<p>Wenn Ihr Website fertiggestellt ist, wählen Sie 'Seminarinformation ändern' aus und entscheiden Sie isch wie man auf Ihren Kurs zugreifen kann. Per Voreinstellung ist der Kurs nicht sichtbar (da Sie zur Zeit damit arbeiten).</p>";
