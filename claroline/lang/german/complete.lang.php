...
$langAddAdminInApache = "Einen Adminstrator hinzufügen";
...
$langAdministrationTools = "Tool - Administration";
$langAdministrationTools = "Administration";
$langAdministrationTools = "Verwaltungstools";
$langAdministrationTools = "Administrationstools";
$langAdministrationTools = "Admin-Tool";
...
$langAlt = "Array";
$langAltMakeBlocking = "Sperren";
$langAltMakeInvisible = "Unsichtbar machen";
$langAltMakeNotBlocking = "Freischalten";
$langAltMakeVisible = "Sichtbar machen";
$langAltMove = "Verschieben";
$langAltMoveDown = "Nach unten schieben";
...
$langAreYouSureToDelete = "sind Sie sicher, das Sie das löschen wollen: ";
$langAreYouSureToDelete = "Sind Sie sicher, dass Sie das löschen wollen : ";
$langAreYouSureToDelete = "Wollen Sie wirklich löschen";
$langAreYouSureToDelete = "Sind Sie sich das Sie löschen wollen? ";
...
$langAreYouSureToDeleteScormModule = "Sind Sie sicher, dass Sie dieses SCROM-konforme Modul wirklich löschen möchten? Das Modul wird anschließend nicht mehr im System zur Verfügung stehen.";
$langAreYouSureToRemove = "Sind Sie sicher, das die folgenden Module aus dem Lernpfad löschen möchten : ";
...
$langCategories = "Kurs Kategorie(n)";
...
<p>Der Link zur Registrierung ist auf der Homepage des Systems (oben rechts).</p><b>Login</b>
<p>Bei Ihren nächsten Besuchen loggen Sie sich ein, mit Login/Passwort und bestätigen Sie den Zugriff auf Ihre(n) Kurs(e). Die URL der Seite ist";
...
$langCourseDelete = "Der Kurs wirde erfolgreich gelöscht";
...
$langCourseTitle = "Titel des Kurs";
...
$langCreateCourses = "Kurse erstellen";
...
$langDescription = "Beschreibung des Dokuments/der Datei";
$langDescriptionCours = "Kursbeschreibung";
$langDetail = "Detail";
$langDetails = "Details";
$langDetailView = "Aufgeliedert nach";
$langDevTools = "Devel Tools";
$langDiffTranslation = "Übersetzungen vergleichen";
...
$langEnrollAsStudent = "Als Lerner eintragen";
$langEnrollAsStudent = "Als Lerner einschreiben";
$langEnrollAsTeacher = "Als Dozent/Tutor einschreiben";
$langEnrollToNewCourse = "In neuen Kurs eintragen";
$langEnrollUser = "Einen Teilnehmer einschreiben";
$langEnter = "Eingabe";
$langEnter = "Eintreten";
$langEnter = "einloggen";
$langEnter2passToChange = "Geben Sie das neue Passwort zwei mal ein oder alssen Sie die Felder leer, um das Passwort beizubehalten";
...
$langForContent = "Ein Forum ist ein schriftliches, asynchrones Diskussionswerkzeug. Wo Email nur einen Eins-zu-Eins Dialog ermöglicht, bieten Foren die Gelegenheit öffentliche bzw. halböffentliche Diskussionen zu führen.</p><p>Die Lerner benötigen nur ihren Browser, um die Foren zu benutzen.</P>
...
$langHomePageTextZone = "Startseitentextbereich";
$langHour = "Uhr";
$langHour = "Stunde";
...
$langIntroWork = "Über diese Seite können Lerner oder Lern-Gruppen Dateien/Dokumente in die Kurs-Webseite hochladen
<br>Bitte HTML-Detaien nur hochladen, wenn sie keine Bilder/Grafiken enthalten<br><br>
Wenn Sie dieses Tool vorstellen oder Ihren Lernern weitere Hinweise geben möchten, klicken Sie auf den Button unterhalb.<br>";
...
$langLinkSite = "Einen Link zu dieser Seite auf der Homepage einfügen";
$langLinkSite = "Einen Website verknüpfen / Link erstellen";
$langLinksToClaroProjectSite = "Links zur Projekt-Website";
$langLinksToClaroProjectSite = "Link zu Projekt-Webseite";
...
$langModifOneProfile = "Benutzer Einstellungen";
$langModifProfile = "Mein Profil bearbeiten";
$langModifUserCourseSettings = "Kurs Einstellungen des Benutzers";
...
$langModule = "Lernmodule";
$langModule = "Modul";
$langModuleMoved = "Modul wurde erfolgreich verschoben";
$langModuleOfMyCourse = "Ein Modul dieses Kurses verwenden";
$langModules = "Module";
...
$langMove = "Hauptkategorie ändern";
...
$langNoCourseResult = "Es gibt keinen Kurs der diesen Kriterien entspricht";
...
$langNoMoreModuleToAdd = "Alle Module dieses Kurses werden bereits in diesem Lernpfad verwendet.";
...
$langNumGroupStudent = "Teamgröße in welche sich eingeschriebene Lerner innerhalb des Kurses eintragen können";
$langOfficialCode = "Kürzel für dien Administration";
...
$langPrivateOnly = "Nur geschlossene Kurse";
...
$langPublicOnly = "Nur öffentliche Kurse";
...
$langQuestion = "Frage";
$langQuestionAnswers = "Antworten die Fragen";
...
$langRegisterTheNewUser = "Diesen Benutzer für einen Kurs registrieren";
$langRegisterUser = "In einen neuen Kurs eintragen";
...
$langRemoveFromLPShort = "Entfernen";
...
$langRestoreCourse = "Kurs bearbeiten";
...
$langSave = "speichen";
$langSave = "Speichern";
$langSaveChange = "Änderungen speichern";
...
$langSearchCourse = "Kurs suchen";
$langSearchCourseAdvanced = "Erweiterte Kurs-Suche";
$langSearchOn = "Suche nach";
$langSearchUser = "Benutzer suchen";
$langSearchUserAdvanced = "Erweiterte Benutzer-Suche";
$langSeeAgenda = "Meine Agenda ansehen";
...
$langSize_of_selected_courses = "Größe der gewählten Kurse";
...
$langStatOf = "Statistik von ";
$langStatOf = "Statistik für ";
...
$langTraduction = "Übersetzungs-Tool";
$langTrafficDetails = "Details Traffic";
$langTrue = "Wahr";
$langTutor = "Dozent/Tutor";
...
$langUserContent = "<b>Rollen</b><p>Rollen haben keine computerbezogenen Funktionen. Dadurch werden keine Rechte für das Betriebssystem vergeben. Sie zeigen nur an, wer was machen darf. Sie können die Rollen verändern, wenn Sie auf 'ändern' unter 'Rolle' klicken, anschließend können Sie einen beliebigen Text eintragen: Dozent, Tutor, Coach, Assistent, Lerner, Besucher, Experte...</P><hr>
...
<p>Um z.B. einen Vertreter die Seite verändern zu lassen, müssen Sie ihn im Kurs registrieren oder sicher stellen, daß er bereits registriert ist, anschließend wählen Sie 'ändern' unter 'Admin Rechte', dann klicken Sie 'all', abschließend 'Ok'.</P><hr>
<b>Mitverantwortlicher</b>
<p>Um im Kopf eines Kurses den Namen eines Mitverantwortlichen zu nennen, benutzen Sie 'Kursinformation ändern' (orangfarbene Werkzeuge). Diese Änderung registriert Ihren Mitverantwortlichen nicht als Benutzer des Kurses. Das Feld 'Tutor/Dozentn' ist völlig unabhängig von der Teilnehmerliste.</p><hr>
<b>Benutzr hinzufügen</b>
...
$langUserCourseList = "Benutzer's Kurs Übersicht";
$langUserCreated = "Der neue Benutzer wurde erfolgreich angelegt";
$langUserDelete = "Der Benutzer wurde erfolgreich gelöscht";
$langUserFree = "Dieser Benutzername ist bereits vergeben. Gehen Sie zurück und wählen Sie einen anderen.";
$langUserid = "Benutzer ID";
$langUserIsNowCourseManager = "Der Teilnehmer ist nun Kurs-Verantwortlicher";
$langUserIsNowStudent = "Der Benutzer ist nun Lerner in diesem Kurs";
...
$langUserNoCourseToDisplay = "Kein Kurs gefunden";
...
$langUserNumber = "Nr.";
$langUserOneByOneExplanation = "Er erhält eine Bestätigung durch E-Mail mit Login-Daten und Passwort.";
$langUsers = "Benutzer";
$langUsers = "Users";
...
$langUserUnregisteredFromCourse = "Der Teilnehmer wurde aus dem Kurs ausgetragen";
$langUserUnsubscribed = "Der Benutzer wurde erfolgreich ausgetragen";
$langUserUnsubscribedFromCourse = "Der Benutzer wurde erfolgreich aus dem Kurs ausgetragen";
...
$langVersionClaro = "Claroline Version bei der Archivierung";
$langVersionDb = "Version der Datenbank bei  der Archivierung";
$langView = "Ansehen";
...
$langYourTotalScore = "Gesamtpunktzahl";
...
$lang_config_AdministrationTools = "Administrations-Tools";
$lang_config_ButtonSend = "Dieses Konfiguration verändern";
...
$lang_config_dbPass = "Datenbank-Passwort :";
$lang_config_email = "Email : ";
$lang_config_ErrorConnectMySQL = "Der Server, Username oder das Paswort sind nicht korrekt.";
$lang_config_ErrorEmailAdmin = "Die Email-Adresse des Administrators ist falsch !";
$lang_config_ErrorEmailManager = "Die Email des Bildungsverantwortlichen ist falsch !";
...
$lang_config_urlAppend = "zugehörige URL";
...
$lang_faculty_CanHaveCatCourse = "Darf Kurse beinhalten : ";
$lang_faculty_CatHaveCat = "Diese Kategorie beinhaltet noch Unterkategorien. Bitte löschen Sie diese !";
$lang_faculty_CatHaveCourses = "Diese Katgeorie beinhaltet noch Kurse. Löschen nicht möglich!";
...
$lang_faculty_imgEdit = "bearbeiten";
$lang_faculty_imgMove = "verschieben";
...
$lang_no_access_here = "Kein Zutritt";
$lang_no_access_here = "Keinen Zugriff ";
$lang_no_course_available_fitting_this_keyword = "Kein Kurs verfügbar der zum Schlagwort passt";
...
$lang_remove_course_from_your_personnal_course_list = "Kurs aus Ihrer perönlichen Kurs-Übersicht entfernen";
$lang_search = "Suche";
...
$lang_this_course_is_protected = "Dieser Kurs ist zugriffsbeschränkt";
$lang_unsubscribe = "austragen";
$lang_user_has_been_enrolled_to_the_course = "Der Benutzer hat sich in den Kurs eingeschrieben";
$lang_your_enrollment_to_the_course_has_been_removed = "Ihre Kurseinschreibung wurde entfernt";
$lang_your_user_profile_doesnt_seem_to_be_enrolled_to_this_course = "Ihr Teilnehmerprofil scheint nicht in diesen Kurs eingetragen zu sein";
$lang_you_had_request = "You ask";
$lang_you_have_been_enrolled_to_the_course = "Sie wurden in den Kurs eingeschrieben";
$l_aim = "AIM";
$l_author = "Autor";
$l_author = "Author";
...
$l_deleted = "Ihr Beitrag wurde gel&ouml;scht.";
...
$l_emptymsg = "Sie m&uuml;ssen eine Nachricht eingeben. Sie k&ouml;nnen keine leere Nachricht absenden.";
...
$l_nopmsgs = "Sie haben keine Private Nachrichten.";
...
$l_noposts = "No Posts";
$l_norecipient = "Sie m&uuml;ssen den Benutzernamen des Empf&auml;ngers Ihrer Nachricht eingeben.";
...
$l_nouser = "Dieser Benutzername existiert nicht.";
...
$l_returntopic = ", um zur Themenauflistung des Forums zur&uuml;ckzukehren.";
...
$l_sortby = "Sort by";
$l_stored = "Ihre Nachricht ist in der Datenbank gespeichert worden.";
...
$l_url = "URL";
$l_userdisallowed = "Der von Ihnen gew&auml;hlte Benutzername ist vom Administrator gesperrt worden. Bitte gehen Sie zur&uuml;ck und versuchen es noch einmal.";
...
$l_usertaken = "Der von Ihnen gew&auml;hlte Benutzername ist leider bereits vergeben.";
$l_usertaken = "The Username you picked has been taken.";
$l_viewforum = "Forum ansehen";
$l_viewforum = "View Forum";
$l_viewmsg = "um Ihre Nachricht anzusehen.";
