...
$_lang['<strong>Deleted</strong><p>Your campus registration has been desactivated, contact us (see our website) if you think this is an error.</p>'] = '<strong>Supprimé</strong><p>Votre campus a été supprimé de la page \'Worldwide\' de Claroline.net, contactez nous si vous pensez que c\'est une erreur.</p>';
...
$_lang['Access to campus'] = 'Acc&egrave;s au campus';
$_lang['Access to courses'] = 'Acc&egrave;s aux espaces';
$_lang['Access to tools'] = 'Acc&egrave;s aux outils';
$_lang['Accounts with same <i>Email</i>'] = 'Comptes avec le même <i>Email</i>';
$_lang['Accounts with same <i>User name</i>'] = 'Comptes avec le même <i>nom d\'utilisateur</i>';
$_lang['Accounts with same <i>User name</i> AND same <i>Password</i>'] = 'Comptes avec le même <i>nom d\'utilisateur</i> et <i>mot de passe</i>';
$_lang['Action'] = 'Action';
...
$_lang['Add a user list in course'] = 'Ajouter une liste d\'utilisateurs à l&acute;espace';
...
$_lang['Allowed : do not record usernames in tracking, anonymous users can do the exercise.'] = 'Autoriser : les noms des utilisateurs ne sont pas enregistrés dans les statistiques, les utilisateurs anonymes peuvent faire l&acute;exercice.';
$_lang['Already browsed'] = 'Déjà visité';
$_lang['Already enroled'] = 'Déjà inscrit';
$_lang['Among'] = 'parmi';
$_lang['An error occured.  Learning Path import failed.'] = 'Une erreur est survenue.  l&acute;importation du parcours pédagogique a échoué.';
...
$_lang['Announcement has been added'] = 'l&acute;annonce a été ajoutée';
$_lang['Announcement has been deleted'] = 'l&acute;annonce a été effacée';
$_lang['Announcement has been modified'] = 'l&acute;annonce a été modifiée';
...
$_lang['Asset not found :'] = 'Ressource non trouvée : ';
...
$_lang['Back to the editor'] = 'Retourner à l&acute;éditeur';
$_lang['Back to user list'] = 'Retourner à liste des utilisateurs';
$_lang['Back to user settings'] = 'Retour aux paramètres de l&acute;utilisateur';
...
$_lang['Cannot find secondary initialisation file in the package.<br /> File not found :'] = 'Un fichier XML secondaire d\'initialisation n\'a pas pu être trouvé.<br /> Fichier manquant : ';
...
$_lang['Changes have been applied to the user settings'] = 'Changements sauvés pour les paramètres de l&acute;utilisateur';
...
$_lang['Click on the month name for more details'] = 'Cliquez sur le nom du mois pour plus de d&eacute;tails';
$_lang['Close'] = 'Fermer';
$_lang['Close window'] = 'Fermer la fenêtre';
$_lang['Comment'] = 'Commentaire';
$_lang['Comment modified'] = 'commentaire modifi&eacute;';
...
$_lang['Course Repository'] = 'Dossier de l&acute;espace';
$_lang['Course access'] = 'Accès à l&acute;espace';
$_lang['Course administrator only'] = 'Réservé à l&acute;administrateur de l&acute;espace';
$_lang['Course code'] = 'Code de l&acute;espace';
$_lang['Course code needed'] = 'Le code espace doit être rempli';
$_lang['Course creator'] = 'Créateur de l&acute;espace';
$_lang['Course description'] = 'Description de l&acute;espace';
$_lang['Course list'] = 'Liste des espaces';
$_lang['Course manager'] = 'gestionnaire de l&acute;espace';
$_lang['Course members'] = 'Membres de l&acute;espace';
$_lang['Course progression'] = 'Progression dans l&acute;espace';
$_lang['Course settings'] = 'Paramètres de l&acute;espace';
$_lang['Course statistics deleted'] = 'Les statistiques de l&acute;espace ont été effacées.';
$_lang['Course title'] = 'Intitulé';
$_lang['Course title needed'] = 'l&acute;intitulé est obligatoire';
$_lang['Course users list'] = 'Liste des utilisateurs de l&acute;espace';
$_lang['Courses'] = 'Espace';
$_lang['Courses not used'] = 'Espaces inutilis&eacute;s';
$_lang['Courses without a lecturer'] = 'Espaces sans mod&eacute;rateur';
$_lang['Courses without student'] = 'Espace sans utilisateur';
$_lang['Create'] = 'créer';
$_lang['Create Directory'] = 'Cr&eacute;er un r&eacute;pertoire';
...
$_lang['Create user account'] = 'Cr&eacute;er un utilisateur';
...
$_lang['Delete all course statistics'] = 'Effacer les statistiques de l&acute;espace';
...
$_lang['Delete user'] = 'Supprimer l&acute;utilisateur';
$_lang['Deletion of the user was done sucessfully'] = 'La suppression de l&acute;utilisateur a bien été effectuée';
$_lang['Denied'] = 'Refusé';
...
$_lang['Directory created'] = 'r&eacute;pertoire cr&eacute;&eacute;';
...
$_lang['Document deleted'] = 'élément supprim&eacute;';
...
$_lang['Documents downloaded by the student'] = 'Documents téléchargés par  l&acute;utilisateur';
$_lang['Documents help'] = 'Aide documents';
$_lang['Documents of the group'] = 'Documents du groupe';
$_lang['Down'] = 'Descendre';
$_lang['Download attached file'] = 'Télécharger le fichier attaché';
$_lang['EG'] = 'par ex.';
...
$_lang['Edit'] = 'Editer';
$_lang['Edit Event'] = 'Editer l&acute;événement';
...
$_lang['Edit exercise settings'] = 'Editer les propriétés de l&acute;exercice';
...
$_lang['Element moved'] = '&eacute;l&eacute;ment deplac&eacute;';
$_lang['Element renamed'] = 'El&eacute;ment renomm&eacute;';
$_lang['Email'] = 'Email';
...
$_lang['Enrol as course manager'] = 'Inscrire comme gestionnaire de l&acute;espace';
...
$_lang['Enter'] = 'Entrer';
$_lang['Enter new password twice to change, leave empty to keep it'] = 'Tapez deux fois le nouveau mot de passe pour le changer, laissez vide pour garder l&acute;ancien';
...
$_lang['Error!! you cannot unregister a course manager'] = 'Erreur!! vous ne pouvez pas radier un gestionnaire de l&acute;espace';
$_lang['ErrorInvalidParms'] = 'Erreur : Paramètre invalide (utilisé des nombres uniquement)';
$_lang['Event added to the agenda'] = 'Evénement ajouté dans l&acute;agenda.';
$_lang['Event deleted from the agenda'] = 'Evénement supprimé de l&acute;agenda.';
$_lang['Event updated into the agenda'] = 'Evénement mis à jour dans l&acute;agenda.';
...
$_lang['Exercise description'] = 'Description de l&acute;exercice';
...
$_lang['Groups (from groups tool, only group members can post)'] = 'De groupe (de l&acute;outil de groupes, seuls les utilisateurs membres de groupes peuvent poster)';
...
$_lang['Information to give to students'] = 'Informations &agrave; communiquer <br />à l\'utilisateur';
$_lang['Insert a document as module'] = 'Insérer un document comme module';
$_lang['Insert a module of the course'] = 'Insérer un module de l&acute;espace';
...
$_lang['Last access'] = 'Dernier acc&egrave;s';
...
$_lang['Learning path has been successfully imported.'] = 'l&acute;importation du parcours pédagogique a réussi.';
...
$_lang['Logins not used'] = 'Comptes inutilis&eacute;s';
$_lang['Logout'] = 'Quitter';
$_lang['Lost password'] = 'Mot de passe perdu';
$_lang['Mail is already used by another user.'] = 'l&acute;e-mail est déjà utilisée par un autre utilisateur.';
$_lang['Mail synthax error.'] = 'Erreur de synthaxe dans l&acute;e-mail.';
...
$_lang['Multiple answers'] = 'R&eacute;ponses multiples';
...
$_lang['Name of the new directory'] = 'Nom du nouveau r&eacute;pertoire';
$_lang['Name of the tool'] = 'Nom de l&acute;outil';
$_lang['Never browsed'] = 'Jamais visité';
$_lang['Never connected students :'] = 'Participants qui ne se sont jamais connect&eacute;s :';
$_lang['Never used'] = 'Jamais utilis&eacute;';
...
$_lang['Next year'] = 'Ann&eacute;e suivante';
$_lang['No'] = 'Non';
...
$_lang['No result'] = 'Pas de r&eacute;sultat';
...
$_lang['Not allowed : record usernames in tracking, anonymous users cannot do the exercise.'] = 'Ne pas autoriser : les noms des utilisateurs sont enregistrés dans les statistiques, les utilisateurs anonymes ne peuvent pas faire l&acute;exercice.';
$_lang['Not recently connected students :'] = 'Cadres qui ne se sont pas connect&eacute; r&eacute;cemment : ';
...
$_lang['Number of courses by faculty'] = 'Nombre d\'espace par cat&eacute;gorie';
$_lang['Number of courses by language'] = 'Nombre d\'espaces  par langue';
$_lang['Number of courses by visibility'] = 'Nombre des espaces par visibilit&eacute;';
...
$_lang['Number of users by faculty'] = 'Nombre d\'utilisateurs par cat&eacute;gorie';
...
$_lang['Ooops, stranges cases detected !!'] = 'Aie , cas particuliers d&eacute;tect&eacute;s !';
$_lang['Operation impossible'] = 'Impossible d\'effectuer cette opération';
$_lang['Operation impossible.<br />A file with this name already exists.'] = 'Impossible d\'effectuer cette op&eacute;ration.
...
$_lang['Please give the exercise name'] = 'Veuillez introduire l\'intitulé de l\'exercice';
$_lang['Please give the question'] = 'Veuillez introduire la question';
$_lang['Please type the text'] = 'Veuillez introduire le texte';
$_lang['Please type your text below'] = 'Veuillez introduire votre texte ci-dessous';
...
$_lang['Previous day'] = 'Jour pr&eacute;c&eacute;dent';
$_lang['Previous month'] = 'Mois pr&eacute;c&eacute;dent';
$_lang['Previous week'] = 'Semaine pr&eacute;c&eacute;dente';
$_lang['Previous year'] = 'Ann&eacute;e pr&eacute;c&eacute;dente';
...
$_lang['Public'] = 'public';
$_lang['Public access from campus home page even without login'] = 'Accès public (depuis la page d\'accueil de l&acute;espace sans identifiant)';
...
$_lang['Question list of the exercise'] = 'Liste des questions';
$_lang['Question not found'] = 'Question introuvable';
$_lang['Question pool'] = 'Banque de questions';
$_lang['Question title'] = 'Titre';
$_lang['Question to lecturer'] = 'Question de planification <br />pour le modérateur';
...
$_lang['Register user'] = 'Inscrire l&acute;utilisateur';
$_lang['Register user to class'] = 'Inscrire l&acute;utilisateur à la sélection';
...
$_lang['Replace attached file'] = 'Remplacer le fichier attaché';
...
$_lang['Statement'] = 'Description de la question';
$_lang['Statistics'] = 'Statistiques';
$_lang['Statistics of course'] = 'Statistiques de l&acute;espace';
$_lang['Statistics of exercise'] = 'Statistiques de l&acute;exercice';
...
$_lang['Subscribe a class'] = 'Inscrire une sélection';
$_lang['Subscribe to course'] = 'Inscrire à l&acute;espace';
...
$_lang['The class has been moved'] = 'La sélection a été déplacée';
$_lang['The course has been successfully deleted'] = 'l&acute;espace a été supprimé';
$_lang['The email address is not valid'] = 'l&acute;adresse email que vous avez introduite n\'est pas complète
...
$_lang['The upload has failed. There is not enough space in your directory'] = 'Le t&eacute;l&eacute;chargement a &eacute;chou&eacute;. Il n\'y a plus assez de place dans votre r&eacute;pertoire';
$_lang['The upload is finished'] = 'Le t&eacute;l&eacute;chargement est termin&eacute;';
$_lang['The user has been enroled to the course'] = 'l&acute;utilisateur a été inscrit au cours';
$_lang['The user has been successfully unregistered'] = 'l&acute;utilisateur a été radié';
$_lang['The user has been successfully unregistered from course'] = 'l&acute;utilisateur a bien été radié de l&acute;espace';
...
$_lang['This class still contains some sub classes, delete them first'] = 'Cette sélection contient toujours d\'autres sélections, supprimez d\'abord son contenu';
...
$_lang['Tool'] = 'Outil';
$_lang['Tool accesses changed'] = 'l&acute;accès au lien a été changé';
$_lang['Tools'] = 'Outils';
$_lang['Topic'] = 'Sujet';
...
$_lang['Total Downloads'] = 'Total des t&eacute;l&eacute;chargements';
...
$_lang['Tracking has been disabled by system administrator.'] = 'Le syst&egrave;me de statistiques et de tracking a &eacute;t&eacute; d&eacute;sactiv&eacute; par l&acute;administrateur syst&egrave;me.';
$_lang['Traffic Details'] = 'D&eacute;tails du trafic';
...
$_lang['Unable to add the event to the agenda'] = 'Impossible d\'ajouter l&acute;événement dans l&acute;agenda.';
$_lang['Unable to change tool access'] = 'Impossible de changer l&acute;accès au lien';
$_lang['Unable to delete'] = 'Impossible de supprimer';
$_lang['Unable to delete event from the agenda'] = 'Impossible de supprimer l&acute;événement de l&acute;agenda.';
...
$_lang['Unable to update the event into the agenda'] = 'Impossible de mettre à jour l&acute;événement dans l&acute;agenda.';
...
$_lang['Unique answer'] = 'R&eacute;ponse unique';
$_lang['Unregister'] = 'Désinscrire';
$_lang['Unregister from class'] = 'Désinscrire de la sélection';
$_lang['Unregister user'] = 'Radier l&acute;utilisateur';
...
$_lang['Upload file'] = 'T&eacute;l&eacute;charger';
$_lang['Uploaded file'] = 'Fichier envoyé';
$_lang['Use a document'] = 'Utiliser un document';
$_lang['Use a module of this course'] = 'Utiliser un module de cet espace';
...
$_lang['User Id'] = 'Id de l&acute;utilisateur';
$_lang['User access details'] = 'Accès utilisateurs';
$_lang['User already in class'] = 'l&acute;utilisateur est déjà inscrit à la sélection';
$_lang['User attempts'] = 'Essais utilisateurs';
$_lang['User course settings'] = 'Paramètres des espaces de cet utilisateur';
$_lang['User has been sucessfully registered to the class'] = 'l&acute;utilisateur a été inscrit à la sélection';
$_lang['User has been sucessfully unregistered from the class'] = 'l&acute;utilisateur a été désinscrit de la sélection';
$_lang['User is now course manager'] = 'l&acute;utilisateur est maintenant gestionnaire de l&acute;espace';
$_lang['User is now student for this course'] = 'l&acute;utilisateur est maintenant étudiant pour ce cours';
$_lang['User list'] = 'Liste des utilisateurs';
$_lang['User not in the class'] = 'l&acute;utilisateur n\'est pas inscrit à la sélection';
$_lang['User settings'] = 'Paramètres de l&acute;utilisateur';
...
$_lang['Users Downloads'] = 'T&eacute;l&eacute;chargements des inscrits';
...
$_lang['View'] = 'Vue';
$_lang['View by'] = 'Niveau de d&eacute;tail';
...
$_lang['Visibility modified'] = 'Visibilit&eacute; modifi&eacute;e';
...
$_lang['Work uploaded by the student in the name of \'Authors\''] = 'Travaux post&eacute;s par le cadre au nom de \'Auteurs\'';
$_lang['Work uploads'] = 'Documents envoy&eacute;s';
$_lang['Worst score'] = 'Minimum';
$_lang['Wrong operation'] = 'Opération impossible';
$_lang['Year'] = 'Ann&eacute;e';
$_lang['Yes'] = 'Oui';
...
$_lang['You can not move a class in itself!'] = 'Vous ne pouvez pas déplacer une sélection vers elle-même!';
...
$_lang['Your new profile has been saved'] = 'Votre nouveau profil a été enregistré';
$_lang['Your password has been emailed to'] = 'Votre mot depasse a été envoyé à l&acute;adresse ';
...
$_lang['blockClaroMainHelp'] = '<br /><p><b>Utilisateur</b></p>
<p>
...
$_lang['blockConfirmDeleteScorm'] = 'Ce parcours est issu de l&acute;importation d\'un package SCORM. Si vous effacez ce parcours, tous les contenus SCORM de ses modules seront supprimés du serveur.  Etes-vous sûr de vouloir effacer le parcours pédagogique ';
$_lang['blockConfirmDeleteStats'] = 'Attention : l&acute;effacement des données statistiques est définitif !<br /><br />Etes vous sûr de vouloir les effacer ?';
$_lang['blockCourseDescriptionCourseContent'] = 'Contenu de l&acute;espace';
$_lang['blockCourseDescriptionCourseContentComment1'] = 'Quelle est l&acute;importance des différents contenus à traiter dans le cadre de l&acute;espace&nbsp;?
...
$_lang['blockCourseDescriptionCourseContentComment2'] = 'Présentation de la table des matières de l&acute;espace, de la structuration du
contenu, de la progression et du calendrier';
$_lang['blockCourseDescriptionDescription'] = 'Description';
$_lang['blockCourseDescriptionDescriptionComment1'] = 'Quelle est la place et la spécificité de l&acute;espace dans le programme&nbsp;?
Existe-t-il des cours pré-requis&nbsp;?
Quels sont les liens avec les autres cours&nbsp;?';
$_lang['blockCourseDescriptionDescriptionComment2'] = 'Information permettant d\'identifier l&acute;espace
...
$_lang['blockCourseDescriptionQualificationsAndGoalsComment1'] = 'Présentation des objectifs généraux et spécifiques de l&acute;espace, des compétences auxquelles la maîtrise de tels objectifs pourrait conduire.';
$_lang['blockCourseDescriptionQualificationsAndGoalsComment2'] = 'Quels sont les apprentissages visés par l&acute;enseignement&nbsp;?
<br />
...
$_lang['blockCourseDescriptionSupportsComment1'] = 'Existe-t-il un support de l&acute;espace ? Quel type de support vais-je privilégier ?
Ouvert ? Fermé ?';
...
$_lang['blockCourseDescriptionTeachingTrainingActivitiesComment1'] = 'Quelles méthodes et quelles activités vont-elles favoriser l&acute;atteinte des
...
$_lang['blockDefaultModuleAddedComment'] = 'Ceci est un texte additionnel d\'introduction du module. Il est spécifique à la présence de ce module dans ce parcours pédagogique. Pour le remplacer par votre propre texte, cliquez en dessous sur <b>modifier</b>.';
$_lang['blockDefaultModuleComment'] = 'Ceci est un texte d\'introduction du module, il apparaîtra dans chaque parcours contenant ce module. Pour le remplacer par votre propre texte, cliquez en dessous sur <b>modifier</b>.';
$_lang['blockDocumentsHelp'] = '<p>Le module de gestion de document fonctionne de
...
<center>
<p>';
$_lang['blockExercisesHelp'] = '<p>Le module d\'exercice vous permet de créer des exercices pouvant contenir un nombre
...
$_lang['blockFeedbackHelp'] = 'Le corrigé est optionnel, s\'il est complété il sera affiché aux participants selon l&acute;option de soumission choisie.';
...
$_lang['blockIntroCourse'] = 'Bienvenue sur la page d\'accueil de l&acute;espace.<br /><br />Vous pouvez sur cette page :
<ul>
...
$_lang['blockIntroLearningPath'] = 'Utilisez cet outil pour fournir à vos apprenants un parcours séquentiel défini par vos soins entre des documents, exercices, pages HTML, liens... ou importez des contenus SCORM existants<br /><br />Si vous désirez ajouter un texte d\'introduction, cliquez sur ce bouton.<br />';
...
$_lang['blockModulePoolHelp'] = 'Cette page vous permet de voir tous les modules disponibles dans votre cours. <br />
...
$_lang['blockUsersHelp'] = '<b>Droits d\'administration</b>
...
$_lang['e.g. <em>History of Literature</em>'] = 'p. ex. <i>Théorie pédante sur l&acute;orthopédagogie</i>';
...
$_lang['in all exercises'] = 'pour l&acute;ensemble des exercices';
$_lang['line'] = 'ligne';
$_lang['lines'] = 'lignes';
$_lang['max. 12 characters, e.g. <em>ROM2121</em>'] = 'max. 12 caractères, p. ex.<i>ROM2121</i>';
...
$_lang['sampleForumDescription'] = 'A supprimer via l&acute;administration des forums';
...
$_lang['sampleLearnPathDescription'] = 'Ceci est un exemple de parcours pédagogique, il utilise l&acute;exemple d\'exercice et l&acute;exemple de document de l&acute;outil d\'exercices et l&acute;outil de documents. Cliquez sur <b>Modifier</b> pour changer ce texte.';
$_lang['sampleLearnPathDocumentDescription'] = 'Vous pouvez utiliser n\'importe quel document de l&acute;outil de documents de cet espace.';
$_lang['sampleLearnPathDocumentTitle'] = 'document_exemple';
$_lang['sampleLearnPathQuizDescription'] = 'Vous pouvez utiliser n\'importe quel exercice de l&acute;outil d\'exercices de cet espace.';
...
$_lang['sampleQuizAnswer1Comment'] = 'Non. l&acute;ironie socratique ne se joue pas sur le terrain de la psychologie, mais sur celui de l&acute;argumentation.';
$_lang['sampleQuizAnswer2'] = 'Reconnaître ses erreurs pour inviter son interlocuteur à faire de même.';
$_lang['sampleQuizAnswer2Comment'] = 'Non. Il ne s\'agit pas d\'une stratégie de séduction ou d\'une méthode par l&acute;exemple.';
...
$_lang['sampleQuizAnswer3Comment'] = 'En effet. l&acute;ironie socratique est une méthode interrogative. Le grec "eirotao" signifie d\'ailleurs "interroger".';
$_lang['sampleQuizAnswer4'] = 'Utiliser le principe de non-contradiction pour amener son interlocuteur dans l&acute;impasse.';
$_lang['sampleQuizAnswer4Comment'] = 'Cette réponse n\'est pas fausse. Il est exact que la mise en évidence de l&acute;ignorance de l&acute;interlocuteur se fait en mettant en évidence les contradictions auxquelles abouttisent ses thèses.';
...
$_lang['sampleQuizQuestionTitle'] = 'l&acute;ironie socratique consiste à...';
...
$_lang['this password is too simple. Use a password like this <code>%passpruposed</code>'] = 'Ce mot de passe est trop simple. Choisissez un autre password  comme par exemple : ';
$_lang['to'] = 'au';
$_lang['uncompress zipped (.zip) file on the server'] = 'Décompresser fichier zipé (.zip)';
$_lang['use brackets [...] to define one or more blanks'] = 'utilisez des crochets [...] pour créer un ou des blancs';
$_lang['warning : Installation cannot find the description of the learning path and has set a default comment.  You should change it'] = 'attention : l&acute;installation n\'a pas trouvé la description du parcours pédagogique et a attribué un commentaire par défaut. Vous pourrez le changer par la suite';
$_lang['warning : Installation cannot find the name of the learning path and has set a default name.  You should change it.'] = 'attention : l&acute;installation n\'a pas trouvé le nom du parcours pédagogique et a attribué un nom par défaut. Vous pourrez le changer par la suite.';
?>