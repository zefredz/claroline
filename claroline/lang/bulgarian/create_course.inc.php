...
$langCodeTaken="Този код е вече зает.  <br>Използвайте <b>Back</b> бутона на вашия браузер и пробвайте отново.";
...
$langAnnouncementEx="Това е примерна обява. Само преподавателите и администраторите могат да публокуват обяви.";
