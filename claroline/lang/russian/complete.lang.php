...
$_lang['Access to tools'] = 'Доступ к средствам';
...
$_lang['All groups are now empty'] = 'Все группы сейчас пустые';
$_lang['All groups have been deleted'] = 'Все группы удалены';
...
$_lang['Area for this group'] = 'Область этой группы';
$_lang['Author'] = 'Автор';
...
$_lang['Create new group(s)'] = 'Создать новую(ые) группу(пы)';
$_lang['Date'] = 'Дата';
$_lang['Day'] = 'День';
...
$_lang['Description'] = 'Описание курса';
$_lang['Detail'] = 'Подробность';
$_lang['Details'] = 'Подробности';
$_lang['Directory created'] = 'Папка создана';
$_lang['Document'] = 'Учебные материалы';
$_lang['Document deleted'] = 'Документ удален';
...
$_lang['Email'] = 'Email';
$_lang['Empty'] = 'Пока нет содержимого.';
$_lang['Empty all groups'] = 'Пустые все группы';
...
$_lang['Fill groups (automatically)'] = 'Заполнить группу(пы) автоматически';
...
$_lang['Group'] = 'зТХРРБ';
$_lang['Group Tutor'] = 'Преподаватель группы';
$_lang['Group area'] = 'Область группы';
$_lang['Group deleted'] = 'Группа удалена';
$_lang['Group management'] = 'Управление группами';
$_lang['Group members'] = 'Пользователи группы';
$_lang['Group name'] = 'Название группы';
$_lang['Group settings have been modified'] = 'Установки группы будут изменены';
$_lang['Group settings modified'] = 'Установки группы изменены.';
$_lang['Groups'] = 'Группы';
$_lang['Groups have been filled (or completed) by students present in the \'Users\' list.'] = 'Группы были заполнены (или укомплектованы) студентами из списка \'Пользователи\'.';
$_lang['Groups help'] = 'Групповая помощь';
$_lang['Groups settings'] = 'Установки группы';
$_lang['He or she will receive email confirmation with login and password'] = 'После подтверждения, Он(Она) получит по электронной почте имя пользователя и пароль.';
...
$_lang['Invalid user : this user doesn\'t exist in your group'] = 'Неверный пользователь : Этот пользователь не в вашей группе.';
$_lang['Language'] = 'Язык';
...
$_lang['List of students in this group'] = 'Список студентов этой группы';
$_lang['Login'] = 'Вход, логин';
$_lang['Login request'] = 'Проверка имени пользователя';
...
$_lang['Number proposed exceeds max. that you allowed (you can modify it below). Group composition has not been modified'] = 'Количество предложенных участников группы превышает максимум, установленный вами. 
...
$_lang['Please give a weighting to each blank'] = 'Дайте значимость каждому вопросу';
...
$_lang['Private'] = 'Закрыт (Приватный)';
$_lang['Public'] = 'Открыт всем';
$_lang['Public access from campus home page even without login'] = 'Свободный доступ (с Главной страницы Кампуса без пароля)';
...
$_lang['Students are allowed to self-register in groups'] = 'Студенты которым разрешена простая регистрация в группах';
$_lang['Subject'] = 'Тема';
...
$_lang['This is the faculty, department or school where the course is delivered'] = 'Это факультет, департамент или школа где создан курс';
...
$_lang['To'] = 'в';
$_lang['Tools'] = 'Панель инструментов';
$_lang['Topic'] = 'Тема';
...
$_lang['Tracking has been disabled by system administrator.'] = 'Система статистики и отслеживания действий пользователей дезактивирована администратором системы.';
$_lang['Traffic Details'] = 'Детали трафика';
$_lang['True'] = 'Верно';
$_lang['Unassigned students'] = 'Студенты не подключены';
$_lang['Unregister'] = 'Отписать';
$_lang['Unsubscribe'] = 'Отмена регистрации';
$_lang['Up'] = 'Вверх';
$_lang['Upgrade'] = 'Обновление Сlaroline';
...
$_lang['e.g. <em>History of Literature</em>'] = 'Пример, <i>История финнансовых рынков</i>';
$_lang['line'] = 'строка';
$_lang['lines'] = 'строки';
$_lang['max. 12 characters, e.g. <em>ROM2121</em>'] = 'Максимально 12 букв, пример <i>LIT2121</i>';
$_lang['my group'] = 'моя группа';
$_lang['my supervision'] = 'одна из моих групп';
$_lang['new group(s)'] = 'Новая(ые) группа(ы)';
...
$_lang['seats (optional)'] = 'места (необязательный)';
$_lang['seats by groups (optional)'] = 'места в группах (необязательный)';
$_lang['to'] = 'по';
