tinyMCE.init({
    ...
    //-- advanced theme
    theme_advanced_buttons1 : "cut,copy,paste,pasteword,claroimage,bold,italic,underline,strikethrough,separator,bullist,numlist,link,unlink,texformula,spoiler,forecolor,resources",
