...
// comment TopRightPath(): return value isn't use 
...
{
	if ($contactNameForm == '*notSet*')
	{
		$contactNameForm     = $adminSurnameForm.' '.$adminNameForm;
	}
	
	if ($contactEmailForm == '*notSet*')
	{
		$contactEmailForm     = $adminEmailForm;
	}

	if ($contactPhoneForm == '*notSet*')
	{
...
<table cellpadding="10" cellspacing="0" border="0" width="650" bgcolor="#E6E6E6">
	...
	<tr bgcolor="#E6E6E6">
		<td>
<?php
echo '<input type="hidden" name="urlAppendPath"                value="'.$urlAppendPath.'">'                  ."\n"
			...
			<td>
				...
				<table >
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" size="40" id="urlForm" name="urlForm" value="'.cleanoutputvalue($urlForm).'">
						</td>
					</tr>
					<tr>
						<td>
			...
			<td>
				...
				<tr>
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" size="40" id="contactPhoneForm" name="contactPhoneForm" value="'.cleanoutputvalue($contactPhoneForm).'">
						</td>
					</tr>
					<tr>
						<td colspan="3">
