...
$langGroupForumLink="Fòrum del grup";
...
$l_message	= "Missatge";
$l_messages	= "Missatges";
$l_subject	= "Matèria";
$l_body		= "Cos del $l_message";
$l_from		= "De";   // Message from
$l_moderator 	= "Moderador";
$l_username 	= "Nom d'usuari";
$l_password 	= "Paraula de pas";
$l_email 	= "Correu-e";
$l_emailaddress	= "Adreça de correu-e";
$l_preferences	= "Preferències";

$l_anonymous	= "Anònim";  // Post
$l_guest	= "Convidat"; // Whosonline
$l_noposts	= "No $l_posts";
$l_joined	= "Incorporat";
$l_gotopage	= "Ves a plana";
$l_nextpage 	= "Plana següent";
$l_prevpage     = "Plana prèvia";
$l_go		= "Ves";
$l_selectforum	= "Selecciona un $l_forum";
...
$l_returnindex	= "$l_toreturn a l'índex del fòrum";
$l_returntopic	= "$l_toreturn a la llista de tòpics del fòrum.";
...
$l_nopost	= "No tens accés a publicar en aquest fòrum.";
$l_noread	= "No tens accés a llegir aquest fòrum.";

$l_lastpost 	= "Última $l_post";
$l_sincelast	= "des de la teva darrera visita";
$l_newposts 	= "Noves $l_posts $l_sincelast";
$l_nonewposts 	= "Cap nova $l_post $l_sincelast";
...
// Private forums
$l_privateforum	= "Aquest és un <b>Fòrum Privat</b>.";
$l_private 	= "$l_privateforum<br>Nota: has de tenir les 'cookies' activades per poder fer servir fòrums privats.";
$l_noprivatepost = "$l_privateforum No tens accés per publicar en aquest fòrum.";

// Viewtopic
$l_topictitle	= "Visualitza $l_topic";
$l_unregistered	= "Usuari no enregistrat";
$l_posted	= "Publicat";
$l_profileof	= "Visualitza perfil de";
$l_viewsite	= "Ves al lloc web de";
$l_icqstatus	= "$l_icq status";  // ICQ status
$l_editdelete	= "Edita/Esborra aquesta $l_post";
$l_replyquote	= "Respon amb cita";
$l_viewip	= "View Posters IP (Moderators/Admins Only)";
$l_locktopic	= "Bloqueja aquest $l_topic";
$l_unlocktopic	= "Desbloqueja $l_topic";
$l_movetopic	= "Mou aquest $l_topic";
$l_deletetopic	= "Esborra aquest $l_topic";

// Functions
$l_loggedinas	= "Connectat com ";
$l_notloggedin	= "No connectat";
$l_logout	= "Desconnecta";
$l_login	= "Connecta";

// Page_header
$l_separator	= "» »";  // Included here because some languages have
		          // problems with high ASCII (Big-5 and the like).
$l_editprofile	= "Edita perfil";
$l_editprefs	= "Edita $l_preferences";
$l_search	= "Cerca";
$l_memberslist	= "Llistat de Membres";
$l_faq		= "FAQ";
...
$l_welcomesubj	= "Benvingut als Fòrums de $sitename";
$l_welcomemail	=
"
$l_welcomesubj,

Si us plau, conserva aquest missatge.


La informació del teu compte és com segueix:
...
$l_editedby	= "Aquest $l_message va ser editat per:";
$l_stored	= "El teu $l_message ha estat guardat a la base de dades.";
$l_viewmsg	= "per veure el teu $l_message.";
$l_deleted	= "La teva $l_post ha estat esborrada.";
$l_nouser	= "That $l_username doesn't exist.";
$l_passwdlost	= "I forgot my password!";
$l_delete	= "Esborra aquesta Publicació";

$l_disable	= "Deshabilita";
$l_onthispost	= "en aquesta Publicació";

$l_htmlis	= "$l_html és";
$l_bbcodeis	= "$l_bbcode és";

$l_notify	= "Notifica'm per correu-e quan es publiquin respostes";

// Newtopic
$l_emptymsg	= "Has d'escriure un $l_message per publicar. No pots publicar un $l_message en blanc.";
