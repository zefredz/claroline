...
$langNomOutilTodo 		= "Проверка на списъка с Предложения"; // to do
$langNomPageAdmin 		= "Администрация";
$langSysInfo  			= "Информация за системата";        // Show system status
$langCheckDatabase  	= "Провери главната база данни";        // Check Database
$langDiffTranslation 	= "Сравни преводите"; // diff of translation
$langStatOf 			= "Статистика на "; // Stats of...
