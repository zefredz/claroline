...
Para los profesores, preparar un curso en Internet es principalmente una cuesti&oacute;n de
Teor&oacute;a Educativa.";

$langClarContent4="est&aacute;n a su disposici&oacute;n para ayudarle durante
los pasos de la evoluci&oacute;n de su proyecto de formaci&oacute;n: desde el
dise&ntilde;o de las herramientas a su integraci&oacute;n en una estrategia coherente
y clara con una evaluaci&oacute;n de su impacto en el aprendizaje de los alumnos.
</p>";
...
$langClarContent1 = "es el campus virtual de";

$langClarContent2 = "Aqu&iacute;, los profesores y los asitentes crean y administran las webs de los cursos, los estudiantes las consultan (documentos, agendas, informaciones diversos). Cuando proceda, los estudiantes realizan ejercicios, publican trabajos, toman parte en las discusiones de los foros...</p><b>Inscripci&oacute;n</b><p>Si usted es estudiante, s&oacute;lo necesita inscribirse eligiendo 'Incribirme a los cursos (estudiante)' y despu&eacute;s marcar los cursos que usted desea seguir.</p><p>Si usted es profesor o asistente, inscr&iacute;base de la misma manera, pero escogiendo 'Crear webs de cursos (profesor)'. Usted tendr&aacute; que rellenar entonces un formulario precisando el c&oacute;digo de un primer curso y su t&iacute;tulo. Una vez que usted habr&aacute; validado esta elecci&oacute;n, usted ser&aacute; conducido a la web que usted habr&aacute; creado y usted podr&aacute; modificar el contenido y la organizaci&oacute;n a vuestro modo.</P><p>Si este portal de creaci&oacute;n y de administraci&oacute;n de cursos no os satisface, no dudes en comunicarnoslo via la r&uacute;brica 'Sugerencias' accesible desde la p&aacute;gina principal del campus (s&oacute;lo despu&eacute;s de haberse identificado).</p><p>El enlace a la inscripci&oacute;n se encuentra en la p&aacute;gina principal de la web en la esquina superior derecha.</p><b>Identificaci&oacute;n personal (login)</b><p>En sus pr&oacute;ximas visitas, para acceder a sus cursos, introduzca su nombre de usuario y su password en los campos de introducci&oacute;n de datos situados en la esquina superior derecha de la pantalla. La direcci&oacute;n de la web es";
...
$langClarContent4 = "est&aacute; a vuestra disposici&oacute;n para ayudaros en las diferentes fases de la creaci&oacute;n de vuestro proyecto: desde la concepci&oacute;n de la herramienta, a su integraci&oacute;n en un dispositivo coherente y a su evaluaci&oacute;n en t&eacute;rminos del impacto sobre el aprendizaje.</p>";
