...
<div class="item<?php if ($description['visibility'] == 'INVISIBLE') : ?> hidden<?php endif; ?>">
    ...
    <div class="content">
        <a href="#" name="ann<?php echo $description['id']; ?>"></a>
    ...
    <div class="manageTools">
        ...
        <a href="<?php echo htmlspecialchars(Url::Contextualize($_SERVER['PHP_SELF'] . '?cmd=exDelete&amp;descId=' . (int) $description['id'])); ?>"
        ...
        <?php if ($description['visibility'] == 'VISIBLE') : ?>
        <a href="<?php echo htmlspecialchars(Url::Contextualize( $_SERVER['PHP_SELF'] . '?cmd=mkInvis&amp;descId=' . (int) $description['id'])); ?>">
        <img src="<?php echo get_icon_url('visible'); ?>" alt="<?php echo get_lang('Invisible'); ?>" />
        </a>
        <?php else : ?>
        <a href="<?php echo htmlspecialchars(Url::Contextualize( $_SERVER['PHP_SELF'] . '?cmd=mkVis&amp;descId=' . (int) $description['id'])); ?>">
