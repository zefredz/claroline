...
function render_access_mode_caption_block()
{
    $block = '<fieldset class="captionBlock">' . "\n"
           ...
           . '<img class="iconDefinitionList" src="' . get_icon_url( 'access_locked' ) . '"  alt="Verrouill�" />' . get_lang( 'Access allowed only to course members (people on the course user list)' ) . "\n"
           . '</fieldset>';
    return $block;
}
