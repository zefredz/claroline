...
{
	global $tbl_forums, $tbl_topics, $tbl_posts;
...
function disp_forum_group_toolbar($gid)
{
	...
	echo '<p><a href="../group/group_space.php?gidReq=' . $gid . '">' . $langGroupSpaceLink. '</a>' 
        . '&nbsp;&nbsp' 
		. '<a href="../document/document.php?gidReq=' . $gid . '">' . $langGroupDocumentsLink . '</a>'
        . '</p>' . "\n";

}

function private_forum()
{
    global $tbl_group_properties;
