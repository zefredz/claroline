...
defined('CLARO_INCLUDE_ALLOWED') || define('CLARO_INCLUDE_ALLOWED'  , true);
...
// These folowing variables could be missing in configuration files
// They are set by defaul to prevent any warning.

    $claro_CasEnabled                = false;
    $claro_displayLocalAuthForm      = true;
    $claro_authUsernameCaseSensitive = false;
