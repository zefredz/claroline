...
// Safari is Not based on Gecko but browser ident retunr gecko.
HTMLArea.is_gecko  = (navigator.product == "Gecko" && (HTMLArea.agt.indexOf("k-meleon") == -1) && (HTMLArea.agt.indexOf("safari") == -1) ); 
